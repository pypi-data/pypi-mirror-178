...
class ISlideshow(Schema):
    ...
    slide1_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "1"}
        ),
        description="",
        required=False,
    )
    ...
    slide1_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "1"}
        ),
        description="",
        required=False,
    )
    ...
    slide2_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "2"}
        ),
        description="",
        required=False,
    )
    ...
    slide2_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "2"}
        ),
        description="",
        required=False,
    )
    ...
    slide3_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "3"}
        ),
        description="",
        required=False,
    )
    ...
    slide3_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "3"}
        ),
        description="",
        required=False,
    )
    ...
    slide4_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "4"}
        ),
        description="",
        required=False,
    )
    ...
    slide4_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "4"}
        ),
        description="",
        required=False,
    )
    ...
    slide5_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "5"}
        ),
        description="",
        required=False,
    )
    ...
    slide5_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "5"}
        ),
        description="",
        required=False,
    )
    ...
    slide6_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "6"}
        ),
        description="",
        required=False,
    )
    ...
    slide6_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "6"}
        ),
        description="",
        required=False,
    )
    ...
    slide7_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "7"}
        ),
        description="",
        required=False,
    )
    ...
    slide7_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "7"}
        ),
        description="",
        required=False,
    )
    ...
    slide8_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "8"}
        ),
        description="",
        required=False,
    )
    ...
    slide8_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "8"}
        ),
        description="",
        required=False,
    )
    ...
    slide9_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "9"}
        ),
        description="",
        required=False,
    )
    ...
    slide9_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "9"}
        ),
        description="",
        required=False,
    )
    ...
    slide10_image = namedfile.NamedBlobImage(
        title=_(
            "label_slideimage", default="Slide Bild ${number}", mapping={"number": "10"}
        ),
        description="",
        required=False,
    )
    ...
    slide10_text = RichTextField(
        title=_(
            "label_slidetext", default="Slide Text ${number}", mapping={"number": "10"}
        ),
        description="",
        required=False,
    )
