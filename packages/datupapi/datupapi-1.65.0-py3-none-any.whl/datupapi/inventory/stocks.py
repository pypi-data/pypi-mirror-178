...
class Stocks(Config):
        ...
        def extract_avg_daily(self, df_Prep ,df_Forecast, df_invopt, forecast_=False,location=True,frequency_='M',months_=4,weeks_=4): 
            """
                ...
                if forecast_ == True:
                      ...
                      if frequency_ == 'M':
                            ...
                            if location:
                                ...
                                df_avg = df_avg[['Date','Item','Location','Target','SuggestedForecast']]
                                df_avg['AvgDailyUsage'] = df_avg.apply(lambda x: x['SuggestedForecast'] if (x['Target']==0) else x['Target'], axis=1 )
                                ...
                                df_avg = df_avg[['Date','Item','Target','SuggestedForecast']]
                                df_avg['AvgDailyUsage'] = df_avg.apply(lambda x: x['SuggestedForecast'] if (x['Target']==0) else x['Target'], axis=1 )
                ...
                if forecast_ == False:
                      ...
                      if frequency_ == 'M':
                            ...
                            if location:
                                ...
                                df_avg = df_avg[['Date','Item','Location','Target',]]
        ...
        def extract_max_daily(self, df_Prep ,df_Forecast, df_invopt, forecast_=False,location=True,frequency_='M',months_=4,weeks_=4): 
            """
              ...
              if forecast_ == True:
                    ...
                    if frequency_ == 'M':
                          ...
                          if location:
                              ...
                              df_avg = df_avg[['Date','Item','Location','Target','SuggestedForecast']]
                              df_avg['MaxDailyUsage'] = df_avg.apply(lambda x: x['SuggestedForecast'] if (x['Target']==0) else x['Target'], axis=1 )
        ...
        def clean_and_format(self,df_invopt):
            ...
            try:
                ...
                indicators=['Item','ItemDescription','Location','LocationDescription','Inventory','Transit', 'Transfer','Committed',
                            ...
                            'ProductType','Weight','Dimension','Color','Origen','Gama','Marca','MateriaPrima','JefeProducto','JefeProductoDescription','GrupoCompra','Familia','Seccion','InventoryUnit','Comments']
