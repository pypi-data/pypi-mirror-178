...
BASE_MAPPING = [
    ...
    CharConfigField(None, "EMAIL_HOST_URL", help_str="SMTP server for sending admin emails. \n"
...
DEFAULT_INI_MAPPING = BASE_MAPPING + DATABASE_MAPPING + LOG_MAPPING + REDIS_MAPPING + SENDFILE_MAPPING
EMPTY_INI_MAPPING = []
