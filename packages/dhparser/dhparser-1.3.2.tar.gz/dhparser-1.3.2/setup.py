...
{'': ['*'],
 'DHParser': ['templates/*'],
 'documentation_src': ['.vscode/*',
                       'Presentations/deRSE2019/*',
                       'deutsche_Anleitungen/*',
                       'html_assets/*',
                       'manuals/*'],
 'documentation_src.doc_examples.JSON': ['tests_grammar/*'],
 ...
 'examples.LaTeX': ['.vscode/*',
                    ...
                    'testdata/testerror.tex',
                    'testdata/testerror.tex'],
 'examples.XML': ['testdata/bad_mistake.xml',
                  'testdata/bad_mistake.xml',
                  'testdata/bad_mistake.xml',
                  'testdata/bad_mistake.xml',
                  'testdata/bad_mistake.xml',
                  'testdata/bad_mistake.xml',
                  ...
                  'testdata/mwg.xml',
                  'testdata/mwg.xml',
                  'testdata/salinacinus.ausgabe.xml',
                  'testdata/salinacinus.ausgabe.xml',
                  'testdata/salinacinus.ausgabe.xml',
                  'testdata/salinacinus.ausgabe.xml',
                  'testdata/salinacinus.ausgabe.xml',
