...
with open("/home/william/code/willsketch/Helper/Description.rst", "r", encoding="utf-8") as fh:
    long_description = fh.read()
with open("/home/william/code/willsketch/Helper/requirements.txt", "r", encoding="utf-8") as fh:
