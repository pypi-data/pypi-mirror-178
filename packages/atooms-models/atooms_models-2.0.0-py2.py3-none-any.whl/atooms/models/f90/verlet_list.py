...
class VerletList(object):
    ...
    def __init__(self, skin=0.2, update="largest", update_period=10,
                 inline=True, debug=False, parallel=False):
        source = os.path.join(os.path.dirname(__file__), 'neighbor_list.f90')
        self.skin = skin
        self.update = update
