...
dirs = ["Missionaries%26Cannibals/bfs.py","Missionaries%26Cannibals/state_space_search.py","8Puzzle/bfs.py","8Puzzle/astar.py","8Queens/hill_climbing.py","TSP/simulated_annealing.py","ZeroSum/alpha_beta_pruning.py","IDDFS/iddfs.py","WumpusWorld/wumpus_world.py","BlocksWorld_GoalStackPlanning/heuristic.py","AO_Graph/ao_star.py","BayesianClassification/naive_bayes.py","SupervisedLearning/decision_tree.py","SupervisedLearning/linear_regression.py","SupervisedLearning/k_means.py"]
...
def start():
    ...
    download_file(base_url + dirs[choice - 1], download_location)
