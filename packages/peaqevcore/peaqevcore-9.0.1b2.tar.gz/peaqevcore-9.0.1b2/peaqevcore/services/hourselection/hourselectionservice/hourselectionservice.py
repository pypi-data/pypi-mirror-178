...
class HourSelectionService:
    ...
    def interim_day_update(self, today: HourObject, tomorrow: HourObject) -> Tuple[HourObject, HourObject]:
        ...
        for i in range(0,14):
            today.offset_dict[i+14] = new_hours.offset_dict[i]
            today.pricedict[i+14] = new_hours.pricedict[i]
        for i in range(14,24):
            tomorrow.offset_dict[i-14] = new_hours.offset_dict[i]
            tomorrow.pricedict[i-14] = new_hours.pricedict[i]
