...
class SsmPs(o7lib.aws.base.Base):
    ...
    def display_parameters(self, parameters):
        """Diplay Parameters"""
        self.ConsoleTitle(left='SSM Parameter Store List')
        print('')
        params = {
            'columns' : [
    ...
    def display_parameter(self, parameter_info : dict, parameter_last : dict):
        """Diplay Parameters"""
        self.ConsoleTitle(left='SSM Parameter')
        print('')
        print(f'Name: {parameter_info["Name"]}')
        print(f'Description: {parameter_info["Description"]}')
        print('')
        print(f'Value: {parameter_last["Value"]}')
        print('')
        print(f'Version: {parameter_last["Version"]}')
        print(f'LastModifiedDate: {parameter_last["LastModifiedDate"].isoformat()}')
        print('')
        print(f'Type: {parameter_info["Type"]}')
        print(f'DataType: {parameter_info["DataType"]}')
        print(f'Tier: {parameter_info["Tier"]}')
        print(f'Type: {parameter_info["Type"]}')
        print('')
