    ...
    for test in ihc_tests:
        ...
        # Check for PD-L1 tests, work through odd handling patterns
            ...
            if prefix_list.count("tc") == 4 and prefix_list.count("ic") == 3:
                ...
                tc_stainpercent = test_results.get("tcStainPercent", "")
                tc_threshold = (
                ...
                ic_stainpercent = test_results.get("icStainPercent", "")
                ...
                ihc_results.append(
                    {
                        ...
                        "tcStainPercent": tc_stainpercent,
                        "tcThreshold": tc_threshold,
                        "icResult": ic_result,
                        "icStainPercent": ic_stainpercent,
            ...
            # PD-L1 (22c3) tests report a cpScore, and no stain or intensity metrics
                ...
                cpScore = test_results.get("cpScore", "")
            ...
            # but report IC Threshold in the regualr Threshold field
                ...
                stainpercent = test_results.get("stainPercent")
