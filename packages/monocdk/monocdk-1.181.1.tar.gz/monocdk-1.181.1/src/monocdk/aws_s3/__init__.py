...
class BucketPolicy(
    ...
    def apply_removal_policy(self, removal_policy: _RemovalPolicy_c97e7a20) -> None:
        ...
        '''
        if __debug__:
            def stub(removal_policy: _RemovalPolicy_c97e7a20) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IBucketProxy(
    ...
    def add_to_resource_policy(
        ...
        '''
        if __debug__:
            def stub(permission: _PolicyStatement_296fe8a3) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IBucketNotificationDestinationProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(scope: _Construct_e78e779f, bucket: IBucket) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument bucket", value=bucket, expected_type=type_hints["bucket"])
