...
class LocalLogger:
    def __init__(self, name:Optional[str]=None, log_dir='/tmp/log', stack_layer=2) -> None:
        if name is None:
            name = 'root'
    ...
    def _get_header(self, msg_type:str):
        ...
        caller = getframeinfo(stack()[self.stack_layer][0])
...
class Logger:
    def __init__(
        ...
        self.logger = LocalLogger(domain, stack_layer=3)
