...
Parts.DeviceSettings {
    Parts.CommonSettings {
        settingsForChangesChecker: [
            ...
            glassSensitivityCombobox.currentIndex,
            externalContact.checked,
            alwaysActive.checked,
            ifGlassSensor.checked,
        ...
        generateSettings: () => {
            var settings = {
                ...
                "sensitivity": glassSensitivityCombobox.currentIndex,
                "extra_contact_aware": externalContact.checked,
                "always_active": alwaysActive.checked,
                "siren_triggers": ifGlassSensor.checked ? [2] : [],
            }
        ...
        Column {
            ...
            DS3.SettingsContainer {
                ...
                Settings.GlassSensitivityCombobox { id: glassSensitivityCombobox }
            ...
            DS3.SettingsContainer {
                ...
                Settings.IfGlassSensor { id: ifGlassSensor }
            }
            ...
            DS3.SettingsContainer {
                Settings.Chimes {
                    ...
                    isExternalContactChecked: externalContact.checked
                }
            }
