        ...
        Column {
            ...
            DS3.SettingsContainer {
                ...
                DS3.SettingsPickerTitleSecondary {
                    ...
                    onCurrentIndexChanged: {
                        if (imageResolutionCombobox.currentIndex == 1 && imageResolutionCombobox.isPopupActivated) {
                    ...
                    model: ["320x176", "640x352"]
                    currentIndex: device.image_resolution > 0 ? device.image_resolution - 1 : 0
                }
            ...
            DS3.SettingsContainer {
                ...
                Settings.IfMaskingSensor {
                        id: ifMaskingSensor
                        enabled: devEnable && antimasking.checked
                }
            }
