    ...
    Parts.CommonSettings {
        Connections {
            ...
            onAltActionSuccess: {
                ...
                let streamSettings = Object.assign({}, device.stream_settings.hikvision_or_safire_settings)
                streamSettings["verificationcode"] = verificationCode.atomInput.text.trim()
                ...
                app.hub_management_module.edit_stream_data({
                    ...
                    "hikvision_or_safire_settings": streamSettings,
                })
            }
        }

        settingsForChangesChecker: [
            verificationCode.atomInput.text.trim(),
        ]
        ...
        DS3.SettingsContainer {
            ...
            Settings.VerificationCode { id: verificationCode }
        }
    }
}
