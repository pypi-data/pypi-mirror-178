...
//  Whether device is enabled
    ...
    firstStepComponent: Parts.CommonSettings {
        id: keyPadCombiSettings
        
        settingsForChangesChecker: [
            groupAssociatedCombobox.currentIndex,
            groupAssociatedSirenCombobox.currentIndex,
            ...
            beepsButton.notifyVolumeIndex,
            beepsButton.chimesEnabled
        ]
        generateSettings: () => {
            var settings = {
                "common_part": {
                ...
                "time_to_act_seconds": alarmVolumeDurationSlider.value,
                "volume_level": parseInt(volume.value),
                "siren_alarm_volume": parseInt(sirenAlarmVolume.currentIndex) + 1,
            ...
            if (hub.firmware_version_dec >= 206000) {
                ...
                if (groupAssociatedSirenCombobox.currentIndex == 0) {
                    settings["siren_associated_group_id"] = "00000000"
                } else {
                    var group = groups.get(groupAssociatedSirenCombobox.currentIndex - 1)
                    if (group) {
                        settings["siren_associated_group_id"] = group.group_id
                    }
                }
        ...
        header: DS3.NavBarModal {
            headerText: keyPadCombiSettings.title
        }
        ...
        Column {
            ...
            Column {
                ...
                DS3.SettingsContainer {
                    ...
                    Settings.GroupAssociatedSirenCombobox { id: groupAssociatedSirenCombobox }
                    Settings.SirenAlarmVolume { id: sirenAlarmVolume }
