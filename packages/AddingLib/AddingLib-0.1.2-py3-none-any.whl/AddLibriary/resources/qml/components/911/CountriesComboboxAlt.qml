...
ComboBox {
    ...
    font.pixelSize: !!contentColor ? 16 : 14
    ...
    delegate: ItemDelegate {
        ...
        Custom.FontText {
            ...
            text: modelData.name
            color: !!contentColor ? contentColor : ui.colors.white
            font: control.font
            maximumLineCount: 2
    ...
    contentItem: Custom.TextField {
        ...
        control.color: !!contentColor ? contentColor : ui.colors.white
        control.opacity: !!contentColor ? 1 : control.opacity
        control.font.pixelSize: !!contentColor ? 16 : 14
