...
AjaxPopup {
    id: popup
    objectName: "deleteHubCompanyBindingPopup"
    width: 360
    ...
    contentItem: Rectangle {
        ...
        Custom.FontText {
            id: moveText
            text: tr.delete_hub_company_binding
                ...
                Custom.Button {
                    ...
                    onClicked: {
                        ...
                        if (popup.mode == "facility") {
                            app.facility_module.delete_hub_company_binding(settings)
                        } else {
                            app.bindings_module.delete_hub_company_binding(settings)
                        }
                    }
                }
            }
    ...
    Connections {
        ...
        onDeleteHubCompanyBindingFailed: {
            popup.close()
        }
    }
    ...
    Connections {
        ...
        onHubCompanyBindingRemovalIncidentExistsError: {
            popup.close()
        }
    }
}