...
DS3.InfoTitle {
    visible: {
        if (!hub) return false
        var common_visibility = hub.firmware_version_dec >= 211100 && device.perimeter_alarm_delay_seconds && device.night_mode_arm
    ...
    atomTitle {
        ...
        subtitle: device.perimeter_alarm_delay_seconds
    }
    leftIcon.source: "qrc:/resources/images/Athena/views_icons/DelayWhenEnteringNightMode-M.svg"
}