...
Item {
    ...
    property alias rooms: listViewRooms
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            ListViewRooms {
                ...
                list {
                    model: management.filtered_rooms
        ...
        Rectangle {
            ...
            ListViewDevices {
                ...
                withoutSettingIcon: false
                list {
                    model: management.filtered_room_devices
                    currentIndex: -1
                    footer: Item {}
                    delegate: Rectangle {
                        id: deviceDelegate
                        ...
                        Rectangle {
                            ...
                            Custom.HandMouseArea {
                                onClicked: {
                                    currentIndex = index
                                    device = listViewDevices.list.model.get(currentIndex)
