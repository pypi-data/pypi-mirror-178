...
AjaxPopup {
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                app.hub_management_module.reg_device_cancel(hub_id)
                popup.close()
            }
    ...
    Connections {
        ...
        onSocketTypeGIsAlreadyAdded: {
            popup.text = tr.hold_button_complete_registration
        }

        onLightSwitchIsAlreadyAdded: {
            popup.text = tr.connection_press_button_lightswitch
        }
    }
}
