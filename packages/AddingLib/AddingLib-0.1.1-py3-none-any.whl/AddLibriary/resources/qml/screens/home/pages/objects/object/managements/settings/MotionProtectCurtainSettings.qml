    ...
    Parts.CommonSettings {
        ...
        generateSettings: () => {
            var settings = {
                ...
                "pet_immunity": petImmunity.checked,
        ...
        Column {
            ...
            DS3.SettingsContainer {
                ...
                Settings.PetImmunity { id: petImmunity }

                Settings.Antimasking {
                    id: antimasking

                    visible: device.has_antimasking
                }
            ...
            DS3.SettingsContainer {
                ...
                Settings.IfMaskingSensor {
                    id: ifMaskingSensor

                    visible: device.has_antimasking && antimasking.checked
                }
            }
        ...
        DS3.SettingsContainer {
            Column {
                ...
                Parts.TestSignalLevelNav {
                    visible: device.firmware_version != '6.58.3.9'
                }
                Parts.TestZoneNav {}
