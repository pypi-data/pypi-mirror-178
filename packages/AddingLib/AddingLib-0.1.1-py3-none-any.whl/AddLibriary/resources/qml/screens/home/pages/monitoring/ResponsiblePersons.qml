...
Rectangle {
    ...
    ListView {
        ...
        RowLayout {
            ...
            Image {
                source: "qrc:/resources/images/incidents/cards/a-control-left.svg"
                sourceSize.width: 12
                ...
                Custom.HandMouseArea {
                    ...
                    onClicked: {
                        if (0 == listView.currentIndex) {
                            listView.currentIndex = incident.filtered_responsible_persons.length - 1
                            return
                        }
            ...
            Image {
                ...
                Custom.HandMouseArea {
                    ...
                    onClicked: {
                        if (incident.filtered_responsible_persons.length - 1 == listView.currentIndex) {
