...
AjaxPopup {
    ...
    Rectangle {
        ...
        AjaxSettingsCombobox {
            ...
            model: popup.management.devices.wire_inputs_model
            currentIndex: 0
            anchors {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                var settings = {
                    ...
                    "wire_input_type": deviceTypeCombobox.currentIndex + 1,
                    "external_contact_mode": 2,
                }
                ...
                var device = null
                device = popup.management.devices.available_wire_inputs[deviceNumberCombobox.currentIndex]
