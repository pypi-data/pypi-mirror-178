...
from fipper.api import functions, types
from fipper.api.core import Object
from fipper.api.errors import (
...
from fipper.crypto import CTR
from fipper.extensions import Markdown
...
class Client:
    ...
    def send(self, data: Object):
        ...
        Available functions are listed in the :obj:`fipper.api.functions` package and may accept compound
        data types from :obj:`fipper.api.types` as well as bare types such as :obj:`int`, :obj:`str`, etc...
    ...
    def get_me(self):
        ...
        Returns:
            Full information about the user in form of a :obj:`UserFull <fipper.api.types.UserFull>` object.
    ...
    def send_chat_action(self,
        ...
        Args:
            ...
            action (:obj:`callable`):
                ...
                Choose one from the :class:`fipper.ChatAction` class,
