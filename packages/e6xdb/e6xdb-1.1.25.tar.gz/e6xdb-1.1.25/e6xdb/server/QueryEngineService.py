...
class Processor(Iface, TProcessor):
    ...
    def process_cancelQuery(self, seqid, iprot, oprot):
        ...
        try:
            ...
            logger.exception('TApplication exception in handler')
            msg_type = TMessageType.EXCEPTION
            result = ex
        except Exception:
            logger.exception('Unexpected exception in handler')
            msg_type = TMessageType.EXCEPTION
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.queryId = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
...
class prepareStatement_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.sSchemaName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                                   0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.query = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                             0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
...
class authenticate_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.user = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                            0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.password = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                                0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
...
class getTables_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.schema = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                              0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                             0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                              0] == 2 else iprot.readString()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.table = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[
                                                                                             0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
