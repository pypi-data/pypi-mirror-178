...
def checkAMLService(req):
    ...
    # UAT
    SQL_Order1 = "SELECT * FROM fec_db.fec_dbsync_amltable WHERE PERSON_ID = '{}'"
    SQL_Order2 = "SELECT * FROM fec_db.fec_dbsync_amltable WHERE FULL_NAME = '{}' AND ID_NO = '{}'"
    SQL_Order3 = "SELECT * FROM fec_db.fec_dbsync_amltable WHERE FULL_NAME = '{}' AND DOB = '{}'"
    SQL_Order4 = "SELECT * FROM fec_db.fec_dbsync_amltable WHERE FULL_NAME = '{}'"
    # print(SQL)
    SQL = ""
    isReject = True
    response = {}
