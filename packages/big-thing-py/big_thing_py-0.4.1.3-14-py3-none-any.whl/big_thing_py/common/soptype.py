...
class SoPProtocolType:
    ...
    class Super(Enum):
        ...
        # PC/EXECUTE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        PC_EXECUTE = 'PC/EXECUTE/%s/%s/%s/%s'

        # PC/RESULT/EXECUTE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        PC_RESULT_EXECUTE = 'PC/RESULT/EXECUTE/%s/%s/%s/%s'

        # PC/SCHEDULE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        PC_SCHEDULE = 'PC/SCHEDULE/%s/%s/%s/%s'

        # PC/RESULT/SCHEDULE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        ...
        # CP/EXECUTE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        CP_EXECUTE = 'CP/EXECUTE/%s/%s/%s/%s'

        # CP/RESULT/EXECUTE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        CP_RESULT_EXECUTE = 'CP/RESULT/EXECUTE/%s/%s/%s/%s'

        # CP/SCHEDULE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
        CP_SCHEDULE = 'CP/SCHEDULE/%s/%s/%s/%s'

        # CP/RESULT/SCHEDULE/[TargetFunctionName]/[TargetThingName]/[TargetMiddlewareName]/[RequesterMWName]
