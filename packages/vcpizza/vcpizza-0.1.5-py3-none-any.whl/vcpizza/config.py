...
import yaml
from vcpizza.exceptions import ConfigDoesNotExistException, InvalidConfiguration


logger = logging.getLogger(__name__)

USER_CONFIG_PATH = os.path.expanduser("~/.vcpizzarc")
...
DEFAULT_CONFIG = {
    "vcpizzas_dir": os.path.expanduser("~/.vcpizzas/"),
    "replay_dir": os.path.expanduser("~/.vcpizza_replay/"),
...
def get_config(config_path):
    ...
    raw_cookies_dir = config_dict["vcpizzas_dir"]
    config_dict["vcpizzas_dir"] = _expand_path(raw_cookies_dir)
...
def get_user_config(config_file=None, default_config=False):
    ...
    Otherwise look up the config file path in the ``vcpizza_CONFIG``
    ...
    try:
        ...
        env_config_file = os.environ["vcpizza_CONFIG"]
    except KeyError:
