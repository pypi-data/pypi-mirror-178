...
class Group(object):
    ...
    def __init__(self, id=None, name=None, version_id=None, parent_group_id=None, last_update_date_utc=None, last_update_user=None, _configuration=None):  # noqa: E501
