...
class FixedField(object):
    ...
    def __init__(self, id=None, display_name=None, property_name=None, entity_type=None, value_type=None, read_only=None, table_reference=None, is_computable=None, _configuration=None):  # noqa: E501
