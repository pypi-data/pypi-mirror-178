...
class MediaTypeFormatter(object):
    ...
    def __init__(self, supported_media_types=None, supported_encodings=None, media_type_mappings=None, required_member_selector=None, _configuration=None):  # noqa: E501
