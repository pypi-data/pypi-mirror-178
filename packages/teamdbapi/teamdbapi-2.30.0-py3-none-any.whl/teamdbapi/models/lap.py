...
class Lap(object):
    ...
    def absolute_number(self, absolute_number):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and absolute_number is None:
    ...
    def lap_date(self, lap_date):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and lap_date is None:
    ...
    def lap_time(self, lap_time):
        ...
        :type: float
        """
        if self._configuration.client_side_validation and lap_time is None:
