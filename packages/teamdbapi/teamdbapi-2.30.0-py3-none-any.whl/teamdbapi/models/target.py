...
class Target(object):
    ...
    def __init__(self, id=None, name=None, description=None, file_format=None, auto_generate_assembly=None, auto_generate_assembly_version_id=None, revision_merge_comment_mandatory=None, assembly_name_suffix=None, _configuration=None):  # noqa: E501
    ...
    def file_format(self):
        ...
        The file format used to create the target versions.  Simu = 1, M = 2, Dcm = 3, Clx = 4  # noqa: E501
    ...
    def file_format(self, file_format):
        ...
        allowed_values = ["Simu", "M", "Dcm", "Clx"]  # noqa: E501
        if (self._configuration.client_side_validation and
                file_format not in allowed_values):
            raise ValueError(
