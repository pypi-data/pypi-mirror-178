...
class CodePageDataItem(object):
    ...
    def __init__(self, m_data_index=None, m_ui_family_code_page=None, m_web_name=None, m_header_name=None, m_body_name=None, m_flags=None, _configuration=None):  # noqa: E501
