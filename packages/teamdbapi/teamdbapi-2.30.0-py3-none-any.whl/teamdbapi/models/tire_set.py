...
class TireSet(object):
    ...
    def mounting_direction_fl(self, mounting_direction_fl):
        ...
        if (self._configuration.client_side_validation and
                mounting_direction_fl not in allowed_values):
            raise ValueError(
    ...
    def mounting_direction_fr(self, mounting_direction_fr):
        ...
        allowed_values = ["Forward", "Reverse"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mounting_direction_fr not in allowed_values):
            raise ValueError(
    ...
    def mounting_direction_rl(self, mounting_direction_rl):
        ...
        allowed_values = ["Forward", "Reverse"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mounting_direction_rl not in allowed_values):
            raise ValueError(
    ...
    def mounting_direction_rr(self, mounting_direction_rr):
        ...
        allowed_values = ["Forward", "Reverse"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mounting_direction_rr not in allowed_values):
            raise ValueError(
    ...
    def heating_oven(self):
        ...
        Oven name used for the heating  # noqa: E501
    ...
    def heating_tire_comment(self):
        ...
        Comments corresponding to the tires  # noqa: E501
