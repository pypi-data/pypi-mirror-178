...
class Car(object):
    ...
    def __init__(self, id=None, name=None, event_id=None, type_car_id=None, last_update_date_utc=None, last_update_user=None, revision=None, lap_count=None, run_count=None, session_count=None, distance=None, distance_real=None, _configuration=None):  # noqa: E501
    ...
    def type_car_id(self, type_car_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and type_car_id is None:
