...
class ValueField(object):
    ...
    def __init__(self, id=None, model_field_id=None, value=None, is_valid=True, parent_item_id=None, last_update_date_utc=None, last_update_user=None, _configuration=None):  # noqa: E501
    ...
    def model_field_id(self, model_field_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and model_field_id is None:
    ...
    def parent_item_id(self, parent_item_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and parent_item_id is None:
