...
class Tire(object):
    ...
    def type_tire_id(self, type_tire_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and type_tire_id is None:
