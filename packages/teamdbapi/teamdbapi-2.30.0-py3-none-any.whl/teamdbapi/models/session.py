...
class Session(object):
    ...
    def __init__(self, id=None, name=None, number=None, car_id=None, track_layout_id=None, session_date=None, session_status=None, last_update_date_utc=None, last_update_user=None, revision=None, lap_count=None, run_count=None, distance=None, distance_real=None, default_assemblies=None, duration=None, _configuration=None):  # noqa: E501
    ...
    def car_id(self, car_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and car_id is None:
    ...
    def track_layout_id(self, track_layout_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and track_layout_id is None:
    ...
    def session_date(self, session_date):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and session_date is None:
    ...
    def session_status(self, session_status):
        ...
        if (self._configuration.client_side_validation and
                session_status not in allowed_values):
            raise ValueError(
