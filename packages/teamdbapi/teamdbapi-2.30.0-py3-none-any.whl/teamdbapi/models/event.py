...
class Event(object):
    ...
    def __init__(self, id=None, name=None, event_date=None, track_id=None, event_type=None, lock_status=None, lock_host_name=None, last_update_date_utc=None, last_update_user=None, revision=None, replication_filter=None, _configuration=None):  # noqa: E501
    ...
    def track_id(self, track_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and track_id is None:
    ...
    def lock_status(self, lock_status):
        ...
        if (self._configuration.client_side_validation and
                lock_status not in allowed_values):
            raise ValueError(
