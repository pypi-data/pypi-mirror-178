...
class TrackLayout(object):
    ...
    def __init__(self, id=None, name=None, length=None, track_id=None, last_update_date_utc=None, last_update_user=None, revision=None, _configuration=None):  # noqa: E501
