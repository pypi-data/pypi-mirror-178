...
class EditApi(object):
    ...
    def edit_copy_from_tag(self, tag, copy_from_tags_args, **kwargs):  # noqa: E501
        """[Command] Copy values corresponding to the given Tag from a context to another  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_copy_from_tag(tag, copy_from_tags_args, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.edit_copy_from_tag_with_http_info(tag, copy_from_tags_args, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_copy_from_tag_with_http_info(tag, copy_from_tags_args, **kwargs)  # noqa: E501
            return data

    def edit_copy_from_tag_with_http_info(self, tag, copy_from_tags_args, **kwargs):  # noqa: E501
        """[Command] Copy values corresponding to the given Tag from a context to another  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_copy_from_tag_with_http_info(tag, copy_from_tags_args, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method edit_copy_from_tag" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('tag' not in params or
            ...
            raise ValueError("Missing the required parameter `tag` when calling `edit_copy_from_tag`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('copy_from_tags_args' not in params or
            ...
            raise ValueError("Missing the required parameter `copy_from_tags_args` when calling `edit_copy_from_tag`")  # noqa: E501
    ...
    def edit_get_current_selected_context(self, **kwargs):  # noqa: E501
        """Get the current selected notes context  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_get_current_selected_context(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_get_current_selected_context_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.edit_get_current_selected_context_with_http_info(**kwargs)  # noqa: E501
            return data

    def edit_get_current_selected_context_with_http_info(self, **kwargs):  # noqa: E501
        """Get the current selected notes context  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_get_current_selected_context_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method edit_get_current_selected_context" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def edit_set_current_context(self, event_id, car_id, session_id, run_id, lap_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_set_current_context(event_id, car_id, session_id, run_id, lap_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edit_set_current_context_with_http_info(event_id, car_id, session_id, run_id, lap_id, **kwargs)  # noqa: E501
        else:
            (data) = self.edit_set_current_context_with_http_info(event_id, car_id, session_id, run_id, lap_id, **kwargs)  # noqa: E501
            return data

    def edit_set_current_context_with_http_info(self, event_id, car_id, session_id, run_id, lap_id, **kwargs):  # noqa: E501
        """[Command] Set the current Event, Car, Session, Run, Lap selected.  Enter the empty unique identifier value 00000000-0000-0000-0000-000000000000 to select the default value.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edit_set_current_context_with_http_info(event_id, car_id, session_id, run_id, lap_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method edit_set_current_context" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('event_id' not in params or
            ...
            raise ValueError("Missing the required parameter `event_id` when calling `edit_set_current_context`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('car_id' not in params or
            ...
            raise ValueError("Missing the required parameter `car_id` when calling `edit_set_current_context`")  # noqa: E501
        # verify the required parameter 'session_id' is set
        if self.api_client.client_side_validation and ('session_id' not in params or
                                                       params['session_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `session_id` when calling `edit_set_current_context`")  # noqa: E501
        # verify the required parameter 'run_id' is set
        if self.api_client.client_side_validation and ('run_id' not in params or
                                                       params['run_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `run_id` when calling `edit_set_current_context`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('lap_id' not in params or
            ...
            raise ValueError("Missing the required parameter `lap_id` when calling `edit_set_current_context`")  # noqa: E501
