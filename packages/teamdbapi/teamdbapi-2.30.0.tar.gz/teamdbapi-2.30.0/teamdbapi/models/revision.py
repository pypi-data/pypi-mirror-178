...
class Revision(object):
    ...
    def __init__(self, id=None, name=None, date_revision=None, maturity=None, value=None, parameter_id=None, is_obsolete=None, parameter_value_check_sum=None, comment=None, user_name=None, last_update_date_utc=None, is_new=None, data_updated_date=None, data_axe_x=None, data_axe_y=None, data_axe_z=None, _configuration=None):  # noqa: E501
    ...
    def date_revision(self, date_revision):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and date_revision is None:
    ...
    def parameter_id(self, parameter_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and parameter_id is None:
