...
class CompareOptions(object):
    ...
    def __init__(self, parameters_selection_filters=None, exclude_parameters_in_selection=None, diff_file_path=None, diff_group=None, _configuration=None):  # noqa: E501
    ...
    def diff_group(self, diff_group):
        ...
        if (self._configuration.client_side_validation and
                diff_group not in allowed_values):
            raise ValueError(
