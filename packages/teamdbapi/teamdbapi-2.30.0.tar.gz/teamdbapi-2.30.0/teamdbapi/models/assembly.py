...
class Assembly(object):
    ...
    def date_assembly(self, date_assembly):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and date_assembly is None:
