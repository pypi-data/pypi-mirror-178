...
class LapReportOptions(object):
    ...
    def __init__(self, use_single_lap_mode=None, lap_report_file_format=None, lap_report_file_path=None, _configuration=None):  # noqa: E501
    ...
    def use_single_lap_mode(self, use_single_lap_mode):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and use_single_lap_mode is None:
    ...
    def lap_report_file_format(self, lap_report_file_format):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and lap_report_file_format is None:
        ...
        if (self._configuration.client_side_validation and
                lap_report_file_format not in allowed_values):
            raise ValueError(
