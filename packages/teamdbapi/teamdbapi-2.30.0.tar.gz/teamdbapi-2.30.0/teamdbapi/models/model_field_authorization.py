...
class ModelFieldAuthorization(object):
    ...
    def __init__(self, id=None, concerned_entity_id=None, concerned_entity_is_group=None, model_field_id=None, can_read=None, can_write=None, _configuration=None):  # noqa: E501
