...
class Version(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_date=None, reference_files=None, target_id=None, auto_generate_assembly_id=None, last_update_date_utc=None, last_update_user=None, replication_filter=None, _configuration=None):  # noqa: E501
    ...
    def reference_files(self):
        ...
        The path to the file used to create the version.  In json, you have to double the \\ in the path. For example : C:\\\\\\\\MyFolder\\\\\\\\MyFile.m  # noqa: E501
    ...
    def reference_files(self, reference_files):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and reference_files is None:
    ...
    def replication_filter(self, replication_filter):
        ...
        if (self._configuration.client_side_validation and
                replication_filter not in allowed_values):
            raise ValueError(
