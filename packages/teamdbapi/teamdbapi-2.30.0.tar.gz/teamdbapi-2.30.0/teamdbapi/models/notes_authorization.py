...
class NotesAuthorization(object):
    ...
    def __init__(self, id=None, concerned_entity_id=None, concerned_entity_is_group=None, item_base_id=None, has_acces=None, _configuration=None):  # noqa: E501
    ...
    def concerned_entity_id(self, concerned_entity_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and concerned_entity_id is None:
    ...
    def item_base_id(self, item_base_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and item_base_id is None:
    ...
    def has_acces(self, has_acces):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and has_acces is None:
