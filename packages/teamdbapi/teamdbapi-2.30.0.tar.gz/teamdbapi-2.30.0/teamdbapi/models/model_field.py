...
class ModelField(object):
    ...
    def type_of_model_field(self, type_of_model_field):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and type_of_model_field is None:
        ...
        if (self._configuration.client_side_validation and
                type_of_model_field not in allowed_values):
            raise ValueError(
    ...
    def type_of_value(self, type_of_value):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and type_of_value is None:
        ...
        if (self._configuration.client_side_validation and
                type_of_value not in allowed_values):
            raise ValueError(
    ...
    def type_of_value_source(self, type_of_value_source):
        ...
        if (self._configuration.client_side_validation and
                type_of_value_source not in allowed_values):
            raise ValueError(
    ...
    def calcul_type(self, calcul_type):
        ...
        if (self._configuration.client_side_validation and
                calcul_type not in allowed_values):
            raise ValueError(
    ...
    def revision_editor_display_format(self, revision_editor_display_format):
        ...
        if (self._configuration.client_side_validation and
                revision_editor_display_format not in allowed_values):
            raise ValueError(
