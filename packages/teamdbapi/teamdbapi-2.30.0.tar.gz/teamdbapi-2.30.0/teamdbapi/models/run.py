...
class Run(object):
    ...
    def run_date(self, run_date):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and run_date is None:
