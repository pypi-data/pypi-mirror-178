...
class LineChartWidget(Widget, LineChart):
    def __init__(self,
        ...
        LineChart.__init__(self, data=data, title=title, views=views, temporal_context=temporal_context, filtering_context=filtering_context, multi_line_chart=multi_line_chart)
