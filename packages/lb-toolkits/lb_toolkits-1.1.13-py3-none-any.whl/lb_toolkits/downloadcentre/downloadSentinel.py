...
class downloadSentinel():
    ...
    def __init__(self, username, password, platformname='Sentinel-2',  producttype='S2MSI2A'):
        ...
        if platformname in ['Sentinel-5 Precursor'] :
            self.api =SentinelAPI(username, password,'https://s5phub.copernicus.eu/dhus/')
        else:
    ...
    def searchfile(self, starttime, endtime=None,
        ...
        products = self.api.query(area=footprint,                        #Area范围
                            ...
                            platformname=self.platformname,        #卫星平台名，Sentinel-2
