...
Field_SQL = {
    ...
    'Float': ("{{field_name}} float{% if max_len  %}({{max_len}}){% endif %} {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %} DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),

    'Double': ("{{field_name}} double {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %}DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),

    'Blob': ("{{field_name}} blob {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %}DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),

    'DateTime': ("{{field_name}} datetime {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %}DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),

    'Date': ("{{field_name}} date {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %}DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),

    'Time': ("{{field_name}} time {% if null  %}NULL{%elif null==false%} NOT NULL {% endif %}"
             "{% if primary_key %} PRIMARY KEY  {% endif %} {% if auto_increment %}AUTO_INCREMENT {% endif %} {% if unique %} UNIQUE  {% endif %}"
             "{% if default==true or default==0 %}DEFAULT {% if default is number %}{{default}} {% else %} '{{default}}'{% endif %} {% endif %} {% if verbose_name %}COMMENT '{{verbose_name}}'  {% endif %}"),
