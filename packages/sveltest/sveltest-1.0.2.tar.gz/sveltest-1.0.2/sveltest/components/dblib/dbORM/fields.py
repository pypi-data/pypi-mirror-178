...
class FloatField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(FloatField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="Float",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
...
class DoubleField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(DoubleField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="Double",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
...
class DateTimeField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(DateTimeField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="DateTime",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
...
class BlobField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(BlobField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="Blob",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
...
class TimeField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(TimeField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="Time",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
...
class DateField(Field):
    ...
    def __init__(self,
                   ...
                   default:Optional[Union[str,int]]=None,verbose_name:Optional[Union[str,int]]=None,
                   primary_key:bool=False,auto_increment:bool=False,null=True,unique:Optional[bool]=False):
        super(DateField, self).__init__(null=null,default=default,
                                           # unique=unique
                                           )
        self.max_len = max_len
        self.default = default
    ...
    def db(self):
        ...
        return self.get_string(
            max_len=self.max_len,field_type="Date",default=self.default,verbose_name=self.verbose_name,primary_key=self.primary_key,
            auto_increment=self.auto_increment,null=self.null,unique=self.unique
        )
