...
from getsubstr.setuptools import get_file_content
...
def get_substring(regexp_pattern: str, line: str, output_format: str = None, join_with: str = None,
    ...
    if not join_with:
        join_with = "\t"
    import sys; sys.path.append("/tmp/_pydbg/pycharm-debug-py3k.egg"); import pydevd; pydevd.settrace('localhost', port=7878, stdoutToServer=True, stderrToServer=True)
