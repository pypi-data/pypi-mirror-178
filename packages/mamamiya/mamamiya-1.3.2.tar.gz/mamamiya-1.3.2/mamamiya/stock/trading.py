...
import numpy as np
import datetime
from mamamiya.stock import cons as ct
import re
from pandas.compat import StringIO
from mamamiya.util import dateu as du
from mamamiya.util.formula import MA
import os
from mamamiya.util.conns import get_apis, close_apis
from mamamiya.stock.fundamental import get_stock_basics
try:
...
def reset_instrument(xapi=None):
    """
            重新设置本地证券列表
    """
    import mamamiya.util.conns as cs 
