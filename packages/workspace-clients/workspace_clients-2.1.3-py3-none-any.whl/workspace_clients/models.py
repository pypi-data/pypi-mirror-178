...
class BaseModel(_BaseModel):
    ...
    @validator("name", "description", pre=True, allow_reuse=True, check_fields=False)
    def _trim_max_length(cls, value, values, config, field):  # type: ignore
        if value:
            return value[: field.type_.max_length]
        return value
