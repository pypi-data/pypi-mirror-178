...
#                lines['RUTMandante']
    ...
    def IVAOtrMnda(self):
        if not hasattr(self, '_iva_otr_mnda'):
            ...
            decimal.getcontext().rounding = decimal.ROUND_HALF_UP
            _iva_otr_mnda = int(decimal.Decimal(_iva_otr_mnda).to_integral_value())
    ...
    def MntNetoOtrMnda(self):
        if not hasattr(self, '_mnt_neto_otr_mnda'):
            ...
            decimal.getcontext().rounding = decimal.ROUND_HALF_UP
            _mnt_neto_otr_mnda = int(decimal.Decimal(_mnt_neto_otr_mnda).to_integral_value())
            return self._aplicar_dsc_rcg(_mnt_neto_otr_mnda, OtrMnda=True)
