...
class Database(object):
    ...
    def select_collection(self, collection_name, indexes=None, immut_keys=None, user_defined=True) -> "Collection":
        ...
        return Collection(collection=col, immut_keys=immut_keys, custom_ops=self._custom_ops)
...
class Collection(object):
    ...
    def __init__(self, collection,  immut_keys:list=[], custom_ops:dict={}):
    ...
    def find_one(self, filters:dict):
        ...
        Returns
            CollectionItem
        """
        if data := list(self.collection.find(filters=filters, limit=1)):
            return self.item(data[0])
        return None
