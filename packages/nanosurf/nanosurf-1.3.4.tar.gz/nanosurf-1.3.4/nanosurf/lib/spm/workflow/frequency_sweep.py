...
class InputSource(enum.Enum):
    ...
    InDetectorSum = enum.auto(),
    In6 = enum.auto(),
    CtrlX_Out = enum.auto(),
    CtrlY_Out = enum.auto(),
    CtrlW_Out = enum.auto(),
    CtrlUser1_Out = enum.auto(),
    CtrlUser2_Out = enum.auto(),
    Analyzer1_CtrlDeltaF = enum.auto(),
    Analyzer1_CtrlAmplitude = enum.auto(),
    Analyzer1_Phase = enum.auto(),
    Analyzer1_Amplitude = enum.auto(),
    Analyzer1_X = enum.auto(),
    Analyzer1_Y = enum.auto(),
    ...
    Ort_Baseline = enum.auto(),
    Ort_AmplitudeReduction = enum.auto(),
    Ort_Excitation = enum.auto(),
