...
from pyabsa.tasks.RNARegression.models.__classic__.lstm import LSTM
from pyabsa.tasks.RNARegression.models.__plm__.bert import BERT_MLP

_rnar_config_template = {'model': BERT_MLP,
                         'optimizer': "adamw",
...
_rnar_config_base = {'model': BERT_MLP,
                     'optimizer': "adamw",
                     'learning_rate': 0.00002,
...
_rnar_config_english = {'model': BERT_MLP,
                        'optimizer': "adamw",
                        'learning_rate': 0.00002,
                        'patience': 99999,
                        'pretrained_bert': "microsoft/deberta-v3-base",
...
_rnar_config_multilingual = {'model': BERT_MLP,
                             'optimizer': "adamw",
                             'learning_rate': 0.00002,
                             'patience': 99999,
...
_rnar_config_chinese = {'model': BERT_MLP,
                        'optimizer': "adamw",
                        'learning_rate': 0.00002,
                        'patience': 99999,
                        'cache_dataset': True,
