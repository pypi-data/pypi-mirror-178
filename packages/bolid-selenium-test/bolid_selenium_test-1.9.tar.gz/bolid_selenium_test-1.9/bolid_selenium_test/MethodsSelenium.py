...
class Methods:
    ...
    def assert_equal(self, input: str, expected: str, locator: str):
        self.input_values(input, locator)
        self.assert_values(expected, locator)
    ...
    def assert_tooltip_text(self, text: str, locator: str):
        self.element_focus(locator)
        self.assert_element_text((By.XPATH, '//*[@class="b-tooltip-text"]'), text)
    ...
    def assert_field_param(self, locator: str, param: str, value: str):
        try:
            wd = self.app.wd
            field_value = WebDriverWait(wd, 10).until(
                EC.visibility_of_element_located((locator)))
