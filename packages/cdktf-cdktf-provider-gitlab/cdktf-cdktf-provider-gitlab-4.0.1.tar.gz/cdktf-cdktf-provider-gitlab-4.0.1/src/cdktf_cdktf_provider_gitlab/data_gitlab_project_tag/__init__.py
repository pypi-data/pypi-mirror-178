...
Refer to the Terraform Registory for docs: [`data_gitlab_project_tag`](https://www.terraform.io/docs/providers/gitlab/d/project_tag).
'''
import abc
import builtins
import datetime
...
class DataGitlabProjectTagCommitOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataGitlabProjectTagCommit]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataGitlabProjectTagReleaseOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataGitlabProjectTagRelease]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
