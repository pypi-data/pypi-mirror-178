...
@LastEditTime: 2022-11-24 18:59:29
...
class FrameBaseHandler(BaseApiHandler):
    ...
    def response_json_error(self, error_code="", error_message="", data=None, log_type=0, is_close_encrypt=False):
        """
        ...
        self.response_common(False, data, error_code, error_message, is_close_encrypt)
