...
@LastEditTime: 2022-11-24 09:33:31
...
class WeChatHelper:
    ...
    @classmethod
    def create_qr_code(self, page, scene="a=1", width=430, app_id="", app_secret="", no_limit_code=True):
        """
