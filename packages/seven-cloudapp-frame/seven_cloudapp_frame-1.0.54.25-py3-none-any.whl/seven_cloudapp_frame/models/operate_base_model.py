...
@LastEditTime: 2022-11-28 14:44:31
            ...
            if len(read_config) > 0:
                ...
                if default:
                    ...
                    for item in value.split(','):
                        cur_remark = config_fields.get("value", {}).get(str(item), "")
                        if cur_remark:
        ...
        try:
            ...
            if operation_log["update_detail"] and isinstance(operation_log["update_detail"], dict):
                ...
                for key in operation_log["update_detail"]:
                    ...
                    if not config_fields or config_fields.get("is_show",1) == 0:
                        continue
                    ...
                    if is_all_fields == True:
                        info = {}
                        info["field"] = key
                        info["sort_index"] = config_fields.get("sort_index",1000)
