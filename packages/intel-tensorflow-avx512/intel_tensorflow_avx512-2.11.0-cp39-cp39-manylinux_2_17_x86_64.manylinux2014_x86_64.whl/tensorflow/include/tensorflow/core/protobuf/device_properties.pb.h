...
public:
  ...
  explicit constexpr DeviceProperties_EnvironmentEntry_DoNotUse(
...
class DeviceProperties final :
 ...
 public:
  ...
  explicit constexpr DeviceProperties(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class NamedDevice final :
 ...
 public:
  ...
  explicit constexpr NamedDevice(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void NamedDevice::set_allocated_properties(::tensorflow::DeviceProperties* properties) {
  ...
  if (properties) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::DeviceProperties>::GetOwningArena(properties);
