...
_MEMORYLOGSTEP = DESCRIPTOR.message_types_by_name['MemoryLogStep']
_MEMORYLOGTENSORALLOCATION = DESCRIPTOR.message_types_by_name['MemoryLogTensorAllocation']
_MEMORYLOGTENSORDEALLOCATION = DESCRIPTOR.message_types_by_name['MemoryLogTensorDeallocation']
_MEMORYLOGTENSOROUTPUT = DESCRIPTOR.message_types_by_name['MemoryLogTensorOutput']
_MEMORYLOGRAWALLOCATION = DESCRIPTOR.message_types_by_name['MemoryLogRawAllocation']
_MEMORYLOGRAWDEALLOCATION = DESCRIPTOR.message_types_by_name['MemoryLogRawDeallocation']
