...
class TPUHardwareFeature final :
 ...
 public:
  ...
  explicit constexpr TPUHardwareFeature(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void TopologyProto::clear_tpu_hardware_feature() {
  if (GetArenaForAllocation() == nullptr && tpu_hardware_feature_ != nullptr) {
...
inline void TopologyProto::unsafe_arena_set_allocated_tpu_hardware_feature(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(tpu_hardware_feature_);
  }
...
inline void TopologyProto::set_allocated_tpu_hardware_feature(::tensorflow::tpu::TPUHardwareFeature* tpu_hardware_feature) {
  ...
  if (tpu_hardware_feature) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::tpu::TPUHardwareFeature>::GetOwningArena(tpu_hardware_feature);
