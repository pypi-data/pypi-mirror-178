...
class FingerprintDef final :
 ...
 public:
  ...
  uint64_t graph_def_checksum() const;
  void set_graph_def_checksum(uint64_t value);
  private:
  uint64_t _internal_graph_def_checksum() const;
  void _internal_set_graph_def_checksum(uint64_t value);
  public:
...
inline uint64_t FingerprintDef::_internal_graph_def_checksum() const {
  return graph_def_checksum_;
}
inline uint64_t FingerprintDef::graph_def_checksum() const {
  // @@protoc_insertion_point(field_get:tensorflow.FingerprintDef.graph_def_checksum)
  return _internal_graph_def_checksum();
}
inline void FingerprintDef::_internal_set_graph_def_checksum(uint64_t value) {
  
  graph_def_checksum_ = value;
}
inline void FingerprintDef::set_graph_def_checksum(uint64_t value) {
