...
class XlaSerializedCacheKey final :
 ...
 public:
  ...
  explicit constexpr XlaSerializedCacheKey(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class XlaSerializedCacheEntry final :
 ...
 public:
  ...
  explicit constexpr XlaSerializedCacheEntry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void XlaSerializedCacheKey::clear_signature_fingerprint() {
  signature_fingerprint_ = uint64_t{0u};
}
...
inline void XlaSerializedCacheKey::clear_cluster_fingerprint() {
  cluster_fingerprint_ = uint64_t{0u};
}
...
inline void XlaSerializedCacheEntry::set_allocated_key(::tensorflow::XlaSerializedCacheKey* key) {
  ...
  if (key) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::XlaSerializedCacheKey>::GetOwningArena(key);
...
void XlaSerializedCacheEntry::set_executable(ArgT0&& arg0, ArgT... args) {
 ...
 executable_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void XlaSerializedCacheEntry::_internal_set_executable(const std::string& value) {
  ...
  executable_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* XlaSerializedCacheEntry::_internal_mutable_executable() {
  
  return executable_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* XlaSerializedCacheEntry::release_executable() {
  ...
  return executable_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void XlaSerializedCacheEntry::set_allocated_executable(std::string* executable) {
  ...
  executable_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), executable,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (executable_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    executable_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
