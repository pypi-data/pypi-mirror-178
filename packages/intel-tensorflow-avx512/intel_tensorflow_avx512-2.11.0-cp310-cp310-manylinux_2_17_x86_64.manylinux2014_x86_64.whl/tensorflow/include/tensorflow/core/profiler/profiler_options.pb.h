...
class ProfileOptions final :
 ...
 public:
  ...
  explicit constexpr ProfileOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RemoteProfilerSessionManagerOptions final :
 ...
 public:
  ...
  explicit constexpr RemoteProfilerSessionManagerOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void ProfileOptions::clear_start_timestamp_ns() {
  start_timestamp_ns_ = uint64_t{0u};
}
...
void ProfileOptions::set_repository_path(ArgT0&& arg0, ArgT... args) {
 ...
 repository_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& ProfileOptions::_internal_repository_path() const {
  return repository_path_.Get();
}
inline void ProfileOptions::_internal_set_repository_path(const std::string& value) {
  
  repository_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ProfileOptions::_internal_mutable_repository_path() {
  
  return repository_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ProfileOptions::release_repository_path() {
  ...
  return repository_path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ProfileOptions::set_allocated_repository_path(std::string* repository_path) {
  ...
  repository_path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), repository_path,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (repository_path_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    repository_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
inline void RemoteProfilerSessionManagerOptions::clear_profiler_options() {
  if (GetArenaForAllocation() == nullptr && profiler_options_ != nullptr) {
...
inline void RemoteProfilerSessionManagerOptions::unsafe_arena_set_allocated_profiler_options(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(profiler_options_);
  }
...
inline void RemoteProfilerSessionManagerOptions::set_allocated_profiler_options(::tensorflow::ProfileOptions* profiler_options) {
  ...
  if (profiler_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::ProfileOptions>::GetOwningArena(profiler_options);
...
inline void RemoteProfilerSessionManagerOptions::clear_session_creation_timestamp_ns() {
  session_creation_timestamp_ns_ = uint64_t{0u};
}
...
inline void RemoteProfilerSessionManagerOptions::clear_max_session_duration_ms() {
  max_session_duration_ms_ = uint64_t{0u};
}
