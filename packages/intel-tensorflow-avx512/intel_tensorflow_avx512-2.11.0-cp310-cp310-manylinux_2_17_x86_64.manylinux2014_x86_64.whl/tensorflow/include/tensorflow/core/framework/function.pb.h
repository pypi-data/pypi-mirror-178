...
public:
  ...
  explicit constexpr FunctionDef_ArgAttrs_AttrEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FunctionDef_ArgAttrs final :
 ...
 public:
  ...
  explicit constexpr FunctionDef_ArgAttrs(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr FunctionDef_ArgAttrEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr FunctionDef_ResourceArgUniqueIdEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr FunctionDef_ControlRetEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RegisteredGradient final :
 ...
 public:
  ...
  explicit constexpr RegisteredGradient(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void RegisteredGradient::clear_registered_op_type() {
  registered_op_type_.ClearToEmpty();
}
...
void RegisteredGradient::set_registered_op_type(ArgT0&& arg0, ArgT... args) {
 ...
 registered_op_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RegisteredGradient::_internal_set_registered_op_type(const std::string& value) {
  ...
  registered_op_type_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RegisteredGradient::_internal_mutable_registered_op_type() {
  
  return registered_op_type_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RegisteredGradient::release_registered_op_type() {
  ...
  return registered_op_type_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RegisteredGradient::set_allocated_registered_op_type(std::string* registered_op_type) {
  ...
  registered_op_type_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), registered_op_type,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (registered_op_type_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    registered_op_type_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
