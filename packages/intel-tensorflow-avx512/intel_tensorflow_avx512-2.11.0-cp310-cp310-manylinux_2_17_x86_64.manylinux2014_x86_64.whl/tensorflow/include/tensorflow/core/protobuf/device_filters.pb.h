...
class TaskDeviceFilters final :
 ...
 public:
  ...
  explicit constexpr TaskDeviceFilters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr JobDeviceFilters_TasksEntry_DoNotUse(
...
class JobDeviceFilters final :
 ...
 public:
  ...
  explicit constexpr JobDeviceFilters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ClusterDeviceFilters final :
 ...
 public:
  ...
  explicit constexpr ClusterDeviceFilters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
