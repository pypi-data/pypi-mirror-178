...
class TensorId final :
 ...
 public:
  ...
  ~TensorId() override;
  explicit constexpr TensorId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Feed::set_allocated_id(::tensorflow::tf2xla::TensorId* id) {
  ...
  if (id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::tf2xla::TensorId>::GetOwningArena(id);
