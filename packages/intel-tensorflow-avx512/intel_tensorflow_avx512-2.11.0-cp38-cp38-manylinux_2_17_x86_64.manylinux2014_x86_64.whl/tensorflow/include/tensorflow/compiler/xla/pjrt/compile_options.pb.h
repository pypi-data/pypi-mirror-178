...
class ExecutableBuildOptionsProto final :
 ...
 public:
  ...
  explicit constexpr ExecutableBuildOptionsProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class CompileOptionsProto final :
 ...
 public:
  ...
  explicit constexpr CompileOptionsProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void CompileOptionsProto::clear_executable_build_options() {
  if (GetArenaForAllocation() == nullptr && executable_build_options_ != nullptr) {
...
inline void CompileOptionsProto::unsafe_arena_set_allocated_executable_build_options(
    ::xla::ExecutableBuildOptionsProto* executable_build_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(executable_build_options_);
  }
...
inline void CompileOptionsProto::set_allocated_executable_build_options(::xla::ExecutableBuildOptionsProto* executable_build_options) {
  ...
  if (executable_build_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::xla::ExecutableBuildOptionsProto>::GetOwningArena(executable_build_options);
    if (message_arena != submessage_arena) {
...
inline void CompileOptionsProto::clear_serialized_multi_slice_config() {
  serialized_multi_slice_config_.ClearToEmpty();
}
...
void CompileOptionsProto::set_serialized_multi_slice_config(ArgT0&& arg0, ArgT... args) {
 ...
 serialized_multi_slice_config_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CompileOptionsProto::_internal_serialized_multi_slice_config() const {
  return serialized_multi_slice_config_.Get();
}
inline void CompileOptionsProto::_internal_set_serialized_multi_slice_config(const std::string& value) {
  
  serialized_multi_slice_config_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CompileOptionsProto::_internal_mutable_serialized_multi_slice_config() {
  
  return serialized_multi_slice_config_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CompileOptionsProto::release_serialized_multi_slice_config() {
  ...
  return serialized_multi_slice_config_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CompileOptionsProto::set_allocated_serialized_multi_slice_config(std::string* serialized_multi_slice_config) {
  ...
  serialized_multi_slice_config_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serialized_multi_slice_config,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (serialized_multi_slice_config_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    serialized_multi_slice_config_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
