...
class NodeDef_ExperimentalDebugInfo final :
 ...
 public:
  ...
  explicit constexpr NodeDef_ExperimentalDebugInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void NodeDef::clear_experimental_debug_info() {
  if (GetArenaForAllocation() == nullptr && experimental_debug_info_ != nullptr) {
...
inline void NodeDef::set_allocated_experimental_debug_info(::tensorflow::NodeDef_ExperimentalDebugInfo* experimental_debug_info) {
  ...
  if (experimental_debug_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::NodeDef_ExperimentalDebugInfo>::GetOwningArena(experimental_debug_info);
...
inline bool NodeDef::_internal_has_experimental_type() const {
  return this != internal_default_instance() && experimental_type_ != nullptr;
}
...
inline void NodeDef::unsafe_arena_set_allocated_experimental_type(
    ::tensorflow::FullTypeDef* experimental_type) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(experimental_type_);
  }
