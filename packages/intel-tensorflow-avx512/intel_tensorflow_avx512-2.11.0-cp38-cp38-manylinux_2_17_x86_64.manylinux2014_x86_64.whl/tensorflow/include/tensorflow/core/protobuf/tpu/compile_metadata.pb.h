...
class TPUCompileMetadataProto_Arg final :
 ...
 public:
  ...
  explicit constexpr TPUCompileMetadataProto_Arg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TPUCompileMetadataProto_Retval final :
 ...
 public:
  ...
  explicit constexpr TPUCompileMetadataProto_Retval(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TPUCompileMetadataProto final :
 ...
 public:
  ...
  explicit constexpr TPUCompileMetadataProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TPUCompileOptions final :
 ...
 public:
  ...
  explicit constexpr TPUCompileOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void TPUCompileMetadataProto::clear_function_library_fingerprint() {
  function_library_fingerprint_ = uint64_t{0u};
}
...
inline void TPUCompileMetadataProto::clear_guaranteed_const_fingerprint() {
  guaranteed_const_fingerprint_.ClearToEmpty();
}
...
void TPUCompileMetadataProto::set_guaranteed_const_fingerprint(ArgT0&& arg0, ArgT... args) {
 ...
 guaranteed_const_fingerprint_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TPUCompileMetadataProto::_internal_set_guaranteed_const_fingerprint(const std::string& value) {
  ...
  guaranteed_const_fingerprint_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TPUCompileMetadataProto::_internal_mutable_guaranteed_const_fingerprint() {
  
  return guaranteed_const_fingerprint_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TPUCompileMetadataProto::release_guaranteed_const_fingerprint() {
  ...
  return guaranteed_const_fingerprint_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void TPUCompileMetadataProto::set_allocated_guaranteed_const_fingerprint(std::string* guaranteed_const_fingerprint) {
  ...
  guaranteed_const_fingerprint_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), guaranteed_const_fingerprint,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (guaranteed_const_fingerprint_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    guaranteed_const_fingerprint_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void TPUCompileMetadataProto::clear_compile_options() {
  if (GetArenaForAllocation() == nullptr && compile_options_ != nullptr) {
...
inline void TPUCompileMetadataProto::unsafe_arena_set_allocated_compile_options(
    ::tensorflow::tpu::TPUCompileOptions* compile_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(compile_options_);
  }
...
inline void TPUCompileMetadataProto::set_allocated_compile_options(::tensorflow::tpu::TPUCompileOptions* compile_options) {
  ...
  if (compile_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::tpu::TPUCompileOptions>::GetOwningArena(compile_options);
    if (message_arena != submessage_arena) {
