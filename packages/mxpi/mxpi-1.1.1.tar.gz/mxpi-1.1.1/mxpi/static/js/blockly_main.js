...
function pip_list(){
  ...
  $("#pip-table").tabulator("setData",[
    ...
    {id:4, name:"Mediapipe",  col:"Mediapipe", arr:'win/Liunx/rpi',cheese:re('mediapipe')},
    {id:5, name:"sounddevice",  col:"录音与播放音乐", arr:'win/Liunx/rpi',cheese:re('sounddevice')},
    {id:6, name:"SoundFile",  col:"音频文件操作", arr:'win/Liunx/rpi',cheese:re('SoundFile')},
    {id:7, name:"librosa",  col:"用于音乐和音频分析的python包", arr:'win/Liunx/rpi',cheese:re('librosa')},
    {id:8, name:"hcsr04sensor",  col:"超声波传感器的依赖库", arr:'rpi',cheese:re('hcsr04sensor')},
  ]);
}
...
function install_ku(name){
  ...
  chatSocket.send(JSON.stringify({'msg':'install_ku','name':name,'pipyuan':yuan}))
}
