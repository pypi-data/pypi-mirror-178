...
function c_list(){
  ...
  $("#c-table").tabulator("setData",[
    ...
    {id:19, name:"行空板-1",  col:"行空板打开摄像头",cheese:ce('19')},
    {id:20, name:"行空板-2",  col:"行空板进行色块识别",cheese:ce('20')},
    {id:21, name:"行空板-3",  col:"行空板进行目标检测",cheese:ce('21')},
    {id:22, name:"行空板-4",  col:"行空板GET网络天气进行显示",cheese:ce('22')},
  ]);
}
var model_lists
function model_list(){
