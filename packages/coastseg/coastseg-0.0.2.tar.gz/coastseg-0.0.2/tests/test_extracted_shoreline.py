...
def test_init_invalid_inputs(valid_roi_settings,valid_shoreline_gdf,valid_settings):
    ...
    with pytest.raises(ValueError):
        extracted_shoreline.Extracted_Shoreline(invalid_roi_id,shoreline,roi_settings,settings)
    
    # Test initialize Extracted_Shoreline with invalid shoreline
    with pytest.raises(ValueError):
        extracted_shoreline.Extracted_Shoreline(roi_id,invalid_shoreline,roi_settings,settings)
    # Test initialize Extracted_Shoreline with empty shoreline
    with pytest.raises(ValueError):
        extracted_shoreline.Extracted_Shoreline(roi_id,empty_shoreline,roi_settings,settings)
        
    # Test initialize Extracted_Shoreline with invalid roi_settings
    with pytest.raises(ValueError):
        extracted_shoreline.Extracted_Shoreline(roi_id,shoreline,invalid_roi_settings,settings)
    ...
    with pytest.raises(ValueError):
        extracted_shoreline.Extracted_Shoreline(roi_id,shoreline,roi_settings,invalid_settings)
