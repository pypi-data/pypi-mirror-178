...
class Task(irisml.core.TaskBase):
    ...
    Config:
        ...
        lr_scale_param_names (Optional[Dict[str, float]]): Learning rate scaling for matched parameters.
    ...
    class Config:
        ...
        lr_scale_param_names: typing.Optional[typing.Dict[str, float]] = None
