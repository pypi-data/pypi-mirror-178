...
from classiq.interface.server.routes import DEFAULT_ANALYZER_FE_APP

DEFAULT_HOST = "https://classiquantum.com"
...
class Configuration(BaseModel):
    ...
    ide: pydantic.AnyHttpUrl = pydantic.Field(
        default=DEFAULT_ANALYZER_FE_APP, description="Classiq IDE URI."
    )
...
def init(args: Optional[Union[str, List[str]]] = None) -> Configuration:
    ...
    arg_parser.add_argument(
        ...
        env_var="CLASSIQ_IDE",
        default=DEFAULT_ANALYZER_FE_APP,
    )
    arg_parser.add_argument(
