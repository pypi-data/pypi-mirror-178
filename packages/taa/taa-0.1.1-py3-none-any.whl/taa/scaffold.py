...
from taa.logger import Logger
from taa.sample import *
...
def init_parser_scaffold(subparsers):
    ...
    sub_parser_scaffold.add_argument(
        ...
        dest="create_venv",
        action="store_true",
        help="Create virtual environment in the project, and install taa.",
    )
...
def create_scaffold(project_name):
    ...
    create_file(os.path.join(project_name, "common", "taa.ini"),file_content=taa_content)
    ...
    create_file(os.path.join(project_name, "README.md"), file_content=Markdown_content)
    ...
    if ExtraArgument.create_venv:
        ...
        # 在Python虚拟环境中安装taa
        print("Installing taa")
        if platform.system().lower() == 'windows':
            os.chdir(".venv")
            os.chdir("Scripts")
            os.system("pip install taa")
