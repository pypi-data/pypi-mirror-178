...
def seq_slide(value: typing.Tuple[float, float] = (0.0, 0.0), orient_axis_ortho: str = 'X', snap: bool = False, view2d_edge_pan: bool = False, release_confirm: bool = False, use_accurate: bool = False) -> None:
