...
def effect_strip_add(type: str = 'CROSS', frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, color: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
