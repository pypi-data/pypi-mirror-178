...
class E360Context(ClientStore):
    ...
    def upload_adt_file(
        ...
        definition = definition_client.get(str(upload.analyticDatasetDefinitionId))
        self.move_workspace_asset(
            str(definition.workspaceAssetId), target_container, name
        )
        self.move_workspace_asset(str(upload.assetId), target_container, name)
        return upload
