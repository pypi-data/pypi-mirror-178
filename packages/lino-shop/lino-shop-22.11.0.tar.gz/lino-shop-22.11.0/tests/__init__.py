...
# load SETUP_INFO:
filename = ROOTDIR.child('lino_shop', 'setup_info.py')
exec(compile(open(filename, "rb").read(), filename, 'exec'))

from lino.utils.pythontest import TestCase

import os
#os.environ['DJANGO_SETTINGS_MODULE'] = "lino_shop.settings.test"
...
class DemoTests(TestCase):
    ...
    def test_shop(self):
        self.run_django_manage_test('lino_shop/projects/shop')
