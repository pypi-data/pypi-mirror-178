$(document).ready(function () {
    ...
    function updateSidebarAttributesVisible() {
        $sidebar_button.attr('title', "Réduire la barre latérale");
        $sidebar_button.attr('aria-label', "Réduire la barre latérale");
    ...
    function updateSidebarAttributesHidden() {
        $sidebar_button.attr('title', "Agrandir la barre latérale");
        $sidebar_button.attr('aria-label', "Agrandir la barre latérale");
