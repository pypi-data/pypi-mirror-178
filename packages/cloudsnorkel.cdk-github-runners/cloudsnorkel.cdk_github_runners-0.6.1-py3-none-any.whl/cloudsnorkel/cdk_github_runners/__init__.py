...
class IRunnerProviderStatus(typing_extensions.Protocol):
    ...
    def security_group(self) -> typing.Optional[builtins.str]:
        '''(experimental) Security group attached to runners.
...
class _IRunnerProviderStatusProxy:
    ...
    def security_group(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "securityGroup"))
...
class Ec2Runner(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param ami_builder: (experimental) AMI builder that creates AMIs with GitHub runner pre-configured. On Linux, a user named ``runner`` is expected to exist with access to Docker. Default: AMI builder for Ubuntu Linux
        ...
        :param security_group: (experimental) Security Group to assign to launched runner instances. Default: account's default security group
        ...
        :param subnet: (experimental) Subnet where the runner instances will be launched. Default: default subnet of account's default VPC
        :param log_retention: (experimental) The number of days log events are kept in CloudWatch Logs. When updating this property, unsetting it doesn't remove the log retention policy. To remove the retention policy, set the value to ``INFINITE``. Default: logs.RetentionDays.ONE_MONTH
    ...
    @jsii.member(jsii_name="securityGroup")
    def security_group(self) -> typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]:
        '''(experimental) Security group attached to launched instances.
    ...
    def subnet(self) -> typing.Optional[aws_cdk.aws_ec2.ISubnet]:
        '''(experimental) VPC subnet used for hosting launched instances.
...
class Ec2RunnerProps(RunnerProviderProps):
    ...
    @builtins.property
    def security_group(self) -> typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]:
        '''(experimental) Security Group to assign to launched runner instances.
    ...
    @builtins.property
    def subnet(self) -> typing.Optional[aws_cdk.aws_ec2.ISubnet]:
        '''(experimental) Subnet where the runner instances will be launched.
