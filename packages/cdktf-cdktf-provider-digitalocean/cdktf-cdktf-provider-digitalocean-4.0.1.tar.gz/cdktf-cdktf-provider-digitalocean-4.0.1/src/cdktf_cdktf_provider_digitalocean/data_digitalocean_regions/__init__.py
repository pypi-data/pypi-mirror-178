...
class DataDigitaloceanRegionsFilterOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanRegionsFilter, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanRegionsFilter, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanRegionsFilter, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanRegionsFilter, cdktf.IResolvable]],
...
class DataDigitaloceanRegionsRegionsOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataDigitaloceanRegionsRegions]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataDigitaloceanRegionsSortOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanRegionsSort, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanRegionsSort, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanRegionsSort, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanRegionsSort, cdktf.IResolvable]],
