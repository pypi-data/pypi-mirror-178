...
class DataDigitaloceanTagsFilterOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanTagsFilter, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanTagsFilter, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanTagsFilter, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanTagsFilter, cdktf.IResolvable]],
...
class DataDigitaloceanTagsSortOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanTagsSort, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanTagsSort, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanTagsSort, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanTagsSort, cdktf.IResolvable]],
...
class DataDigitaloceanTagsTagsOutputReference(
    ...
    def internal_value(self, value: typing.Optional[DataDigitaloceanTagsTags]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataDigitaloceanTagsTags]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
