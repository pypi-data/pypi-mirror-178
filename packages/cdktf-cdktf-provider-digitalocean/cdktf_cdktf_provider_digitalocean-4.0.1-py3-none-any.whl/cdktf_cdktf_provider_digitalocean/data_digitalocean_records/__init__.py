...
class DataDigitaloceanRecordsFilterOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanRecordsFilter, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanRecordsFilter, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanRecordsFilter, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanRecordsFilter, cdktf.IResolvable]],
...
class DataDigitaloceanRecordsRecordsOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataDigitaloceanRecordsRecords]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataDigitaloceanRecordsSortOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataDigitaloceanRecordsSort, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataDigitaloceanRecordsSort, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataDigitaloceanRecordsSort, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataDigitaloceanRecordsSort, cdktf.IResolvable]],
