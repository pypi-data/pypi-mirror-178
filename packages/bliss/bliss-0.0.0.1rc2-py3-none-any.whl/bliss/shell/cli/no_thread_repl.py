...
import gevent
import bliss._aiogevent as aiogevent
        ...
        try:
            while True:
                try:
                    ...
                    try:
                        result = None
                        # use of "suppress" context manager to not propagate
                        # CancelledError, which can happen if the future returned
                        # by "eval_greenlet" is already done when calling "await",
                        # which happened in issue #3103
