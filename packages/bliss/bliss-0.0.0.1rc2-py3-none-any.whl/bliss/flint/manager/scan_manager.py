...
from blissdata.data.lima_image import ImageFormatNotSupported
from blissdata.data import scan as bliss_scan
from blissdata.client import close_all_redis_connections

from .data_storage import DataStorage
from bliss.flint.helper import scan_info_helper
from bliss.flint.model import flint_model
from bliss.flint.model import scan_model
from blissdata.data.nodes import lima as lima_nodes
...
class ScanManager(bliss_scan.ScansObserver):
    ...
    def __process_data_event(self, data_event):
        ...
        if isinstance(data_event, _ScalarDataEvent):
            ...
            frame_id = data_event.index + len(data_event.data_bunch) - 1
