...
def getAnyDisplayableChannelAsCurve(
    scan: scan_model.Scan,
) -> Optional[scan_model.Channel]:
    """Returns from the scan any displayable channel

    Basically returns any channel which is not use time unit.
    """
    for name in scan.getChannelNames():
