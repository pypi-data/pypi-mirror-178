...
def get_default_redis_connection_manager():
    return get_default_connection().redis_connection_manager
...
def get_file(
    ...
    :params raise_on_none_path if False and config_node[key] is None, return empty file. Otherwise raise KeyError.
