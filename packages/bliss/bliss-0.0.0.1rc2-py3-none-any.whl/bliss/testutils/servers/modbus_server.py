...
from bliss.testutils.servers.log_utils import basic_config
from bliss.common.utils import ReuseAddrTCPServer
...
class ModbusServer(ReuseAddrTCPServer):
    timeout = 0.1
...
def main(address):
    ...
    app = get_server(ModbusServer, address, RequestHandler)
