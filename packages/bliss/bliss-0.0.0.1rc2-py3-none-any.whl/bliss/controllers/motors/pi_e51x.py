...
class PI_E51X(pi_gcs.Communication, pi_gcs.Recorder, Controller):
    ...
    def get_comm_info(self):
        """
        Return a string containing comunication info
        The answer depends on model.
        ...
        if self.model == "E517":
            return self.command("IFC?", nb_line=6)

        if self.model == "E518":
            return self.command("IFC?", nb_line=5)

        return ""

    def get_fw_info(self):
        """
        Return a string containing firmware info
        The answer depends on model.
        """
    ...
    def get_info(self, axis):
        ...
        # Communication info (depends on model)
        _txt += self.get_comm_info()
