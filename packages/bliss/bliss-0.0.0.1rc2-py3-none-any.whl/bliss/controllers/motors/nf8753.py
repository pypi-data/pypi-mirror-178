...
"""
Bliss controller for ethernet NewFocus 8753 piezo controller.
NB: not for NF8742
...
class NF8753(Controller):
    ...
    def initialize(self):
        ...
        try:
            ...
            try:
                self.sock = get_comm(self.config.config_dict, SERIAL)
            except ValueError:
                host = self.config.get("host")
                warn(
                    "'host' keyword is deprecated. Use 'tcp' instead",
                    DeprecationWarning,
                )
