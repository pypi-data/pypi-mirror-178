...
class Spec(Controller):
    ...
    def read_acceleration(self, axis):
        acctime = self._read_channel(axis.mnemonic, "acceleration") / 1000.0
        return self.read_velocity(axis) / float(acctime)

    def set_acceleration(self, axis, new_acc):
        acctime = 1000.0 * self.read_velocity(axis) / float(new_acc)
    ...
    def start_one(self, motion):
        ...
        acctime = self._read_channel(motion.axis.mnemonic, "acceleration") / 1000.0
