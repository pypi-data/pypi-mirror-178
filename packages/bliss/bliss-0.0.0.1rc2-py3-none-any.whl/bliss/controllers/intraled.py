...
class IntraledController:
    ...
    def send(self, command: str) -> str:
        ...
        Arguments:
            command: Example: 'si00100'

        Return:
            Decoded string with starting char `>` removed.
        """
    ...
    def get_temperature(self) -> float:
        """
        Get temperature from this device in degree Celcius.
...
class Intraled:
    ...
    def on(self):
        ...
        - The minimum to have light is 1.1%
        - The minimum to be sure light is on on ID21 is 10%

        TODO: use a setting? -> YES.
        """
        self.intensity = 10
    ...
    def source(self, value: str):
        ...
        Arguments:
            value: One of `POTENTIOMETER`, `ANALOG IN`, `COM PORT`
        """
