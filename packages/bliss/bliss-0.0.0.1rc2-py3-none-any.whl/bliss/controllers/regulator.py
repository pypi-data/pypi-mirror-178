...
class Controller(BlissController):
    ...
    def init_obj(self, obj):
        ...
        with self.__lock:
            ...
            if not self.__hw_controller_initialized:
                ...
                log_debug(self, "initialize_controller: %s" % (self.name))
            ...
            if isinstance(obj, Loop):
                ...
                if not self.__initialized_obj.get(obj.input):
                    ...
                    log_debug(self, "initialize_input: %s" % (obj.input))
                ...
                if not self.__initialized_obj.get(obj.output):
                    ...
                    log_debug(self, "initialize_output: %s" % (obj.output))

                obj.load_base_config()
                self.initialize_loop(obj)
                log_debug(self, "initialize_loop: %s" % (obj))
                ...
                if isinstance(obj, Input):
                    ...
                    log_debug(self, "initialize_input: %s" % (obj))
                elif isinstance(obj, Output):
                    self.initialize_output(obj)
                    log_debug(self, "initialize_output: %s" % (obj))
    ...
    def get_object(self, name):
        ...
        Returns:
           the object
        """
        log_debug(self, "Controller:get_object: %s" % (name))
    ...
    def set_dwell(self, tloop, dwell):
        ...
        Args:
           ...
           dwell
        """
        log_debug(self, "Controller:set_dwell: %s %s" % (tloop, dwell))
        raise NotImplementedError
    ...
    def get_dwell(self, tloop):
        ...
        Returns:
           dwell value
        """
        log_debug(self, "Controller:get_dwell: %s" % (tloop))
        raise NotImplementedError
    ...
    def set_step(self, tloop, step):
        ...
        Args:
           ...
           step
        """
        log_debug(self, "Controller:set_step: %s %s" % (tloop, step))
        raise NotImplementedError
    ...
    def get_step(self, tloop):
        ...
        Returns:
           step value
        """
        log_debug(self, "Controller:get_step: %s" % (tloop))
        raise NotImplementedError
    ...
    def Wraw(self, string):
        ...
        """
        log_debug(self, "Controller:Wraw:")
        raise NotImplementedError
    ...
    def Rraw(self):
        ...
        """
        log_debug(self, "Controller:Rraw:")
        raise NotImplementedError
    ...
    def stop_output_ramp(self, toutput):
        ...
        Args:
           toutput: Output class type object
        """
        log_debug(self, "Controller:stop_output_ramp: %s" % (toutput))
        raise NotImplementedError
    ...
    def is_output_ramping(self, toutput):
        ...
        Returns:
           (bool) True if ramping, else False.
        """
        log_debug(self, "Controller:is_output_ramping: %s" % (toutput))
        raise NotImplementedError
    ...
    def set_output_ramprate(self, toutput, rate):
        ...
        """
        log_debug(self, "Controller:set_output_ramprate: %s %s" % (toutput, rate))
        raise NotImplementedError
    ...
    def get_output_ramprate(self, toutput):
        ...
        """
        log_debug(self, "Controller:get_output_ramprate: %s" % (toutput))
        raise NotImplementedError
...
def send_limit(func):
    ...
    def f(*args, **kwargs):
        ...
        nonlocal last_call
        delta_t = time.perf_counter() - last_call
        if delta_t <= 0.15:
