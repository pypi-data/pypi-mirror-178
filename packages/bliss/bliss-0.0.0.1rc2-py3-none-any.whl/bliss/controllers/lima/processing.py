...
class LimaProcessing(BeaconObject):
    ...
    flatfield_normalize = BeaconObject.property_setting(
        "flatfield_normalize", default=True
    )

    @flatfield_normalize.setter
    def flatfield_normalize(self, value):
        assert isinstance(value, bool)
        return value
    ...
    def to_dict(self):
        return {
            ...
            "flatfield_normalize": self.flatfield_normalize,
    ...
    def __info__(self):
        ...
        return textwrap.dedent(
            ...
            flatfield normalize: {self.flatfield_normalize}
