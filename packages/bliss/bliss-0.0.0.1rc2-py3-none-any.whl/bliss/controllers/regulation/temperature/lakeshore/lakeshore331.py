...
from bliss.common.logtools import log_debug, log_debug_data, log_warning
...
class LakeShore331(Controller):
    ...
    def initialize_controller(self):
        ...
        log_debug(self, "initialize_controller")
        self.clear()
    ...
    def read_input(self, tinput):
        ...
        """
        log_debug(self, "read_input: %s" % (tinput))
    ...
    def read_output(self, toutput):
        ...
        """
        log_debug(self, "read_output: %s" % (toutput))
    ...
    def set_kp(self, tloop, kp):
        ...
        """
        log_debug(self, "set_kp: %s %s" % (tloop, kp))
    ...
    def set_ki(self, tloop, ki):
        ...
        """
        log_debug(self, "set_ki: %s %s" % (tloop, ki))
    ...
    def set_kd(self, tloop, kd):
        ...
        """
        log_debug(self, "set_kd: %s %s" % (tloop, kd))
    ...
    def start_regulation(self, tloop):
        ...
        Args:
           tloop:  Loop class type object
        """
        log_debug(self, "start_regulation: %s" % (tloop))
    ...
    def stop_regulation(self, tloop):
        ...
        Args:
           tloop:  Loop class type object
        """
        log_debug(self, "stop_regulation: %s" % (tloop))
    ...
    def set_setpoint(self, tloop, sp, **kwargs):
        ...
        """
        log_debug(self, "set_setpoint: %s %s" % (tloop, sp))
    ...
    def get_setpoint(self, tloop):
        ...
        """
        log_debug(self, "get_setpoint: %s" % (tloop))
    ...
    def start_ramp(self, tloop, sp, **kwargs):
        ...
        """
        log_debug(self, "start_ramp: %s %s" % (tloop, sp))
    ...
    def stop_ramp(self, tloop):
        ...
        Args:
            tloop:  Loop class type object
        """
        log_debug(self, "stop_ramp: %s" % (tloop))
    ...
    def is_ramping(self, tloop):
        ...
        """
        log_debug(self, "is_ramping: %s" % (tloop))
    ...
    def set_ramprate(self, tloop, rate):
        ...
        """
        log_debug(self, "set_ramprate: %s %s" % (tloop, rate))
    ...
    def get_ramprate(self, tloop):
        ...
        """
        log_debug(self, "get_ramprate: %s" % (tloop))
    ...
    def alarm_reset(self):
        ...
        """
        log_debug(self, "alarm_reset")
        self.send_cmd("ALMRST")

    def show(self, name=None):
        """Display all main parameters and values for the temperature controller.

        Prints device ID, PID, heater range, loop status, sensors configuration, inputs temperature etc.
        """
        repr_list = []
        log_debug(self, "Controller:show")
    ...
    def get_filter_params(self, tinput):
        ...
        log_debug(self, "get_filter_params")
    ...
    def set_filter_params(self, tinput, **kwargs):
        ...
        Kwargs:
            ...
            window (int): specifies what percent of full scale reading
                          ...
                          Valid range: 1 to 10%.
        """
        log_debug(self, "set_filter_params")
    ...
    def set_output_value(self, toutput, value):
        ...
        self.send_cmd("MOUT", value, channel=toutput.channel)
    ...
    def select_curve(self, crvn, input_channel):
        ...
        log_debug(self, "select_curve: %s", crvn)
    ...
    def show_all_curves(self):
        ...
        log_debug(self, "list_all_curves")
    ...
    def delete_curve(self, crvn):
        log_debug(self, "delete_curve:%s", crvn)
        user_min_curve, user_max_curve = self.NUSERCURVES
    ...
    def _read_temperature(self, input_channel, unit):
        ...
        """
        log_debug(self, "_read_temperature")
    ...
    def _pid_coeff(self, loop_channel, **kwargs):
        ...
        if len(kwargs):
            ...
            if float(kp) < 0.1 or float(kp) > 1000.0:
                raise ValueError(
                    "Proportional gain %s is out of bounds [0.1,1000]" % kp
                )
            if float(ki) < 0.1 or float(ki) > 1000.0:
