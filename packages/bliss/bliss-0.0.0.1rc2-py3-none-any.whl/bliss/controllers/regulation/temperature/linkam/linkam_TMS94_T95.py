...
class LinkamTms94(Controller):
    ...
    def set_setpoint(self, tloop, sp, **kwargs):
        ...
        self._setpoint = int(cmd) / 10.0  # or sp ???
    ...
    def set_ramprate(self, tloop, rate):
        ...
        self._ramp_rate = int(val) / 100.0  # or rate ???
    ...
    def WRraw(self, cmd):
        ...
        if len(args) > 0:
            ...
            return self.send_cmd(args[0], value)
