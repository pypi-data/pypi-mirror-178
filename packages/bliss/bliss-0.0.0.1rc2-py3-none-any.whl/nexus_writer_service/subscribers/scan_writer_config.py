...
class NexusScanWriterConfigurable(scan_writer_base.NexusScanWriterBase):
    ...
    def instrument_info(self):
        return self.config_writer.get("instrument_info", None)
    ...
    def _get_application(self, nxapplidef, attr, default=None):
        ...
        if ret is None:
            self.logger.warning(
                "Application definition incomplete ('%s' is missing)", attr
            )
            ret = default
        return ret
    ...
    def _nxapplication_create_args(self, name, definition_name):
        ...
        nxdict = {"definition": definition_name}
        args = (name,)
    ...
    def _save_application_merged(
        ...
        for configname in confignames:
            notfoundmsg = (
                "Application definition incomplete ({} not found for {})".format(
