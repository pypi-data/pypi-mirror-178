...
from nexus_writer_service.patching import freeze_subprocess  # noqa: F401
    ...
    **Properties:**
    ...
    def read_writer_log_level(self):
        ...
        return read_log_level[
            logging.getLogger("nexus_writer_service").getEffectiveLevel()
        ]
    ...
    def write_writer_log_level(self, value):
        ...
        logging.getLogger("nexus_writer_service").setLevel(write_log_level[value])
