...
"""
    ...
    [OPTIONAL][Default False] debug_params              whether or not we add parameters to the logged function signature, example: sum(1+2): result was 3
...
def log_middleware_async(verbose_exc=False, suppress_exc=False, 
    ...
    def decorator(function):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if debug_params:
                params = []
                [params.append(str(arg)) for arg in args]
                [params.append(str(k) + "=" + str(v)) for k, v in kwargs.items()]
                params = ','.join(params)
