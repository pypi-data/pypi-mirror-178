...
void apply_dephase_0_little_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {target0};
  std::sort(positions, positions + 1);
...
void apply_dephase_0_big_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {(num_qubits - target0 - 1)};
  std::sort(positions, positions + 1);
...
void apply_dephase_1_little_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {target0};
  std::sort(positions, positions + 1);
...
void apply_dephase_1_big_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {(num_qubits - target0 - 1)};
  std::sort(positions, positions + 1);
...
void apply_amp_damp_0_little_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {target0};
  std::sort(positions, positions + 1);
...
void apply_amp_damp_0_big_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {(num_qubits - target0 - 1)};
  std::sort(positions, positions + 1);
...
void apply_amp_damp_1_little_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {target0};
  std::sort(positions, positions + 1);
...
void apply_amp_damp_1_big_endian(uint64_t num_qubits, std::complex<double> *state_vector, std::complex<double> *gate_matrix, uint64_t target0)
{
  uint64_t num_states = 1 << num_qubits;
  uint64_t positions[] = {(num_qubits - target0 - 1)};
  std::sort(positions, positions + 1);
