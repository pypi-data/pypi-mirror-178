...
class PackageReader:
    ...
    def get_service_by_name(self, service: str) -> Optional[ServiceSetting]:
        ...
        """
        return self.rpc_client.rpc("config", "get_service_by_name", ConfigGetServiceByNameRequest(name=service),
                                   ConfigGetServiceResponse).service

    def list_all_services(self, prefix: Optional[str] = None) -> List[ServiceSetting]:
        """
        :param prefix: prefix of the package id, if none is passed all are returned
        """
        return self.rpc_client.rpc("config", "get_services", ConfigGetInstalledServicesRequest(prefix=prefix),
                                   ConfigGetServicesResponse).services

    def list_by_hardware_type(self, prefix: str) -> List[ServiceSetting]:
        """
        ...
        """
        return self.rpc_client.rpc("config", "get_services_by_hardware_type",
                                   ConfigGetServicesByHardwareTypeRequest(hardware_type_prefix=prefix),
                                   ConfigGetServicesResponse).services

    def list_by_parent_type(self, prefix: str) -> List[ServiceSetting]:
        """
        ...
        """
        return self.rpc_client.rpc("config", "get_services_by_parent_type",
                                   ConfigGetServicesByParentTypeRequest(parent_type_prefix=prefix),
                                   ConfigGetServicesResponse).services

    def list_by_software_type(self, prefix: str) -> List[ServiceSetting]:
        """
        ...
        """
        return self.rpc_client.rpc("config", "get_services_by_software_type",
                                   ConfigGetServicesBySoftwareTypeRequest(software_type_prefix=prefix),
                                   ConfigGetServicesResponse).services
