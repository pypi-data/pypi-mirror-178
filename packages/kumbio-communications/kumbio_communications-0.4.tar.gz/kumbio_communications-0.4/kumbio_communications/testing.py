...
def send_notification(token_for_app:str, organization_id:int, send_to:list[str], date_time_to_send:list[str]=['NOW'], 
                      ...
                      execute_in_another_thread:bool=True, object_id:int=None, object_type:ObjectType=None, extra_object_data:dict=None):
    ...
    """
        ...
        for example:
            ...
            total_number_of_notifications = len(send_to)
    ...
    data_to_send = {
        ...
        'extra_object_data': extra_object_data,
    }
    ...
    for index, send in enumerate(send_to):
        ...
        # this should be handled differently, since the call is going to be async, we should not raise an exception
       
            
        if CURRENT_APP == 'KUMBIO_CALENDAR' and treat_not_sent:
