...
from colemen_config import _os_divider,_os_platform
...
from colemen_utilities.string_utils.string_escaping import escape_charcode
from colemen_utilities.string_utils.string_escaping import escape_quoted_chars
from colemen_utilities.string_utils.string_escaping import escape_regex
from colemen_utilities.string_utils.string_strip import strip_end
...
def dict_replace_string(value:str,replace:dict):
    ...
    if isinstance(replace,(dict)) is False:
        _con.log("The replace argument must be a dictionary","error")
        return None
