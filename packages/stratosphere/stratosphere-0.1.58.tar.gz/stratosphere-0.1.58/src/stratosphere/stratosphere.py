...
from stratosphere.utils.environment import get_version_stratosphere
...
class Stratosphere:
    ...
    def __init__(self, url: str = config.db.default_url, echo: bool = False, ask_password=False):
        ...
        logging.info(
            f"Stratosphere v{get_version_stratosphere()} initialized, documentation at https://www.stratosphere.dev/doc"
        )
        self.db.info()
