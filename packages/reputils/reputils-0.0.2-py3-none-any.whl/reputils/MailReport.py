...
# logger.add(sys.stdout, level=os.getenv("LOGURU_LEVEL", "INFO"))    # TRACE | DEBUG | INFO | WARN | ERROR |  FATAL
...
class MRSendmail:
    ...
    def send(
        ...
        message.add_header("Date", _formatdate(datetime.datetime.now(_tzberlin)))
