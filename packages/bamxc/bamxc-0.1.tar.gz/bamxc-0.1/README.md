...
Based on this work, we propose **bam**, an open source Python package that provides a complete workflow to create your own labelling function to build cleaner bird song recording dataset. **bam** is mostly based on [scikit-maad](https://github.com/scikit-maad/scikit-maad) package
...
**bam** is hosted on PyPI. To install, run the following command in your Python environment:
...
If you find **bam** usefull for your research, please consider citing it as:
