...
version = SourceFileLoader('bam.version',
                           'bam/version.py').load_module()
...
setup(
      name = 'bamxc',
      version = version.__version__,  # Specified at bamxc/version.py file
      ...
      url = 'https://github.com/ear-team/bam',
      #project_urls={'Documentation': 'https://bam.github.io'},
