...
class ResponseWorkspaceList(object):
    ...
    def __init__(self, backup_volume_id=None, created_by=None, created_dt=None, end_dt=None, endpoints=None, histories=None, id=None, kernel_cluster=None, kernel_cluster_node=None, kernel_cluster_select_policies=None, kernel_resource_spec=None, last_backup_succeeded=None, name=None, organization=None, status=None, status_last_updated=None, status_reason=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
