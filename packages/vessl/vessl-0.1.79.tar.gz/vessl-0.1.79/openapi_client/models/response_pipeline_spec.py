...
class ResponsePipelineSpec(object):
    ...
    def __init__(self, context=None, created_dt=None, step_dependencies=None, steps=None, local_vars_configuration=None):  # noqa: E501
    ...
    def context(self, context):
        ...
        :type context: dict(str, dict(str, str))
        """
