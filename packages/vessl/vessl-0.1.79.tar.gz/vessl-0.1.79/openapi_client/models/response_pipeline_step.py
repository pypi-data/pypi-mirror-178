...
class ResponsePipelineStep(object):
    ...
    attribute_map = {
        ...
        'manual_judgement_spec': 'manual_judgement_spec',
        'run_spec': 'run_spec',
        'title': 'title',
        'type': 'type'
    }

    def __init__(self, description=None, id=None, if_spec=None, manual_input_spec=None, manual_judgement_spec=None, run_spec=None, title=None, type=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._manual_judgement_spec = None
        self._run_spec = None
        self._title = None
        self._type = None
        ...
        if manual_judgement_spec is not None:
            self.manual_judgement_spec = manual_judgement_spec
    ...
    @property
    def manual_judgement_spec(self):
        """Gets the manual_judgement_spec of this ResponsePipelineStep.  # noqa: E501


        :return: The manual_judgement_spec of this ResponsePipelineStep.  # noqa: E501
        :rtype: object
        """
        return self._manual_judgement_spec

    @manual_judgement_spec.setter
    def manual_judgement_spec(self, manual_judgement_spec):
        """Sets the manual_judgement_spec of this ResponsePipelineStep.


        :param manual_judgement_spec: The manual_judgement_spec of this ResponsePipelineStep.  # noqa: E501
        :type manual_judgement_spec: object
        """

        self._manual_judgement_spec = manual_judgement_spec
