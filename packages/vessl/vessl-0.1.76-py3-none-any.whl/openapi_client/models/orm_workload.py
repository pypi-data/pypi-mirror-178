...
class OrmWorkload(object):
    ...
    def __init__(self, created_dt=None, distributed_number=None, edges=None, endpoints=None, env_vars=None, exit_code=None, experiment_id=None, final_cost=None, id=None, kernel_cluster_select_policies=None, last_charged=None, organization_id=None, service_id=None, start_command=None, status=None, status_last_updated=None, status_reason=None, type=None, updated_dt=None, volume_mounts=None, workload_kernel_cluster=None, workload_kernel_cluster_node=None, workload_kernel_image=None, workload_kernel_resource_spec=None, workspace_id=None, local_vars_configuration=None):  # noqa: E501
