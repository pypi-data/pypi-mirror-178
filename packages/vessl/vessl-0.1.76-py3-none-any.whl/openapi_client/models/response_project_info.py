...
class ResponseProjectInfo(object):
    ...
    def __init__(self, created_dt=None, description=None, experiment_summary=None, id=None, is_public=None, is_sample=None, key_metrics=None, name=None, note=None, organization=None, primary_owner=None, project_datasets=None, project_repositories=None, updated_dt=None, volume_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def is_sample(self):
        """Gets the is_sample of this ResponseProjectInfo.  # noqa: E501


        :return: The is_sample of this ResponseProjectInfo.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_sample(self, is_sample):
        """Sets the is_sample of this ResponseProjectInfo.


        :param is_sample: The is_sample of this ResponseProjectInfo.  # noqa: E501
        :type is_sample: bool
        """
        if self.local_vars_configuration.client_side_validation and is_sample is None:  # noqa: E501
            raise ValueError("Invalid value for `is_sample`, must not be `None`")  # noqa: E501
