...
class OrmWorkloadEdges(object):
    ...
    def __init__(self, billing_histories=None, experiment=None, histories=None, kernel_cluster=None, kernel_cluster_node=None, kernel_image=None, kernel_resource_spec=None, organization=None, service=None, workspace=None, local_vars_configuration=None):  # noqa: E501
