...
class ResponseMyUser(object):
    ...
    def __init__(self, created_dt=None, default_organization=None, display_name=None, email=None, github_username=None, has_password=None, id=None, is_email_verified=None, is_pending=None, last_login=None, organizations=None, updated_dt=None, username=None, local_vars_configuration=None):  # noqa: E501
