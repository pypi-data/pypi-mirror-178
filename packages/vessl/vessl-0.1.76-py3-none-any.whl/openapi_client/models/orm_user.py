...
class OrmUser(object):
    ...
    def __init__(self, created_dt=None, display_name=None, edges=None, email=None, id=None, immutable_slug=None, is_email_verified=None, is_pending=None, last_login=None, updated_dt=None, username=None, local_vars_configuration=None):  # noqa: E501
