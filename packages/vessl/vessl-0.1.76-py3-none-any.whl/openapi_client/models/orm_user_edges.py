...
class OrmUserEdges(object):
    ...
    def __init__(self, access_tokens=None, credit_earn_histories=None, default_organization=None, experiments=None, models=None, project_dashboards=None, reset_password_tokens=None, starred_dashboards=None, user_organization=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
