...
class OrmPipelineExecution(object):
    ...
    def __init__(self, context=None, created_dt=None, edges=None, id=None, immutable_slug=None, number=None, pipeline_id=None, pipeline_spec_id=None, status=None, triggered_by=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
