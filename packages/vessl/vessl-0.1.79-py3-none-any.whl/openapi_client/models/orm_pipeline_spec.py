...
class OrmPipelineSpec(object):
    ...
    def __init__(self, context=None, created_dt=None, edges=None, id=None, pipeline_id=None, step_dependencies=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
