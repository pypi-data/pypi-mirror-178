...
class OrmPipelineStepExecution(object):
    ...
    def __init__(self, created_dt=None, edges=None, id=None, immutable_slug=None, pipeline_execution_id=None, status=None, step_id=None, step_type=None, updated_dt=None, variables=None, local_vars_configuration=None):  # noqa: E501
