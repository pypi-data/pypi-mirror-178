...
class OrmPipelineEdges(object):
    ...
    def __init__(self, created_by=None, cron_triggers=None, executions=None, organization=None, specs=None, webhook_triggers=None, local_vars_configuration=None):  # noqa: E501
