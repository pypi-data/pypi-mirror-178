...
override this function. `Returns the current theme as a String`"""
    ...
    def _build_fonts(self) -> list:
        ...
        self.xlarge_font = (fnt["family"], int(fnt["size"]) + 4, "normal")
        self.xlarge_bold_font = (fnt["family"], int(fnt["size"]) + 4, "bold")
        self.xxlarge_font = (fnt["family"], int(fnt["size"]) + 6, "normal")
        self.xxlarge_bold_font = (fnt["family"], int(fnt["size"]) + 6, "bold")
