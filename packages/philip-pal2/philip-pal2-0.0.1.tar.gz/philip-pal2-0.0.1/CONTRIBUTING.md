...
Welcome to `philip-pal2` contributor's guide.
...
If you experience bugs or general issues with `philip-pal2`, please have a look
...
You can help improve `philip-pal2` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`philip-pal2` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `philip-pal2`'s files. While this mechanism can
...
```
conda create -n philip-pal2 python=3 six virtualenv pytest pytest-cov
conda activate philip-pal2
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/philip-pal2.git
   cd philip-pal2
   ```
...
5. Install [pre-commit]:
   ...
   `philip-pal2` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/philip-pal2
[issue tracker]: https://github.com/<USERNAME>/philip-pal2/issues
