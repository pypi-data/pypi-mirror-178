...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 430,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 431,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 432,
    SBK_QLOCALE_IDX                                          = 174,
    ...
    SBK_QWRITELOCKER_IDX                                     = 325,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 326,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 327,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 328,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 329,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 330,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 331,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 335,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 334,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 333,
    SBK_QXMLSTREAMREADER_IDX                                 = 332,
    SBK_QXMLSTREAMWRITER_IDX                                 = 336,
    SBK_QT_GLOBALCOLOR_IDX                                   = 371,
    SBK_QT_MOUSEBUTTON_IDX                                   = 387,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 136,
    SBK_QT_ORIENTATION_IDX                                   = 392,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 138,
    SBK_QT_FOCUSPOLICY_IDX                                   = 366,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 405,
    SBK_QT_SORTORDER_IDX                                     = 403,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 404,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 140,
    SBK_QT_TILERULE_IDX                                      = 410,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 338,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 123,
    SBK_QT_TEXTFLAG_IDX                                      = 407,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 406,
    SBK_QT_WHITESPACEMODE_IDX                                = 419,
    SBK_QT_HITTESTACCURACY_IDX                               = 373,
    SBK_QT_WINDOWTYPE_IDX                                    = 424,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 145,
    SBK_QT_WINDOWSTATE_IDX                                   = 423,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 144,
    SBK_QT_APPLICATIONSTATE_IDX                              = 341,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 124,
    SBK_QT_SCREENORIENTATION_IDX                             = 397,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 139,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 420,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 340,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 374,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 130,
    SBK_QT_BGMODE_IDX                                        = 345,
    SBK_QT_KEY_IDX                                           = 381,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 382,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 134,
    SBK_QT_MODIFIER_IDX                                      = 386,
    SBK_QT_ARROWTYPE_IDX                                     = 342,
    SBK_QT_PENSTYLE_IDX                                      = 395,
    SBK_QT_PENCAPSTYLE_IDX                                   = 393,
    SBK_QT_PENJOINSTYLE_IDX                                  = 394,
    SBK_QT_BRUSHSTYLE_IDX                                    = 346,
    SBK_QT_SIZEMODE_IDX                                      = 402,
    SBK_QT_UIEFFECT_IDX                                      = 418,
    SBK_QT_CURSORSHAPE_IDX                                   = 355,
    SBK_QT_TEXTFORMAT_IDX                                    = 408,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 343,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 358,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 125,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 359,
    SBK_QT_TOOLBARAREA_IDX                                   = 413,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 142,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 414,
    SBK_QT_DATEFORMAT_IDX                                    = 356,
    SBK_QT_TIMESPEC_IDX                                      = 411,
    SBK_QT_DAYOFWEEK_IDX                                     = 357,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 398,
    SBK_QT_CASESENSITIVITY_IDX                               = 347,
    SBK_QT_CORNER_IDX                                        = 354,
    SBK_QT_EDGE_IDX                                          = 361,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 127,
    SBK_QT_CONNECTIONTYPE_IDX                                = 351,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 400,
    SBK_QT_FILLRULE_IDX                                      = 364,
    SBK_QT_MASKMODE_IDX                                      = 384,
    SBK_QT_CLIPOPERATION_IDX                                 = 350,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 379,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 380,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 417,
    SBK_QT_AXIS_IDX                                          = 344,
    SBK_QT_FOCUSREASON_IDX                                   = 367,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 352,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 376,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 132,
    SBK_QT_INPUTMETHODHINT_IDX                               = 375,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 131,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 362,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 415,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 383,
    SBK_QT_ANCHORPOINT_IDX                                   = 339,
    SBK_QT_FINDCHILDOPTION_IDX                               = 365,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 128,
    SBK_QT_DROPACTION_IDX                                    = 360,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 126,
    SBK_QT_CHECKSTATE_IDX                                    = 348,
    SBK_QT_ITEMDATAROLE_IDX                                  = 377,
    SBK_QT_ITEMFLAG_IDX                                      = 378,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 133,
    SBK_QT_MATCHFLAG_IDX                                     = 385,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 135,
    SBK_QT_WINDOWMODALITY_IDX                                = 422,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 409,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 141,
    SBK_QT_EVENTPRIORITY_IDX                                 = 363,
    SBK_QT_SIZEHINT_IDX                                      = 401,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 421,
    SBK_QT_COORDINATESYSTEM_IDX                              = 353,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 416,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 143,
    SBK_QT_GESTURESTATE_IDX                                  = 369,
    SBK_QT_GESTURETYPE_IDX                                   = 370,
    SBK_QT_GESTUREFLAG_IDX                                   = 368,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 129,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 390,
    SBK_QT_NAVIGATIONMODE_IDX                                = 391,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 434,
    SBK_QT_TIMERTYPE_IDX                                     = 412,
    SBK_QT_SCROLLPHASE_IDX                                   = 399,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 389,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 388,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 137,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 349,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 372,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 396,
    SBK_QtCoreQT_IDX                                         = 337,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 426,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 427,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 428,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 429,
    SBK_QtCore_IDX_COUNT                                     = 435
};
...
enum : int {
    ...
    SBK_QPTRDIFF_IDX                                         = 9,
    SBK_QUINTPTR_IDX                                         = 10,
    SBK_QTCORE_QLIST_INT_IDX                                 = 11, // QList<int >
    SBK_QTCORE_QLIST_QPOINT_IDX                              = 12, // QList<QPoint >
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 13, // QList<QPointF >
    ...
    SBK_QTCORE_QLIST_QMODELINDEX_IDX                         = 28, // QList<QModelIndex >
