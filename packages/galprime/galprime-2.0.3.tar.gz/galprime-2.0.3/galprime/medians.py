...
def boostrap_median(table_list, iterations=500, x_step=0.5, progress_bar = False,
                    plot_dir=None, plot_prefix=""):
    ...
    iterable = tqdm(range(iterations), desc="Bootstrapping") if progress_bar else range(iterations)
