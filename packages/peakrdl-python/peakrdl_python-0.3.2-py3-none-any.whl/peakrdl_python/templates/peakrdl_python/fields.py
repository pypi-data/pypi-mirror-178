...
class Field(Base):
    ...
    __slots__ = ['__parent_register', '__size_props',
                 '__bitmask', '__msb0', '__lsb0', '__reset_value']

    def __init__(self, parent_register: Reg, size_props: FieldSizeProps,
                 logger_handle: str, inst_name: str, reset_value: Optional[int]=None):
    ...
    def reset_value(self) -> Optional[int]:
        """
        reset value for the field, return None if it is unspecified
        """
