...
class MiddleDatasetMgmt(dsmgmt.DatasetMgmt):
    ...
    def _make_example(self, image_bytes, label_bytes): # write
    ...
    def augmente_image(self, parsed_image_dataset, augmente_type):
        ...
        for image_features in parsed_image_dataset:
            ...
            image_aug, segmentation_mask_aug = self._augmentation(tf.io.decode_image(img, channels=3), tf.io.decode_png(segment_img, channels=1), augmente_type)
    ...
    def merge_image_dataset(self, dataset_paths):
        ...
        dataset1 = self.read_images(dataset_paths[0])
        print(f"dataset1={dataset1}\n\n")
        dataset2 = self.read_images(dataset_paths[1])
        ...
        for image in dataset:
            data_set.append(self._make_example(image['image'], image['segmentation_mask']))
