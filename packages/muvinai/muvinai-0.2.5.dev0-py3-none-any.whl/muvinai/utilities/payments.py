...
def get_client_price(client: dict, plan_price: int, corpo_discount: float, sum_access=True,
    ...
    subtotal = round(plan_price * sum([100 - d["descuento"] for d in prices["descuentos_porcentuales"]]) / 100, 2)
    ...
    for d in prices['descuentos_porcentuales']:
        ...
        charges_detail[concepto] = round(- charges_detail['native_plan'] * d['descuento'] / 100, 2)
