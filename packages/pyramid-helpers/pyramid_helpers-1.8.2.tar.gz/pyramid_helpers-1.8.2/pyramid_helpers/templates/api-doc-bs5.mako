...
<tr class="${required_tr_class}">
    ...
    % elif data['type'] == 'Int':
        <input type="text" class="form-control touchspin" data-bts-min="${data.get('min') or -4294967295}" data-bts-max="${data.get('max') or 4294967295}" id="${id}" name="${data['name']}"${required_input} />
    % elif data['type'] == 'OneOf':
        <select class="form-control selectpicker" id="${id}" name="${data['name']}" ${required_input} data-minimum-results-for-search="Infinity">
            <option value=""></option>
...
<div class="collapse show api-doc-module" id="api-doc-${module_id}" aria-multiselectable="true">
    ...
    <div class="card api-doc-service">
        <div class="card-header p-0 border-bottom-0">
            <h5 class="card-title api-doc-service-title" data-bs-toggle="collapse" data-bs-target="#api-doc-collapse-${service_id}" aria-expanded="true" aria-controls="api-doc-collapse-${service_id}">
                ## Methods
        ...
        <div id="api-doc-collapse-${service_id}" class="collapse api-doc-service-collapse" data-bs-parent="#api-doc-${module_id}" aria-labelledby="api-doc-heading-${service_id}">
            ...
            % endif
                    <div class="float-end">
                        <button class="btn btn-primary" type="submit">${translate('Send request')}</button>
                    </div>
                </form>
            </div><!-- .card-body -->
...
<script id="api-doc-form-error" type="text/x-handlebars-template">
<div class="alert alert-danger api-doc-input-error">
