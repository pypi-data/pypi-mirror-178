...
class Simulation:
    ...
    def get_results(self, signals: List[str] = None, wait=True) -> SimulationResults:
        """Get simulation results.

        :param signals: List of signal paths to fetch results of, defaults to None (all signals)
        :type signals: List[str], optional
        ...
        if signals is not None:
            return self._signal_results(signals)
        else:
            return self.results
