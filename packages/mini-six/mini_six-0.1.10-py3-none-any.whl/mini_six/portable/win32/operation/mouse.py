...
def move_to(handle: Union[int, windll.HWND], x: int, y: int):
    """移动鼠标到坐标（x, y)
...
def left_down(handle: Union[int, windll.HWND], x: int, y: int):
    """在坐标(x, y)按下鼠标左键
...
def left_up(handle: Union[int, windll.HWND], x: int, y: int):
    """在坐标(x, y)放开鼠标左键
...
def scroll(handle: Union[int, windll.HWND], delta: int, x: int, y: int):
    """在坐标(x, y)滚动鼠标滚轮
...
def scroll_up(handle: Union[int, windll.HWND], x: int, y: int):
    """在坐标(x, y)向上滚动鼠标滚轮
...
def scroll_down(handle: Union[int, windll.HWND], x: int, y: int):
    """在坐标(x, y)向下滚动鼠标滚轮
