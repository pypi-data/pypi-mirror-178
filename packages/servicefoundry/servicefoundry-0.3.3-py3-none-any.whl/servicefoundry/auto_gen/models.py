...
#   timestamp: 2022-11-16T15:36:36+00:00
...
class ModelFormat(str, Enum):
    ...
    mlflow = "mlflow"
    huggingface_transformers_pipeline = "huggingface-transformers-pipeline"
...
class Resources(BaseModel):
    ...
    ephemeral_storage_request: constr(regex=r"^[1-9]\d*$") = Field(
        "1000",
    ...
    ephemeral_storage_limit: constr(regex=r"^[1-9]\d*$") = Field(
        "2000",
...
class ModelDeployment(BaseModel):
    ...
    model_uri: constr(regex=r"(\w+:(/?/?)[^\s]+)") = Field(
        ...,
        description="+usage=URI of the model to be deployed. If you have saved your model using MLFoundry, paste the model FQN here.\n+sort=2\n+label=Model URI",
    )
