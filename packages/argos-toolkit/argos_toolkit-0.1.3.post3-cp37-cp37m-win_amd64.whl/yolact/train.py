...
def make_parser():
    ...
    parser.add_argument(
        ...
        default=-1,
        type=int,
        help='Resume training at this iter. If this is -1,'
    ...
    parser.add_argument(
        ...
        default=2,
        type=int,
        help='Output validation information every n iterations.'
    ...
    parser.add_argument(
        ...
        default=100000,
        type=int,
        help='When --keep_latest is on, don\'t delete the latest'
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help='If specified, override the dataset specified in'
        ' the config with this one (example: coco2017_dataset).',
    )
    parser.add_argument(
        '--no_log',
        dest='log',
    ...
    parser.add_argument(
        ...
        dest='log_gpu',
        action='store_true',
        help='Include GPU information in the logs. Nvidia-smi'
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help='If using multiple GPUS, you can set this to be a'
        ' comma separated list detailing which GPUs should get'
        ' what local batch size (It should add up to your total'
        ' batch size).',
    )
    parser.add_argument(
        '--no_autoscale',
...
def train(args):
    ...
    if args.batch_alloc is not None:
        ...
        if sum(args.batch_alloc) != args.batch_size:
            print(
                f'Error: Batch allocation {args.batch_alloc}'
                f' does not sum to batch size {args.batch_size}'
            )
            exit(-1)
