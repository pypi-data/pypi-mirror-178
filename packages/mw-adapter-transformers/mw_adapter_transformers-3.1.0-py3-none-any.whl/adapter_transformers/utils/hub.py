...
default_cache_path = os.path.join(hf_cache_home, "adapter_transformers")
...
def hf_bucket_url(
    ...
    its sha1 if stored in git, or its sha256 if stored in git-lfs. Files cached locally from adapter_transformers before v3.5.0
