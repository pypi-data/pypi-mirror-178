...
class XLMProphetNetEncoder(ProphetNetEncoder):
    ...
    ```python
    >>> from adapter_transformers import XLMProphetNetTokenizer, XLMProphetNetEncoder
    >>> import torch
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    ...
    ```python
    >>> from adapter_transformers import XLMProphetNetTokenizer, XLMProphetNetDecoder
    >>> import torch
...
class XLMProphetNetModel(ProphetNetModel):
    ...
    ```python
    >>> from adapter_transformers import XLMProphetNetTokenizer, XLMProphetNetModel
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    ...
    ```python
    >>> from adapter_transformers import XLMProphetNetTokenizer, XLMProphetNetForConditionalGeneration
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    ...
    ```python
    >>> from adapter_transformers import XLMProphetNetTokenizer, XLMProphetNetForCausalLM
    >>> import torch
    ...
    >>> from adapter_transformers import EncoderDecoderModel, XLMProphetNetTokenizer, XLMRobertaTokenizer
    >>> import torch
