...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from adapter_transformers import ViTFeatureExtractor, FlaxVisionEncoderDecoderModel
    ...
    def __call__(
        ...
        ```python
        >>> from adapter_transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
        >>> from PIL import Image
        >>> import requests
