...
class CTRLModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import CTRLTokenizer, CTRLModel
        >>> import torch
...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import CTRLTokenizer, CTRLLMHeadModel
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import CTRLTokenizer, CTRLForSequenceClassification
