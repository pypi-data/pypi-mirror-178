...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaImageModel, FlavaImageConfig
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaTextModel, FlavaTextConfig
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaMultimodalModel, FlavaMultimodalConfig
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaImageCodebook, FlavaImageCodebookConfig
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaModel, FlavaForPreTraining, FlavaConfig
