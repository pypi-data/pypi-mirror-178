...
class FlavaModel(FlavaPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import FlavaProcessor, FlavaModel
...
class FlavaImageCodebook(FlavaPreTrainedModel):
    ...
    def get_codebook_indices(self, pixel_values: torch.Tensor) -> torch.Tensor:
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import FlavaFeatureExtractor, FlavaImageCodebook
...
class FlavaForPreTraining(FlavaPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import FlavaForPreTraining, FlavaProcessor
