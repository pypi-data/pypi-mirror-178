...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BlenderbotTokenizer, BlenderbotModel
...
class BlenderbotForCausalLM(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BlenderbotTokenizer, BlenderbotForCausalLM
