...
class FlaxBlenderbotPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from adapter_transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
FLAX_BLENDERBOT_CONDITIONAL_GENERATION_DOCSTRING = r"""
    ...
    Conversation example::
        ...
        >>> from adapter_transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig
