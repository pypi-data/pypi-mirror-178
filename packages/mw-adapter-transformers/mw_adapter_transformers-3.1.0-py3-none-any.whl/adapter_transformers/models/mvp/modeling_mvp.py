...
MVP_CONDITIONAL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import MvpTokenizer, MvpForConditionalGeneration
...
MVP_SEQUENCE_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import MvpTokenizer, MvpForSequenceClassification
...
MVP_QUESTION_ANSWERING_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import MvpTokenizer, MvpForQuestionAnswering
...
class MvpForCausalLM(MvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import MvpTokenizer, MvpForCausalLM
