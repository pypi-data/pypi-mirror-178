...
class TFMT5Model(TFT5Model):
    ...
    ```python
    >>> from adapter_transformers import TFMT5Model, T5Tokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    ```python
    >>> from adapter_transformers import TFMT5ForConditionalGeneration, T5Tokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    ```python
    >>> from adapter_transformers import TFMT5EncoderModel, T5Tokenizer
