...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import PegasusTokenizer, BigBirdPegasusForConditionalGeneration
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartModel with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForSequenceClassification with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForQuestionAnswering with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import PegasusTokenizer, BigBirdPegasusForCausalLM
