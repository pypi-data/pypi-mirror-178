...
class TFDeiTForMaskedImageModeling(TFDeiTPreTrainedModel):
    ...
    def call(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import DeiTFeatureExtractor, TFDeiTForMaskedImageModeling
        >>> import tensorflow as tf
...
class TFDeiTForImageClassification(TFDeiTPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import DeiTFeatureExtractor, TFDeiTForImageClassification
        >>> import tensorflow as tf
        >>> from PIL import Image
        >>> import requests
