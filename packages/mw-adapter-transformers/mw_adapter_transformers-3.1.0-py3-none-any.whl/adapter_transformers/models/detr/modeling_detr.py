...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import DetrFeatureExtractor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import DetrFeatureExtractor, DetrForObjectDetection
        >>> import torch
        >>> from PIL import Image
        >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        >>> from adapter_transformers import DetrFeatureExtractor, DetrForSegmentation
        >>> from adapter_transformers.models.detr.feature_extraction_detr import rgb_to_id
