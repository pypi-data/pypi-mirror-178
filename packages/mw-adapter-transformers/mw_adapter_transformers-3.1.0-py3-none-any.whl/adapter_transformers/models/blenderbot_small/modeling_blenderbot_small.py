...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import BlenderbotSmallTokenizer, BlenderbotSmallForConditionalGeneration
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BlenderbotSmallTokenizer, BlenderbotSmallModel
...
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BlenderbotSmallTokenizer, BlenderbotSmallForCausalLM
