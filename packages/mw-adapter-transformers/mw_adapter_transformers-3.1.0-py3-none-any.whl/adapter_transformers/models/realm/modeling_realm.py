...
class RealmEmbedder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import RealmTokenizer, RealmEmbedder
        >>> import torch
...
class RealmScorer(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import RealmTokenizer, RealmScorer
...
class RealmKnowledgeAugEncoder(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import RealmTokenizer, RealmKnowledgeAugEncoder
...
class RealmForOpenQA(RealmPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import RealmForOpenQA, RealmRetriever, RealmTokenizer
