...
class VisualBertModel(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from adapter_transformers import BertTokenizer, VisualBertModel
        import torch
...
class VisualBertForPreTraining(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        from adapter_transformers import BertTokenizer, VisualBertForPreTraining
...
class VisualBertForMultipleChoice(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from adapter_transformers import BertTokenizer, VisualBertForMultipleChoice
        import torch
...
class VisualBertForQuestionAnswering(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from adapter_transformers import BertTokenizer, VisualBertForQuestionAnswering
        import torch
...
class VisualBertForVisualReasoning(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from adapter_transformers import BertTokenizer, VisualBertForVisualReasoning
        import torch
...
class VisualBertForRegionToPhraseAlignment(VisualBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        # Assumption: *get_visual_embeddings(image)* gets the visual embeddings of the image in the batch.
        from adapter_transformers import BertTokenizer, VisualBertForRegionToPhraseAlignment
        import torch
