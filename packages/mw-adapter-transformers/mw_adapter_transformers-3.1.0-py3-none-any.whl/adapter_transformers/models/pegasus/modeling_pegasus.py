...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import PegasusTokenizer, PegasusModel
...
class PegasusForCausalLM(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import PegasusTokenizer, PegasusForCausalLM
