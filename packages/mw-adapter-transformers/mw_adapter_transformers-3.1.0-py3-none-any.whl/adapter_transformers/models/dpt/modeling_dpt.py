...
class DPTForDepthEstimation(DPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import DPTFeatureExtractor, DPTForDepthEstimation
        >>> import torch
        >>> import numpy as np
...
class DPTForSemanticSegmentation(DPTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import DPTFeatureExtractor, DPTForSemanticSegmentation
        >>> from PIL import Image
        >>> import requests
