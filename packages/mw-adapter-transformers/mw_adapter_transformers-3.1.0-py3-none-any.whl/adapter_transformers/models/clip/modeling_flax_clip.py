...
class FlaxCLIPPreTrainedModel(FlaxPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import CLIPTokenizer, FlaxCLIPModel
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from adapter_transformers import CLIPProcessor, FlaxCLIPModel
...
FLAX_CLIP_TEXT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import CLIPTokenizer, FlaxCLIPTextModel
...
FLAX_CLIP_VISION_MODEL_DOCSTRING = """
    ...
    >>> from PIL import Image
    >>> import requests
    >>> from adapter_transformers import CLIPProcessor, FlaxCLIPVisionModel
