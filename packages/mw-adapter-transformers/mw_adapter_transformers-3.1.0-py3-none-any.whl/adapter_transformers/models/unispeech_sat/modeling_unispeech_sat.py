...
class UniSpeechSatForPreTraining(UniSpeechSatPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import Wav2Vec2FeatureExtractor, UniSpeechSatForPreTraining
...
# Copied from adapter_transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForSequenceClassification with Wav2Vec2->UniSpeechSat, wav2vec2->unispeech_sat, WAV_2_VEC_2->UNISPEECH_SAT
