...
class UniSpeechForPreTraining(UniSpeechPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import Wav2Vec2FeatureExtractor, UniSpeechForPreTraining
        >>> from adapter_transformers.models.unispeech.modeling_unispeech import _compute_mask_indices
...
# Copied from adapter_transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForSequenceClassification with Wav2Vec2->UniSpeech, wav2vec2->unispeech, WAV_2_VEC_2->UNISPEECH
