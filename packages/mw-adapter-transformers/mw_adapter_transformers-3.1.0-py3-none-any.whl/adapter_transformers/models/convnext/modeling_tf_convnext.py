...
class TFConvNextModel(TFConvNextPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import ConvNextFeatureExtractor, TFConvNextModel
...
class TFConvNextForImageClassification(TFConvNextPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import ConvNextFeatureExtractor, TFConvNextForImageClassification
        >>> import tensorflow as tf
        >>> from PIL import Image
        >>> import requests
