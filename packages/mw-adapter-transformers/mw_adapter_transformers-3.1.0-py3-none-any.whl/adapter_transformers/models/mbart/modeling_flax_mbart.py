...
class FlaxMBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from adapter_transformers import MBartTokenizer, FlaxMBartForConditionalGeneration
...
FLAX_MBART_CONDITIONAL_GENERATION_DOCSTRING = r"""
    ...
    ```python
    >>> from adapter_transformers import MBartTokenizer, FlaxMBartForConditionalGeneration, MBartConfig
