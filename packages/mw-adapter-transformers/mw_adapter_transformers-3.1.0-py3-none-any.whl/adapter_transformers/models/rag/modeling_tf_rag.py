...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import RagTokenizer, RagRetriever, TFRagModel
        >>> import torch
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import RagTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import RagTokenizer, RagRetriever, TFRagSequenceForGeneration
