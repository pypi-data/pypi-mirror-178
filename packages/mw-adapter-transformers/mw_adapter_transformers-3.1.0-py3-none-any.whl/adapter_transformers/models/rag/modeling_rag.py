...
class RagModel(RagPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import RagTokenizer, RagRetriever, RagModel
        >>> import torch
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import RagTokenizer, RagRetriever, RagSequenceForGeneration
        >>> import torch
...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import RagTokenizer, RagRetriever, RagTokenForGeneration
        >>> import torch
