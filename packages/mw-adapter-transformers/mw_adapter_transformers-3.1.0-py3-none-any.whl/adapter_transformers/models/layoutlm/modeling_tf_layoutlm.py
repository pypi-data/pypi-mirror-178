...
class TFLayoutLMModel(TFLayoutLMPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, TFLayoutLMModel
        >>> import tensorflow as tf
...
class TFLayoutLMForMaskedLM(TFLayoutLMPreTrainedModel, TFMaskedLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, TFLayoutLMForMaskedLM
        >>> import tensorflow as tf
...
class TFLayoutLMForSequenceClassification(TFLayoutLMPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, TFLayoutLMForSequenceClassification
        >>> import tensorflow as tf
...
class TFLayoutLMForTokenClassification(TFLayoutLMPreTrainedModel, TFTokenClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import LayoutLMTokenizer, TFLayoutLMForTokenClassification
