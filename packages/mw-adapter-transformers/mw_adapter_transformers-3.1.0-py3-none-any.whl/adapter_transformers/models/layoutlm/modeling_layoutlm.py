...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, LayoutLMModel
        >>> import torch
...
class LayoutLMForMaskedLM(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, LayoutLMForMaskedLM
        >>> import torch
...
class LayoutLMForSequenceClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, LayoutLMForSequenceClassification
        >>> import torch
...
class LayoutLMForTokenClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import LayoutLMTokenizer, LayoutLMForTokenClassification
        >>> import torch
