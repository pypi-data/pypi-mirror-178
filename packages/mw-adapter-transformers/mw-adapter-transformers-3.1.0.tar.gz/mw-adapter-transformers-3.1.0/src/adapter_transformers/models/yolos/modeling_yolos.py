...
if is_vision_available():
    from adapter_transformers.models.detr.feature_extraction_detr import center_to_corners_format
...
class YolosForObjectDetection(YolosPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import YolosFeatureExtractor, YolosForObjectDetection
