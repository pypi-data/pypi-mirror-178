...
# Copied from adapter_transformers.models.detr.feature_extraction_detr.center_to_corners_format
...
# Copied from adapter_transformers.models.detr.feature_extraction_detr.corners_to_center_format
...
# Copied from adapter_transformers.models.detr.feature_extraction_detr.masks_to_boxes
...
# Copied from adapter_transformers.models.detr.feature_extraction_detr.rgb_to_id
def rgb_to_id(color):
...
# Copied from adapter_transformers.models.detr.feature_extraction_detr.id_to_rgb
...
class YolosFeatureExtractor(FeatureExtractionMixin, ImageFeatureExtractionMixin):
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.__init__
    def __init__(
        self,
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor._is_valid_format
    def _is_valid_format(self, format):
        if format not in ["coco_detection", "coco_panoptic"]:
            raise ValueError(f"Format {format} not supported")
        return format

    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.prepare
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.convert_coco_poly_to_mask
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.prepare_coco_detection
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.prepare_coco_panoptic
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor._resize
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor._normalize
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor._max_by_axis
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.post_process
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.post_process_segmentation
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.post_process_instance
    ...
    # Copied from adapter_transformers.models.detr.feature_extraction_detr.DetrFeatureExtractor.post_process_panoptic
