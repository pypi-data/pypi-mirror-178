...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from adapter_transformers import TFVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
        >>> from PIL import Image
        >>> import requests
