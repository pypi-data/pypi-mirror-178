...
class T5Model(T5ModelAdaptersMixin, T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, T5Model
...
class T5ForConditionalGeneration(T5ModelWithHeadsAdaptersMixin, T5ModelAdaptersMixin, T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, T5ForConditionalGeneration
...
class T5EncoderModel(T5ModelAdaptersMixin, T5PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, T5EncoderModel
