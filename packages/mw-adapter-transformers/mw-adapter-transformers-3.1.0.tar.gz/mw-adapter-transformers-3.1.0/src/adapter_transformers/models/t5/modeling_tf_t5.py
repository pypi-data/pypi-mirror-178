...
class TFT5Model(TFT5PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, TFT5Model
...
class TFT5ForConditionalGeneration(TFT5PreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, TFT5ForConditionalGeneration
...
class TFT5EncoderModel(TFT5PreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import T5Tokenizer, TFT5EncoderModel
