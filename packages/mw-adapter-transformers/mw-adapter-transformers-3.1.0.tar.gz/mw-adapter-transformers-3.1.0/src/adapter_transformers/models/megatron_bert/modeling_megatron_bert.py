...
class MegatronBertForPreTraining(MegatronBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BertTokenizer, MegatronBertForPreTraining
        >>> import torch
...
class MegatronBertForCausalLM(MegatronBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BertTokenizer, MegatronBertForCausalLM, MegatronBertConfig
        >>> import torch
...
class MegatronBertForNextSentencePrediction(MegatronBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import BertTokenizer, MegatronBertForNextSentencePrediction
        >>> import torch
