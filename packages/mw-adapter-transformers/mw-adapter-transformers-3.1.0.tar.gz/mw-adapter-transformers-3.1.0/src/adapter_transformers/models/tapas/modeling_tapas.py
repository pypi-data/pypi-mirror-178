...
class TapasModel(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import TapasTokenizer, TapasModel
        >>> import pandas as pd
...
class TapasForMaskedLM(TapasPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import TapasTokenizer, TapasForMaskedLM
        >>> import pandas as pd
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import TapasTokenizer, TapasForQuestionAnswering
        >>> import pandas as pd
...
class TapasForSequenceClassification(TapasPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import TapasTokenizer, TapasForSequenceClassification
        >>> import torch
        >>> import pandas as pd
