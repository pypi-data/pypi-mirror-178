...
class FlaxMT5Model(FlaxT5Model):
    ...
    ```python
    >>> from adapter_transformers import FlaxMT5Model, T5Tokenizer
...
class FlaxMT5EncoderModel(FlaxT5EncoderModel):
    ...
    ```python
    >>> from adapter_transformers import FlaxT5EncoderModel, T5Tokenizer
...
class FlaxMT5ForConditionalGeneration(FlaxT5ForConditionalGeneration):
    ...
    ```python
    >>> from adapter_transformers import FlaxMT5ForConditionalGeneration, T5Tokenizer
