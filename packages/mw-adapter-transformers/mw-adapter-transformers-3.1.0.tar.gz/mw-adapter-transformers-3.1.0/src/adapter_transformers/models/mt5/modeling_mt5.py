...
class MT5Model(T5Model):
    ...
    ```python
    >>> from adapter_transformers import MT5Model, T5Tokenizer
...
class MT5ForConditionalGeneration(T5ForConditionalGeneration):
    ...
    ```python
    >>> from adapter_transformers import MT5ForConditionalGeneration, T5Tokenizer
...
class MT5EncoderModel(T5EncoderModel):
    ...
    ```python
    >>> from adapter_transformers import MT5EncoderModel, T5Tokenizer
