...
class QDQBertLMHeadModel(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import BertTokenizer, QDQBertLMHeadModel, QDQBertConfig
        >>> import torch
...
class QDQBertForNextSentencePrediction(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import BertTokenizer, QDQBertForNextSentencePrediction
        >>> import torch
