...
FLAX_WAV2VEC2_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import Wav2Vec2Processor, FlaxWav2Vec2Model
...
FLAX_WAV2VEC2_FOR_CTC_DOCSTRING = """
    ...
    ```python
    >>> import jax.numpy as jnp
    >>> from adapter_transformers import Wav2Vec2Processor, FlaxWav2Vec2ForCTC
    >>> from datasets import load_dataset
    >>> import soundfile as sf
...
FLAX_WAV2VEC2_FOR_PRETRAINING_DOCSTRING = """
    ...
    >>> import numpy as np
    >>> import jax.numpy as jnp
    >>> from adapter_transformers import Wav2Vec2FeatureExtractor, FlaxWav2Vec2ForPreTraining
