...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import CLIPTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from adapter_transformers import CLIPProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import CLIPTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import CLIPProcessor, TFCLIPModel
