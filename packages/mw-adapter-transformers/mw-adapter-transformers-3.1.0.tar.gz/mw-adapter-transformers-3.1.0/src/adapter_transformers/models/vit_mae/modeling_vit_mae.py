...
class ViTMAEPreTrainedModel(PreTrainedModel):
    ...
    # Copied from adapter_transformers.models.vit.modeling_vit.ViTPreTrainedModel._init_weights
...
class ViTMAEModel(ViTMAEPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoFeatureExtractor, ViTMAEModel
...
class ViTMAEForPreTraining(ViTMAEPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoFeatureExtractor, ViTMAEForPreTraining
        >>> from PIL import Image
        >>> import requests
