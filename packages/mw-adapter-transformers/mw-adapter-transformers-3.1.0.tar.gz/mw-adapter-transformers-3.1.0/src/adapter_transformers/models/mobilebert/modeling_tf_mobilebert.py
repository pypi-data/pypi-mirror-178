...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import MobileBertTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import MobileBertTokenizer, TFMobileBertForNextSentencePrediction
