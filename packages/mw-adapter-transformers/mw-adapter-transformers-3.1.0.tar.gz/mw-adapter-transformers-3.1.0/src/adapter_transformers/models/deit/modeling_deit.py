...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTPreTrainedModel with ViT->DeiT all-casing
...
class DeiTForMaskedImageModeling(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import DeiTFeatureExtractor, DeiTForMaskedImageModeling
        >>> import torch
...
class DeiTForImageClassification(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import DeiTFeatureExtractor, DeiTForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
