...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
    ...
    ```python
    >>> from adapter_transformers import MBartTokenizer, TFMBartForConditionalGeneration
...
class TFMBartForConditionalGeneration(TFMBartPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    @staticmethod
    # Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartForConditionalGeneration._reorder_cache
