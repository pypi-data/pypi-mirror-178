...
FLAX_BEIT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import BeitFeatureExtractor, FlaxBeitModel
...
FLAX_BEIT_MLM_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import BeitFeatureExtractor, BeitForMaskedImageModeling
    >>> from PIL import Image
    >>> import requests
...
FLAX_BEIT_CLASSIF_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import BeitFeatureExtractor, FlaxBeitForImageClassification
    >>> from PIL import Image
    >>> import requests
