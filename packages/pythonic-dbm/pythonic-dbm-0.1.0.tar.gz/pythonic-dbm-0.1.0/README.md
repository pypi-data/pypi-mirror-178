...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/hakancelikdev/pydbm/main.svg)](https://results.pre-commit.ci/latest/github/hakancelikdev/pydbm/main)
...
[![Pypi](https://img.shields.io/pypi/v/pydbm)](https://pypi.org/project/pydbm/)
![PyPI - Python Version](https://img.shields.io/pypi/pyversions/pydbm)
[![Downloads](https://static.pepy.tech/personalized-badge/pydbm?period=total&units=international_system&left_color=grey&right_color=red&left_text=downloads)](https://pepy.tech/project/pydbm)
