...
def get_filenames(files, packages):
    for package in packages:
        ...
        if package_spec is None:
            ...
            return None
        files.append(os.path.dirname(package_spec.origin))
...
def create_translation(out, files, packages, force_dir, no_translate, hardware):
    global keywords
...
def check_translations(directory, files, packages, check_keywords, hardware):
    global keywords
