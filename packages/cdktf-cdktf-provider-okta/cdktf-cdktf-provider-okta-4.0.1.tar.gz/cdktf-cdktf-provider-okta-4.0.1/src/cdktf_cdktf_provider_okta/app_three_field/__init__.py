...
class AppThreeField(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["AppThreeFieldTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        users: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["AppThreeFieldUsers", typing.Dict[str, typing.Any]]]]] = None,
        ...
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#id AppThreeField#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        ...
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#timeouts AppThreeField#timeouts}
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#create AppThreeField#create}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#read AppThreeField#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#update AppThreeField#update}.
        '''
    ...
    def put_users(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["AppThreeFieldUsers", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def users(self) -> "AppThreeFieldUsersList":
        return typing.cast("AppThreeFieldUsersList", jsii.get(self, "users"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["AppThreeFieldTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["AppThreeFieldTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class AppThreeFieldTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[AppThreeFieldTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[AppThreeFieldTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[AppThreeFieldTimeouts, cdktf.IResolvable]],
...
@jsii.data_type(
    jsii_type="@cdktf/provider-okta.appThreeField.AppThreeFieldUsers",
    jsii_struct_bases=[],
...
class AppThreeFieldUsers:
    def __init__(
        ...
        *,
        ...
        '''
        :param id: User ID. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/r/app_three_field#id AppThreeField#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
...
class AppThreeFieldUsersList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-okta.appThreeField.AppThreeFieldUsersList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def get(self, index: jsii.Number) -> "AppThreeFieldUsersOutputReference":
        '''
        ...
        return typing.cast("AppThreeFieldUsersOutputReference", jsii.invoke(self, "get", [index]))
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[AppThreeFieldUsers]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[AppThreeFieldUsers]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[AppThreeFieldUsers]]],
...
class AppThreeFieldUsersOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-okta.appThreeField.AppThreeFieldUsersOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[AppThreeFieldUsers, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[AppThreeFieldUsers, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[AppThreeFieldUsers, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[AppThreeFieldUsers, cdktf.IResolvable]],
