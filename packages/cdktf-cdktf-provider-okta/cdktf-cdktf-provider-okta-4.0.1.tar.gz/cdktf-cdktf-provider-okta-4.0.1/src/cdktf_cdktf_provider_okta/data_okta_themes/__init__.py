...
Refer to the Terraform Registory for docs: [`data_okta_themes`](https://www.terraform.io/docs/providers/okta/d/themes).
'''
import abc
import builtins
import datetime
...
class DataOktaThemes(
    ...
    def __init__(
        ...
        *,
        ...
        :param brand_id: Brand ID. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/d/themes#brand_id DataOktaThemes#brand_id}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/okta/d/themes#id DataOktaThemes#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataOktaThemesConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class DataOktaThemesThemesOutputReference(
    ...
    def internal_value(self, value: typing.Optional[DataOktaThemesThemes]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataOktaThemesThemes]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
