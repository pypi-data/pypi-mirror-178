...
def awsClient(service:str='s3'):  # Old S3Connect

    """
    Get S3 client
    
    service:str    
        s3: to get acces Data Lake
    ...
    s3_client = boto3.client(service,aws_access_key_id=aws_access_key_id,aws_secret_access_key=aws_secret_access_key)
