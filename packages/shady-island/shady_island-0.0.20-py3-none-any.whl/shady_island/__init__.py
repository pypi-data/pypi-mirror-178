...
class Tier(metaclass=jsii.JSIIMeta, jsii_type="shady-island.Tier"):
    ...
    def __init__(self, id: builtins.str, label: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(id: builtins.str, label: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Workload(
    ...
    def import_(self, *stacks: aws_cdk.Stack) -> None:
        ...
        *before* installing the ``shady-island`` library would not be able to be part
        ...
        '''
        if __debug__:
            def stub(*stacks: aws_cdk.Stack) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def _register_stack(self, stack: aws_cdk.Stack) -> aws_cdk.Stack:
        ...
        return typing.cast(aws_cdk.Stack, jsii.invoke(self, "registerStack", [stack]))
