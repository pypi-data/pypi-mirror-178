...
class SecretLabelsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[SecretLabels, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[SecretLabels, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SecretLabels, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[SecretLabels, cdktf.IResolvable]],
