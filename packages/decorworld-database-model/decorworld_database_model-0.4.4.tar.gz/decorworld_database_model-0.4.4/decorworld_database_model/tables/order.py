...
class OrderSchema(Schema):
    ...
    shipping_description = fields.String(data_key='shippingDescription', required=False)
    ...
    invoice_tax_number = fields.String(data_key='invoiceTaxNumber', required=False)
    invoice_description = fields.String(data_key='invoiceDescription', required=False)
