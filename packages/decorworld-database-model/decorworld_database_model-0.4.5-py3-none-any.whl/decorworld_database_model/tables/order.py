...
class OrderSchema(Schema):
    ...
    updated_date = fields.DateTime(data_key='updatedDate', allow_none=False)
    ...
    shipping_description = fields.String(data_key='shippingDescription', allow_none=False)
    ...
    invoice_tax_number = fields.String(data_key='invoiceTaxNumber', allow_none=False)
    invoice_description = fields.String(data_key='invoiceDescription', allow_none=False)
