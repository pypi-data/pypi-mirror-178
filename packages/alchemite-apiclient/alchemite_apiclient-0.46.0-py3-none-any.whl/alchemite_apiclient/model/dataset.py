...
class Dataset(ModelNormal):
    ...
    def _from_openapi_data(cls, name, row_count, column_headers, descriptor_columns, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            vector_pairs ([[str]], none_type): A list of pairs of column names.  The columns in each pair are the axes for a 2D coordinate system.. [optional]  # noqa: E501
            ...
            shared_through ([str]): If a dataset has been shared with the user then this will show through which group(s) it has been shared. Won't be set if the user requesting the resource owns it. . [optional]  # noqa: E501
        """
