...
class KeepAliveResponse:
    ...
    def from_http_response(res: Response):
        ...
        if res.status_code == 200:
            ...
            internal_error = KeepAliveError.INTERNAL_ERROR
            try:
        ...
        return KeepAliveResponse(success, error_code, _error_msg=_error_msg)