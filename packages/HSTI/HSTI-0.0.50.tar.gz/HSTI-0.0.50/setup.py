...
setuptools.setup(
    ...
    package_data={
    "HSTI.data_files": ["*.txt","*.pkl"],
    "HSTI.data_files.NUC.10_10_200_22": ["*.npy"],
    "HSTI.data_files.NUC.10_10_200_191": ["*.npy"],
    "HSTI.data_files.Temperature_conversions.10_10_200_22": ["*.npy"],
    "HSTI.data_files.Temperature_conversions.10_10_200_191": ["*.npy"]
    },
