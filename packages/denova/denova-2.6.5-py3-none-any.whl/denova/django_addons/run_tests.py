#!/usr/bin/env python3
'''
    Test runner for django based sites.
...
class RunTests():
    ...
    def dynamic_tests(self):
        ...
        try:
            ...
            # self.verbose('WARNING: "manage.py test" often locks up after running. Just Ctrl-C.')

            test_command = ['./manage.py',
                            'test',
                            '--verbosity',
                            str(self.VERBOSITY),
                            self.test]
