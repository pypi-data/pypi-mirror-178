...
def pretty_called_process_error(cpe):
    ''' Pretty-print subprocess.CalledProcessError
        ...
        <<< cpe = {"args": \
                   {"stderr": "Traceback (most recent call last):                      File \"/var/local/projects/tools/renew_cert.py\", line 32, in <module>                      print(pretty_called_process_error(cpe))                      File \"/usr/local/lib/python3.9/dist-packages/denova/python/format.py\", line 582, in pretty_called_process_error                      pretty = pretty + pretty_text("stdout", cpe.stdout)                      File "/usr/local/lib/python3.9/dist-packages/denova/python/format.py", line 567, in pretty_text                      text = text.decode().strip()                      AttributeError: \'str\' object has no attribute \'decode\'", "stdout": "", "return_code": 1}\
                  }
