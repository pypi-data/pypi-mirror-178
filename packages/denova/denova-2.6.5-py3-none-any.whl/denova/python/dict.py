...
from denova.python.internals import is_class_instance
from denova.python.log import Log
from denova.python.utils import last_exception, object_name
...
class Simple(dict):
    ''' You can reference a field in a Simple object by either obj.name or
        ...
        To convert a class instance to a dict, see denova.python.dict.dictify().
...
def dictify(obj, deep=False, json_compatible=False, debug=False):
    ''' Resolves an object to a dictionary.
        ...
        denova.python.internals.is_class_instance().
        ...
        denova.python.dict.Simple(). Builtin instance member names beginning
        with '__' are ignored.
