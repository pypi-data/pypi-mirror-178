...
import yaml
from pizza.exceptions import ConfigDoesNotExistException, InvalidConfiguration


logger = logging.getLogger(__name__)

USER_CONFIG_PATH = os.path.expanduser("~/.pizzarc")
...
DEFAULT_CONFIG = {
    "pizzas_dir": os.path.expanduser("~/.pizzas/"),
    "replay_dir": os.path.expanduser("~/.pizza_replay/"),
...
def get_config(config_path):
    ...
    raw_cookies_dir = config_dict["pizzas_dir"]
    config_dict["pizzas_dir"] = _expand_path(raw_cookies_dir)
...
def get_user_config(config_file=None, default_config=False):
    ...
    Otherwise look up the config file path in the ``PIZZA_CONFIG``
    ...
    try:
        ...
        env_config_file = os.environ["PIZZA_CONFIG"]
    except KeyError:
