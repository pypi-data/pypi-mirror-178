...
from pizza.find import find_template
from pizza.utils import make_sure_path_exists, rmtree, work_in
...
def is_copy_only_path(path, context):
    ...
    """
    try:
        for dont_render in context["pizza"]["_copy_without_render"]:
...
def generate_context(context_file="pizza.json", default_context=None):
