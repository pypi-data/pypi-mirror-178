...
class MCPipeNSBJob(Job):
    ...
    def set_sct_file(self, with_sct=False):
        ...
        if with_sct is True:
            ...
            self.output_file_metadata["sct"] = "True"
        else:
            self.output_file_metadata["sct"] = "False"
    ...
    def set_executable_sequence(self, debug=False):
        ...
        file_meta_data = {
            ...
            "nsb": 1,
            "sct": self.output_file_metadata["sct"],
        }
