        ...
        for dir in list_dir:
            ...
            if os.path.isfile(path):
                try:
                    ...
                    file_list.append({'name': dir, 'location': rel_location, 'type': 'File', 'valid': True})
                except:
                ...
                try:
                    ...
                    dir_list.append({'name': dir, 'location': rel_location, 'type': 'Directory', 'valid': True})
                except:
