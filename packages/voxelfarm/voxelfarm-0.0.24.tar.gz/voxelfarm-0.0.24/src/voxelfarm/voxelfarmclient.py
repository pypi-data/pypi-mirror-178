...
class rest:
    ...
    def notify_users(self, project_id, file_entity_id):
        ...
        if file_entity != None:
            emails_to = ["sylvain.giroux@royhill.com.au", "miguel@voxelfarm.com", "james.batchelor@royhill.com.au", "judith.scrimshaw@royhill.com.au", "lee.jamieson@royhill.com.au", "john.maitland@royhill.com.au", "jorgeluis@voxelfarm.com"]
    ...
    def workflow_get_parameter_dataframe(self, project_id, product_id, version = 0):
        attribute_product = self.workflow_get_entity_id(project_id, product_id, 'report_entity', version)
