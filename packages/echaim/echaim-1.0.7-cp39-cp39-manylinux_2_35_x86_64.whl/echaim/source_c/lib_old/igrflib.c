...
/*  char header[2][MAXSTR];*/
  ...
  FILE *fp;
  char *root = malloc(256 + 31); //256 is length of array in getDir, add 30 to the end for strcat
...
+  }*/
  strcpy(root,DIR);
  strcat(root,"aacgm/coeffs/magmodel_1590-2020.txt");
