...
setup(
    ...
    version=VERSION,
    description="A package that makes it somewhat simpler to make queries to an InfluxDB instance by creating an API for it.",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://bitbucket.org/dataductus/influxdb-querier/src/main/",
    author="Calle Holst",
    ...
    packages=["influxdb_querier"],
    install_requires=["influxdb", "influxdb-datalogger"],
