...
class Server(Socket):
    """
    Server part of the ``reapy_boost`` dist API.
    ...
    def _get_request(
        self, connection: Socket, address: ty.Union[ty.Tuple[str, ...], str]
    ) -> ty.Dict[str, object]:
        ...

    def _hold_connection(
        self, address: ty.Union[ty.Tuple[str, ...], str]
    ) -> ty.Dict[str, ty.Optional[str]]:
        ...

    def _process_request(
        self, request: ty.Dict[str, object],
        address: ty.Union[ty.Tuple[str, ...], str]
    ) -> ty.Dict[str, ty.Any]:
        ...

    def _send_result(
        self, connection: Socket, result: ty.Dict[str, ty.Any]
    ) -> None:
        ...
    ...
    def process_requests(
        self, requests: ty.Dict[str, ty.Any]
    ) -> ty.Dict[str, ty.Any]:
        ...
