...
class JournalDetail(dd.DetailLayout):
    ...
    dc force_sequence yearly_numbering auto_fill_suggestions make_ledger_movements auto_check_clearings must_declare preliminary
    printed_name
    MatchRulesByJournal
    """
...
class MyMovements(Movements):
    ...
    def get_filter_kw(self, ar, **kw):
        ...
        if p is None:
            return None
        kw.update(partner=p)
        return super(MyMovements, self).get_filter_kw(ar, **kw)
