...
class DexHelper:
    ...
    # def get_pair_info(self,_pair,_dex:UniswapV2):
    #     pair_address=_dex.get_pair(_pair[0],_pair[1])
    #     print(pair_address)
    #     return _dex.get_pair_info(pair_address)

    # def get_pair_reserve_dict_concureent(self,_pair_list:list,_dex:UniswapV2):
    #     pair_reserve_dict={}
    #     with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
    #         future_pair_info={executor.submit(self.get_pair_info,pair_address,_dex): pair_address for pair_address in _pair_list}
    #         for future in concurrent.futures.as_completed(future_pair_info):
    #             print(future.result())
        # for pair in _pair_list:
        #     pair_address=_dex.get_pair(pair[0],pair[1])
        #     token0Address,reserve0,token1Address,reserve1,blockTimeStamp,price0,price1=_dex.get_pair_info(pair_address)
