...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        pyinstaller_tool.resize(710, 762)
        font = QtGui.QFont()
        ...
        self.horizontalLayout_36.setContentsMargins(8, 8, 8, 8)
        ...
        self.lb_platform_info.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.pb_check_imports.setMinimumSize(QtCore.QSize(0, 36))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.ButtonText, brush)
        ...
        self.uiPushButton_clear_data.setMinimumSize(QtCore.QSize(0, 36))
        palette = QtGui.QPalette()
        ...
        self.pb_gen_executable.setMinimumSize(QtCore.QSize(0, 36))
        palette = QtGui.QPalette()
        ...
        self.horizontalLayout_36.addWidget(self.splitter)
...
"打包完成后的 exe 可执行文件文件的名称，此项留空则使用程序启动入口文件名。"))
        ...
        self.le_project_root.setToolTip(_translate("pyinstaller_tool", "是指当前程序项目的起始目录，主要用于确定虚拟环境的创建位置。"))
...
"如果项目目录下没有虚拟环境，则弹出菜单询问：使用主环境、创建虚拟环境、取消。"))
        ...
        self.lb_platform_info.setToolTip(_translate("pyinstaller_tool", "操作系统的版本信息，由内置 platform 模块提供。"))
