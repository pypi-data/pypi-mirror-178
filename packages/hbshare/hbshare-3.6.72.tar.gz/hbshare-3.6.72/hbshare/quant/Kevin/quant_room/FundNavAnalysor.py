...
if __name__ == '__main__':
    ...
    nv_series = get_fund_nav_from_sql('20211224', '20220909', {"卓识全天候": "STJ403"})
    period_date = get_trading_day_list('20211224', '20220909', frequency='week')
    nv_series = nv_series.reindex(period_date)

    FundNavAnalysor('20211224', '20220909', '000985', nv_series).run()