...
class Extensions(ApiEndpoint):
    ...
    def get_azure_dps_config(self) -> AzureDpsConfig:
    ...
    def get_azure_iot_hub_config(self) -> AzureIotHubConfig:
    ...
    def get_azure_iot_central_config(self) -> AzureIotCentralConfig:
    ...
    @api_call()
    def export_group_to_hyperscaler(self, config: ExportConfig) -> str:
        return self.session.post(self.get_url("/hyperscaler/export"), json=asdict(config))

    @api_call()
    def get_export_status(self, export_job_id: str) -> str:
