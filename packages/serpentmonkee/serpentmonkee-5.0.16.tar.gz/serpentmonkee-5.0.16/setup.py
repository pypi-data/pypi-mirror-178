...
setup(
    ...
    version='5.0.16',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/anthromorphic-ai/serpentmonkee/archive/5.0.16.tar.gz',
