...
class CreateCloudResource(object):
    ...
    def __init__(self, aws_vpc_id=None, aws_subnet_ids=None, aws_iam_role_arns=None, aws_security_groups=None, aws_s3_id=None, aws_efs_id=None, aws_efs_mount_target_ip=None, aws_cloudformation_stack_id=None, gcp_vpc_id=None, gcp_subnet_ids=None, local_vars_configuration=None):  # noqa: E501
        ...
        if aws_subnet_ids is not None:
            self.aws_subnet_ids = aws_subnet_ids
    ...
    @property
    def aws_subnet_ids(self):
        """Gets the aws_subnet_ids of this CreateCloudResource.  # noqa: E501

        A list of AWS subnet IDs of this cloud.  # noqa: E501

        :return: The aws_subnet_ids of this CreateCloudResource.  # noqa: E501
        :rtype: list[str]
        """
        return self._aws_subnet_ids

    @aws_subnet_ids.setter
    def aws_subnet_ids(self, aws_subnet_ids):
        """Sets the aws_subnet_ids of this CreateCloudResource.

        A list of AWS subnet IDs of this cloud.  # noqa: E501

        :param aws_subnet_ids: The aws_subnet_ids of this CreateCloudResource.  # noqa: E501
        :type: list[str]
        """

        self._aws_subnet_ids = aws_subnet_ids
