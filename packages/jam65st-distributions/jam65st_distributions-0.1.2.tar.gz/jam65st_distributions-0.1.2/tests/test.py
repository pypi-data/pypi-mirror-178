...
from jam65st_distributions import Gaussian
from jam65st_distributions import Binomial


class TestGaussianClass(unittest.TestCase):
    print('TestGaussianClass')
    ...
    def test_pdf(self):
        ...
        self.assertEqual(round(self.gaussian.pdf(75), 5),
                         0.00429,
...
# __token__: pypi-AgEIcHlwaS5vcmcCJGU4YTc1MDg0LTlhNmEtNGIwMC1hOWE5LTQ4YjU1MDUyOWRkNgACKlszLCI5N2NiZDFlZS1kOTY5LTRkZTItYjU3Zi0xNmM2MjljYWVlMDYiXQAABiDulW6CU4kv1dNy_hcv4r_-HF1keB4m_ixhJ198-bwFFQ