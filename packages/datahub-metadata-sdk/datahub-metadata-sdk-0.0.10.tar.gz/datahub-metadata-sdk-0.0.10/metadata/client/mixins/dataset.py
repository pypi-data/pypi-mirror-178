...
class DatasetMixin:
    ...
    def migrate_dataset(self,  dataset: Dataset, urn: str, upsert=True):
        ensure_type(dataset, Dataset)

        r = self._query_graphql(Dataset.entity_type, urn=urn)['data']['dataset']['editableDatasetProperties']
    ...
    def download_dataset(self, urn: str, dest: str, sub_paths: Optional[List[str]]):
        ...
        for file in files:
            ...
            storage_client.download(file, target)
