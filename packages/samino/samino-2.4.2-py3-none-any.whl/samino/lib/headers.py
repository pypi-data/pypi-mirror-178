...
# Not Required for normal samino only for async (for now atleast)
...
class Headers:
    def __init__(self, header_device: str = None):
        ...
        self.app_headers = {
            ...
            "User-Agent": "Dalvik/2.1.0 (Linux; U; Android 9; Galaxy S9 Build/SAmino 9 ; com.narvii.amino.master/3.5.34794)",
    ...
    def updateHeaders(self, data = None, lang = None, updateDevice = None, sid = None):
        ...
        if data: self.app_headers.update({"NDC-MSG-SIG": generateSig(data)})
