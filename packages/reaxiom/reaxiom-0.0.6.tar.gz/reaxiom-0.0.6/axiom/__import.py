...
def the_func(config={}, in_folders=[], given_name=[], out_folder=None, func_name=''):
    ...
    function_info = yaml.safe_load(open(os.path.join(_config['axiom_path'], 'info', 'local', func_name, md5+'.yaml')))
