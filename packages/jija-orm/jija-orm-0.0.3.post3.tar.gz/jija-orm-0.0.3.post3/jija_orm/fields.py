...
class Field:
    ...
    def __init__(self, *, pk=False, default=NotSet, null=False):
        self.pk = pk
        self.null = null
...
class RelatedField:
    def __init__(self, *, relation_to: models.Model, on_delete, null=False):
        if not isinstance(relation_to, models.Model):
