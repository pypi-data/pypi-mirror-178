...
class AnalysisObject(AbstractObject):
    ...
    def setup_minimizer(self, minimizer_type:str='Minuit2', minimizer_algo:str='Migrad', 
                        ...
                        hesse:bool=False, improve:int=0, max_calls:int=-1, max_iters:int=-1,
                        print_level:int=-1, timer:bool=False, constrain_nuis:bool=True,
                        batch_mode:bool=False, int_bin_precision:float=-1., minimizer_offset:int=1,
                        verbosity:Optional[Union[int, str]]="INFO"):
        
        minimizer = self.minimizer_cls("Minimizer", self.model.pdf, self.model.data,
                                       workspace=self.model.workspace, verbosity=verbosity)
    ...
    def save(self, fname:str, recreate:bool=True, rebuild:bool=False):
        self.model.save(fname, recreate=recreate, rebuild=rebuild)
