...
class H2ORegressionMetrics(H2OCommonMetrics):
    ...
    def getMeanResidualDeviance(self):
        """
        The mean residual deviance for this scoring run.
        """
        value = self._java_obj.getMeanResidualDeviance()
        return value
