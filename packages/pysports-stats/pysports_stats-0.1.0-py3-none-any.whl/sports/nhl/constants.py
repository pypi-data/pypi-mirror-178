PARSING_SCHEME = {
    ...
    'total_goals_per_game': 'td[data-stat="goals_for_per_game"]:first',
...
PLAYER_SCHEME = {
    ...
    'height': 'div[class="players"] p:nth-child(3) span:nth-child(1)',
    'weight': 'div[class="players"] p:nth-child(3) span:nth-child(2)',
