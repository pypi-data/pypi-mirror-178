...
class ReceiversApi(object):
    ...
    def get_receivers(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `FirmwareVersion` | String | `eq, neq, in, like, isnull, isnotnull` | | `MacAddress` | String | `eq, neq, in, like, isnull, isnotnull` | | `Name` | String | `eq, neq, in, like, isnull, isnotnull` | | `NetworkId` | String | `eq, neq, in, like, isnull, isnotnull` | | `PendingRfChannel` | Int32? | `eq, neq, in, lt, gt, leq, geq, isnull, isnotnull` | | `RadioMacAddress` | String | `eq, neq, in, like, isnull, isnotnull` | | `ReceiverLocationType` | ReceiverLocationTypeCodes | `eq, neq, in` | | `ReceiverType` | ReceiverTypeCodes | `eq, neq, in` | | `RfChannel` | Int32? | `eq, neq, in, lt, gt, leq, geq, isnull, isnotnull` | | `SerialNumber` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationAbbreviation` | String | `eq, neq, in, like, isnull, isnotnull` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, in, like, isnull, isnotnull` |
        ...
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `FirmwareVersion` | String | | `MacAddress` | String | | `Name` | String | | `NetworkId` | String | | `PendingRfChannel` | Int32? | | `RadioMacAddress` | String | | `RfChannel` | Int32? | | `SerialNumber` | String | | `CorporationName` | String | | `LocationName` | String |
