...
from cubicweb_wireit.views.edition import WiringCreationFormView

from cubicweb_processing.views.predicates import (
...
class _WiringForRunChainCreationFormView(WiringCreationFormView):
    ...
    def form_title(self, entity):
        ...
        title = xml_escape(
            self._cw._("Creating Wiring for RunChain %s")
