...
from cubicweb_web.views import uicfg as cw_uicfg

from cubicweb_wireit.views import uicfg as wireit_uicfg
...
_cw_pvs.tag_object_of(
    ("ParameterDefinition", "parameter_of", "Executable"), "attributes"
)
...
wireit_uicfg.wireit_afs.tag_object_of(
    ("RunChain", "wiring", "Wiring"), "main", "hidden"
)
