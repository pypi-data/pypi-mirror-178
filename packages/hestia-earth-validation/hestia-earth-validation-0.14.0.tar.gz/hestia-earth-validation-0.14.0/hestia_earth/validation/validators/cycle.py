...
def validate_crop_residue_completeness(cycle: dict, site: dict):
    ...
    data_completeness = cycle.get('completeness', {}).get(TermTermType.CROPRESIDUE.value)
    site_type = site.get('siteType')
...
def validate_cycle(cycle: dict, node_map: dict = {}):
    ...
    return flatten([
        ...
        ([
            ...
            validate_crop_residue_completeness(cycle, site) if 'completeness' in cycle and site else True,
