...
# IMG_DIR = 'data/nucleus/tif_images_sophie'
# IMG_DIR = 'data/nucleus/images_manual'

MSK_DIR = 'data/remi/tif_msk'
...
# MSK_DIR = 'data/nucleus/tif_masks_sophie'
