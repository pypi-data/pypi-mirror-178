...
{'': ['*'],
 'aceye': ['ARP Adjacency Endpoints/CSV/*',
           ...
           'BGP Peers/Mindmap/*',
           'BGP Peers/YAML/*',
           'BGP Route Reflector Nodes/CSV/*',
           'BGP Route Reflector Nodes/HTML/*',
           'BGP Route Reflector Nodes/JSON/*',
           'BGP Route Reflector Nodes/Markdown/*',
           'BGP Route Reflector Nodes/Mindmap/*',
           'BGP Route Reflector Nodes/YAML/*',
