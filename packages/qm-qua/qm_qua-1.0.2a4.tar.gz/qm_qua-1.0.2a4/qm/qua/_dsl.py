...
def play(
    ...
    **kwargs,
    ...
    :param chirp:   Allows to perform piecewise linear sweep of the element’s
                    ...
                    Note: When using chrip, it is possible to add a flag "continue_chirp=True" to the play command.
                    When this flag is set, the internal oscillator will continue the
                    chirp even after the play command had ended.
...
def strict_timing_():
    """
    Anything written inside the strict timing block will either be executed without gaps, or it will raise an error.
