(dom_loaded => {
    ...
    function updateSidebarAttributesVisible() {
        sidebar_button.setAttribute('title', "Seitenleiste einklappen");
        sidebar_button.setAttribute('aria-label', "Seitenleiste einklappen");
    ...
    function updateSidebarAttributesHidden() {
        sidebar_button.setAttribute('title', "Seitenleiste ausklappen");
        sidebar_button.setAttribute('aria-label', "Seitenleiste ausklappen");
