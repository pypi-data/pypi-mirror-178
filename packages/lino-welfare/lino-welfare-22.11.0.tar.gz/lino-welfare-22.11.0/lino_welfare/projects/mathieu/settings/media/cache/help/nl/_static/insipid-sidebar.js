(dom_loaded => {
    ...
    function updateSidebarAttributesVisible() {
        sidebar_button.setAttribute('title', "Zijpaneel inklappen");
        sidebar_button.setAttribute('aria-label', "Zijpaneel inklappen");
    ...
    function updateSidebarAttributesHidden() {
        sidebar_button.setAttribute('title', "Zijpaneel uitklappen");
        sidebar_button.setAttribute('aria-label', "Zijpaneel uitklappen");
