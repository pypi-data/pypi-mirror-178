...
config = {
    'dataset': 'yearbook', # choices=['arxiv', 'drug', 'huffpost', 'mimic', 'fmow', 'precipitation', 'yearbook']
    ...
    'prediction_type': 'mortality',  # help='MIMIC: "mortality" or "readmission", "precipitation"')
