...
const SAME_SELF_COLOR: Option<usize> = Some(3);
const SAME_COLOR: Option<usize> = None;
const NEW_COLOR: Option<usize> = Some(1);
const REMOVED_COLOR: Option<usize> = Some(0);
...
pub fn diff_circuits(
    ...
    if print_legend {
        write!(
            result,
            "{} {} {} {}\n",
            color("Black: Same as original", None),
