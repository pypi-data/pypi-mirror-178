import abc
from typing import Any, Callable, Dict, FrozenSet, List, Optional, Sequence, Set, Tuple, Type, Union
...
class Array(Circuit):
    ...
    @staticmethod
    def new_named_axes(value: torch.Tensor, name: Optional[str] = None, named_axes: Dict[int, str] = {}) -> "Array": ...
    @staticmethod
...
class PrintOptions(object):
    ...
    colorer: Optional[Callable[[Circuit], Optional[int]]]
    ...
    def __init__(
        ...
        colorer: Optional[Callable[[Circuit], Optional[int]]] = None,
    ...
    def evolve(
        ...
        colorer: Union[Optional[Callable[[Circuit], Optional[int]]], NotSet] = NOT_SET,
    ...
    @staticmethod
    def size_colorer() -> Callable[[Circuit], Optional[int]]: ...
    @staticmethod
    def hash_colorer() -> Callable[[Circuit], Optional[int]]: ...
    @staticmethod
    def type_colorer() -> Callable[[Circuit], Optional[int]]: ...
    @staticmethod
    def computability_colorer() -> Callable[[Circuit], Optional[int]]: ...
    @staticmethod
    def fixed_color(color: Optional[int]) -> Callable[[Circuit], Optional[int]]: ...
...
class PrintHtmlOptions(object):
    ...
    colorer: Optional[Callable[[Circuit], str]]  # Should return a css color. If None, use the primary color
    primary_color: str
    ...
    def __init__(
        ...
        colorer: Optional[Callable[[Circuit], str]] = PrintHtmlOptions.type_colorer(),
        primary_color: str = "lightgray",
        display_serial_numbers: bool = False,
    ...
    def evolve(
        ...
        display_serial_numbers: Union[bool, NotSet] = NOT_SET,
    ...
    @staticmethod
    def size_colorer() -> Callable[[Circuit], str]: ...
    @staticmethod
    def hash_colorer() -> Callable[[Circuit], str]: ...
    @staticmethod
    def type_colorer() -> Callable[[Circuit], str]: ...
    @staticmethod
    def computability_colorer() -> Callable[[Circuit], str]: ...
    @staticmethod
    def fixed_color(color: str) -> Callable[[Circuit], str]: ...
...
class ExpandModuleSpecCircuitChangedShapeInExpandError(ExpandError): ...
class ExpandModuleSpecArgSymbolReplacedWithNonSymbolError(ExpandError): ...
class ExpandModuleSpecArgSymbolChangedShapeInExpandError(ExpandError): ...
...
class ParseExpectedNoExtraInfoError(ParseError): ...
...
class ParseCircuitExpected3CharsPerForModuleExtraError(ParseCircuitError): ...
class ParseCircuitModuleInconsistentNumChildrenError(ParseCircuitError): ...
...
class ParseArgError(ValueError): ...
class ParseArgReferenceCircuitByNameHasNoneNameError(ParseArgError): ...
class ParseArgReferenceCircuitDuplicateIdentifierError(ParseArgError): ...
...
class ModuleBindModuleBindExpectedSymbolError(ModuleBindError): ...
...
class BindItem:
    """
    Utility class for module_new_bind.
