...
ClircuitColorer = Callable[[Circuit], CliColor]
...
class PrintOptions(object):
    ...
    colorer: Optional[Callable[[Circuit], CliColor]]
    ...
    @staticmethod
    def size_colorer() -> ClircuitColorer: ...
    @staticmethod
    def hash_colorer() -> ClircuitColorer: ...
    @staticmethod
    def type_colorer() -> ClircuitColorer: ...
    @staticmethod
    def computability_colorer() -> ClircuitColorer: ...
    @staticmethod
    def fixed_color(color: Optional[int]) -> ClircuitColorer: ...
    @staticmethod
    def circuit_set_colorer(map: Dict[str, Circuit]) -> ClircuitColorer:
...
class ExpandModuleSpecCircuitChangedNDimInExpandError(ExpandError): ...
class ExpandModuleSpecArgSymbolReplacedWithNonSymbolError(ExpandError): ...
class ExpandModuleSpecArgSymbolChangedNDimInExpandError(ExpandError): ...
