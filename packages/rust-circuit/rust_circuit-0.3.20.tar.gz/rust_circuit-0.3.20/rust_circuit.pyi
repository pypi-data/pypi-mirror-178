...
class PrintOptions(object):
    ...
    def evolve(
        ...
        colorer: Union[Optional[Callable[[Circuit], int]], NotSet] = NOT_SET,
...
class PrintHtmlOptions(object):
    ...
    def __init__(
        ...
        colorer: Optional[Callable[[Circuit], str]] = PrintHtmlOptions.variant_colorer(),
    ...
    @staticmethod
    def variant_colorer() -> Callable[[Circuit], str]: ...
    @staticmethod
