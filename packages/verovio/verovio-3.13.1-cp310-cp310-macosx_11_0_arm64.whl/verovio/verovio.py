...
class toolkit(object):
    ...
    def renderToTimemap(self, *args):
        return _verovio.toolkit_renderToTimemap(self, *args)

    def renderToTimemapFile(self, *args):
    ...
    def getNotatedIdForElement(toolkit, xml_id):
        return json.loads(_verovio.toolkit_getNotatedIdForElement(toolkit, xml_id))
