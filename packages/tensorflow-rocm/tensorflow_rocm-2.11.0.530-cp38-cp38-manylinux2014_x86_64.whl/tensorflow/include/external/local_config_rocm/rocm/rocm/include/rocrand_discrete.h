...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.3.0/include/rocrand/rocrand_discrete.h by using #include <rocrand/rocrand_discrete.h>")
