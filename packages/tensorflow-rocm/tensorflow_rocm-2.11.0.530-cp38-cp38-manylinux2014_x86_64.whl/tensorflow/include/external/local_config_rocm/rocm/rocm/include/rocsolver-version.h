...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.3.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>")
...
#define ROCSOLVER_VERSION_MINOR 19
#define ROCSOLVER_VERSION_PATCH 0
#define ROCSOLVER_VERSION_TWEAK 29f4a39-dirty
// clang-format on
