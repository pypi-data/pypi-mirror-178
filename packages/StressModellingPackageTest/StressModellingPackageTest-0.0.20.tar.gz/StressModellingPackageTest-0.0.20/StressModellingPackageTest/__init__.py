...
def CreateGraph(BeforeInterventionFolder,AfterInterventionFolder,adjList,function):
    Graph_obj =  GraphCreator().MakeGraph(BeforeInterventionFolder,AfterInterventionFolder,adjList,function)
    return Graph_obj
...
# Graph_obj1= GraphCreator().MakeGraph(BeforeInterventionFolder=r"./Before",AfterInterventionFolder=r"./After",adjList=r"./Adjacent list ac zones.xlsx",function="L2 Norm")
