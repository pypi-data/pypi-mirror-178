...
class BayesianOptimizer(BaseOptimizationAlgorithm):
    """
    Optimization algorithm from scikit-optimize library
    ...
    Args :
        ...
        algorithm_options (dict,optional): Additional keyword arguments passed to skopt.Optimizer. https://scikit-optimize.github.io/stable/modules/generated/skopt.Optimizer.html
        May include:
