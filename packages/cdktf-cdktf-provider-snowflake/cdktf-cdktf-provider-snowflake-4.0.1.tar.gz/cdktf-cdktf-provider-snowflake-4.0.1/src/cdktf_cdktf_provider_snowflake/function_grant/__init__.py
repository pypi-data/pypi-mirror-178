...
class FunctionGrantArgumentsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[FunctionGrantArguments, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[FunctionGrantArguments, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[FunctionGrantArguments, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[FunctionGrantArguments, cdktf.IResolvable]],
