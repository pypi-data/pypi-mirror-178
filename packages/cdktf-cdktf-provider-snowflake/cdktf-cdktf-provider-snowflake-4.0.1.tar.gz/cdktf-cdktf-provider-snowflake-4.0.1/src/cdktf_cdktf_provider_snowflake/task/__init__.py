...
class Task(
    ...
    def __init__(
        ...
        *,
        ...
        allow_overlapping_execution: typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]] = None,
    ...
    def allow_overlapping_execution_input(
        ...
        return typing.cast(typing.Optional[typing.Union[builtins.bool, cdktf.IResolvable]], jsii.get(self, "allowOverlappingExecutionInput"))
    ...
    def allow_overlapping_execution(
        ...
        return typing.cast(typing.Union[builtins.bool, cdktf.IResolvable], jsii.get(self, "allowOverlappingExecution"))
