...
@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('math.segment_sum_v2', v1=['math.segment_sum_v2', 'segment_sum_v2'])
@deprecated_endpoints('segment_sum_v2')
def segment_sum_v2(data, segment_ids, num_segments, name=None):
  ...
  if tld.is_eager:
    try:
      ...
      pass
    try:
      _result = _dispatcher_for_segment_sum_v2(
      ...
      _result = _dispatch.dispatch(
            segment_sum_v2, (), dict(data=data, segment_ids=segment_ids,
...
_dispatcher_for_segment_sum_v2 = segment_sum_v2._tf_type_based_dispatcher.Dispatch
