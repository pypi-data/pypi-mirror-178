...
comment_english = {
    ...
    "table-cor": {
        "start_date": " input current living country in the FIRST line, put the expiry date of your immigration document like study pemmit/work permit/visitor record as the end date.\nfrom the second line, input any other countries that you have lived in for more six months, excluding your current living country and the country of your citizenship"
    },
    "table-military": {
