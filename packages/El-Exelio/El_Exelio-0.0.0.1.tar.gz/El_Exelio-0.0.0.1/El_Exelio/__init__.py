...
class Workbook:
    ...
    def append(self, sheet=None, head: tuple | list = None, data: tuple | list = None, head_bold: bool = False,
               head_justify: str = "center", data_bold: bool = False, data_justify: str = "center"):
        if sheet is None:
            sheet = self.sheet
