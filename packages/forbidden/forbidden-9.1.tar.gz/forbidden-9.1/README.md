...
python3 -m pip install dist/forbidden-9.1-py3-none-any.whl
```
...
[
   {
      ...
      "body":null,
      "agent":"Forbidden/9.1",
      "command":"curl --connect-timeout 90 -m 180 -iskL --max-redirs 10 --path-as-is -H 'Host: 127.0.0.1' -H 'User-Agent: Forbidden/9.1' -X 'GET' 'https://example.com:443/admin'",
      "code":200,
      "length":255408
   },
   {
      ...
      "body":null,
      "agent":"Forbidden/9.1",
      "command":"curl --connect-timeout 90 -m 180 -iskL --max-redirs 10 --path-as-is -H 'Host: 127.0.0.1:443' -H 'User-Agent: Forbidden/9.1' -X 'GET' 'https://example.com:443/admin'",
      "code":200,
      "length":255408
   }
]
...
```fundamental
Forbidden v9.1 ( github.com/ivan-sincek/forbidden )
...
```fundamental
Stresser v4.1 ( github.com/ivan-sincek/forbidden )
