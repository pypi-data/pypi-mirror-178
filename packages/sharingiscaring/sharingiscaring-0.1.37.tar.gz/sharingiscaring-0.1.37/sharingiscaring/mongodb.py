...
from sharingiscaring.tooter import Tooter, TooterType
console = Console()
...
class MongoDB(
    ...
    def __init__(self, mongo_config, tooter):
        ...
        try:
            ...
            tooter.send(message=f'BOT ERROR! Cannot connect to MongoDB, with error: {e}', notifier_type=TooterType.MONGODB_ERROR)
