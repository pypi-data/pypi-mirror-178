...
class SubscriptionDetails(Enum):
    ...
    SUBSCRIPTION_ONE_TIME_FEE   = int(os.environ.get('SUBSCRIPTION_ONE_TIME_FEE', 400))
    ...
    SUBSCRIPTION_UNLIMITED      = int(os.environ.get('SUBSCRIPTION_UNLIMITED', 480))
    ...
    SUBSCRIPTION_PLAN_START_DATE = dateutil.parser.parse(os.environ.get('SUBSCRIPTION_PLAN_START_DATE', "2022-11-29"))
class TestClass:
    def __init__(self):
        pass
