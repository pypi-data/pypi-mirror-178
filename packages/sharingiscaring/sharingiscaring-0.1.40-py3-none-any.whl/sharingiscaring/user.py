...
class SubscriptionDetails(Enum):
    ...
    SUBSCRIPTION_PLAN_START_DATE = dateutil.parser.parse(os.environ.get('SUBSCRIPTION_PLAN_START_DATE', "2022-12-01"))
    SUBSCRIPTION_PLAN_COUNTDOWN = SUBSCRIPTION_PLAN_ACTIVE and (SUBSCRIPTION_PLAN_START_DATE >  dt.datetime.now())
    SUBSCRIPTION_PLAN_GO        = SUBSCRIPTION_PLAN_ACTIVE and (SUBSCRIPTION_PLAN_START_DATE <= dt.datetime.now())
class TestClass:
    def __init__(self):
        pass
