...
class _InstructionContainer:
    ...
    def join(self, cols, other):
        def innerjoin_fn(rs1, rs2):
            if rs1 != [] and rs2 != []:
                for r1 in rs1:
                    for r2 in rs2:
                        r1.update(r2)
                        yield {col: r1.get(col, None) for col in cols}
    ...
    def left_join(self, cols, other):
        def leftjoin_fn(rs1, rs2):
            if rs1 != [] and rs2 != []:
                for r1 in rs1:
                    for r2 in rs2:
                        r1.update(r2)
    ...
    def right_join(self, cols, other):
        def rightjoin_fn(rs1, rs2):
            if rs1 != [] and rs2 != []:
                for r2 in rs2:
                    for r1 in rs1:
                        r2.update(r1)
                        yield {col: r2.get(col, None) for col in cols}
            elif rs1 == [] and rs2 != []:
                for r2 in rs2:
                    yield {col: r2.get(col, None) for col in cols}
    ...
    def full_join(self, cols, other):
        def fulljoin_fn(rs1, rs2):
            if rs1 != [] and rs2 != []:
                for r1 in rs1:
                    for r2 in rs2:
                        r1.update(r2)
