...
#
def Refractive_Index_Re_Extended_NIST(descriptor, energy_in_keV, density, material_constants_library=xraylib):
...
def Refractive_Index_Im_Extended_NIST(descriptor, energy_in_keV, density, material_constants_library=xraylib):
    if descriptor_kind_index(descriptor) == 2:
        ...
        return material_constants_library.Refractive_Index_Im(descriptor, energy_in_keV, density)
...
# moved to power.xoppy_calc_xpower
