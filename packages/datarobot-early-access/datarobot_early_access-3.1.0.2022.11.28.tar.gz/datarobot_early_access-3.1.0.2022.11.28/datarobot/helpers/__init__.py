...
class AdvancedOptions:
    ...
    blend_best_models: bool, optional
        (New in version v2.19) blend best models during Autopilot run. DEPRECATED
    ...
    consider_blenders_in_recommendation: bool, optional
        ...
        deployment in an Autopilot Run. Defaults to False.  DEPRECATED
    ...
    def __init__(
        ...
        if self.blend_best_models:
            deprecation_warning(
                subject="blend_best_models in Advanced Options",
                deprecated_since_version="3.1",
                will_remove_version="3.2",
                message="Blending in autopilot is deprecated",
            )
        ...
        if self.consider_blenders_in_recommendation:
            deprecation_warning(
                subject="consider_blenders_in_recommendation in Advanced Options",
                deprecated_since_version="3.1",
                will_remove_version="3.2",
                message="Blending in autopilot is deprecated",
            )
...
See `datarobot.helpers.AdvancedOptions` for all available advanced options."
        ...
        elif self.consider_blenders_in_recommendation:
            deprecation_warning(
                subject="consider_blenders_in_recommendation in Advanced Options",
                deprecated_since_version="3.1",
                will_remove_version="3.2",
