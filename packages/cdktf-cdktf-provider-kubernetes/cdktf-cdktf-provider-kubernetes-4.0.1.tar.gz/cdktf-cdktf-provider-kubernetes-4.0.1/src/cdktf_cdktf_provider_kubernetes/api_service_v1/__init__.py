...
class ApiServiceV1(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        metadata: typing.Union["ApiServiceV1Metadata", typing.Dict[str, typing.Any]],
        spec: typing.Union["ApiServiceV1Spec", typing.Dict[str, typing.Any]],
    ...
    def put_spec(
        ...
        *,
        ...
        service: typing.Optional[typing.Union["ApiServiceV1SpecService", typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
...
class ApiServiceV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class ApiServiceV1MetadataOutputReference(
    ...
    def internal_value(self, value: typing.Optional[ApiServiceV1Metadata]) -> None:
        if __debug__:
            def stub(value: typing.Optional[ApiServiceV1Metadata]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ApiServiceV1SpecOutputReference(
    ...
    def internal_value(self, value: typing.Optional[ApiServiceV1Spec]) -> None:
        if __debug__:
            def stub(value: typing.Optional[ApiServiceV1Spec]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class ApiServiceV1SpecServiceOutputReference(
    ...
    def internal_value(self, value: typing.Optional[ApiServiceV1SpecService]) -> None:
        if __debug__:
            def stub(value: typing.Optional[ApiServiceV1SpecService]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
