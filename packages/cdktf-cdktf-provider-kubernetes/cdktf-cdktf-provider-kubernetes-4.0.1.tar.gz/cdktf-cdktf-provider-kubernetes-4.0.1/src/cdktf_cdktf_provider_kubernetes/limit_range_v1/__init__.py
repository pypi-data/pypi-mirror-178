...
class LimitRangeV1(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        metadata: typing.Union["LimitRangeV1Metadata", typing.Dict[str, typing.Any]],
        id: typing.Optional[builtins.str] = None,
        spec: typing.Optional[typing.Union["LimitRangeV1Spec", typing.Dict[str, typing.Any]]] = None,
    ...
    def put_spec(
        self,
        *,
        limit: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["LimitRangeV1SpecLimit", typing.Dict[str, typing.Any]]]]] = None,
    ) -> None:
        '''
...
class LimitRangeV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class LimitRangeV1MetadataOutputReference(
    ...
    def internal_value(self, value: typing.Optional[LimitRangeV1Metadata]) -> None:
        if __debug__:
            def stub(value: typing.Optional[LimitRangeV1Metadata]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class LimitRangeV1Spec:
    ...
    def limit(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["LimitRangeV1SpecLimit"]]]:
        '''limit block.
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["LimitRangeV1SpecLimit"]]], result)
...
class LimitRangeV1SpecLimitList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LimitRangeV1SpecLimit]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LimitRangeV1SpecLimit]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LimitRangeV1SpecLimit]]],
...
class LimitRangeV1SpecLimitOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[LimitRangeV1SpecLimit, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[LimitRangeV1SpecLimit, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[LimitRangeV1SpecLimit, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[LimitRangeV1SpecLimit, cdktf.IResolvable]],
...
class LimitRangeV1SpecOutputReference(
    ...
    def put_limit(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union[LimitRangeV1SpecLimit, typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def limit_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[LimitRangeV1SpecLimit]]], jsii.get(self, "limitInput"))
    ...
    def internal_value(self, value: typing.Optional[LimitRangeV1Spec]) -> None:
        if __debug__:
            def stub(value: typing.Optional[LimitRangeV1Spec]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
