...
class DataKubernetesSecretV1(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        metadata: typing.Union["DataKubernetesSecretV1Metadata", typing.Dict[str, typing.Any]],
    ...
    def immutable(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "immutable"))
...
class DataKubernetesSecretV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class DataKubernetesSecretV1MetadataOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataKubernetesSecretV1Metadata]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
