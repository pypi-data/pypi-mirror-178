...
class DataKubernetesEndpointsV1(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        metadata: typing.Union["DataKubernetesEndpointsV1Metadata", typing.Dict[str, typing.Any]],
        id: typing.Optional[builtins.str] = None,
        subset: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1Subset", typing.Dict[str, typing.Any]]]]] = None,
        ...
        '''Create a new {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1 kubernetes_endpoints_v1} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param metadata: metadata block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#metadata DataKubernetesEndpointsV1#metadata}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#id DataKubernetesEndpointsV1#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param subset: subset block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#subset DataKubernetesEndpointsV1#subset}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_metadata(
        ...
        *,
        ...
        '''
        :param annotations: An unstructured key value map stored with the endpoints that may be used to store arbitrary metadata. More info: http://kubernetes.io/docs/user-guide/annotations Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#annotations DataKubernetesEndpointsV1#annotations}
        :param generate_name: Prefix, used by the server, to generate a unique name ONLY IF the ``name`` field has not been provided. This value will also be combined with a unique suffix. Read more: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#idempotency Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#generate_name DataKubernetesEndpointsV1#generate_name}
        :param labels: Map of string keys and values that can be used to organize and categorize (scope and select) the endpoints. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#labels DataKubernetesEndpointsV1#labels}
        :param name: Name of the endpoints, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#name DataKubernetesEndpointsV1#name}
        :param namespace: Namespace defines the space within which name of the endpoints must be unique. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#namespace DataKubernetesEndpointsV1#namespace}
        '''
    ...
    def put_subset(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1Subset", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def subset_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1Subset"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1Subset"]]], jsii.get(self, "subsetInput"))
...
class DataKubernetesEndpointsV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def subset(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1Subset"]]], result)
...
class DataKubernetesEndpointsV1MetadataOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataKubernetesEndpointsV1Metadata]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataKubernetesEndpointsV1Subset:
    def __init__(
        self,
        *,
        address: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1SubsetAddress", typing.Dict[str, typing.Any]]]]] = None,
        not_ready_address: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1SubsetNotReadyAddress", typing.Dict[str, typing.Any]]]]] = None,
        port: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1SubsetPort", typing.Dict[str, typing.Any]]]]] = None,
    ) -> None:
        '''
        :param address: address block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#address DataKubernetesEndpointsV1#address}
        :param not_ready_address: not_ready_address block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#not_ready_address DataKubernetesEndpointsV1#not_ready_address}
        :param port: port block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#port DataKubernetesEndpointsV1#port}
        '''
        if __debug__:
            def stub(
                *,
    ...
    def address(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetAddress"]]]:
        '''address block.
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetAddress"]]], result)

    @builtins.property
    def not_ready_address(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetNotReadyAddress"]]]:
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetNotReadyAddress"]]], result)

    @builtins.property
    def port(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetPort"]]]:
        '''port block.
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetPort"]]], result)
...
class DataKubernetesEndpointsV1SubsetAddress:
    def __init__(
        ...
        *,
        ...
        '''
        :param ip: The IP of this endpoint. May not be loopback (127.0.0.0/8), link-local (169.254.0.0/16), or link-local multicast ((224.0.0.0/24). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#ip DataKubernetesEndpointsV1#ip}
        :param hostname: The Hostname of this endpoint. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#hostname DataKubernetesEndpointsV1#hostname}
        :param node_name: Node hosting this endpoint. This can be used to determine endpoints local to a node. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#node_name DataKubernetesEndpointsV1#node_name}
        '''
        if __debug__:
            def stub(
                *,
...
class DataKubernetesEndpointsV1SubsetAddressList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetAddress]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetAddress]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetAddress]]],
...
class DataKubernetesEndpointsV1SubsetAddressOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetAddress, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetAddress, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetAddress, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetAddress, cdktf.IResolvable]],
...
class DataKubernetesEndpointsV1SubsetList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1Subset]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1Subset]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1Subset]]],
...
class DataKubernetesEndpointsV1SubsetNotReadyAddressList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetNotReadyAddress]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetNotReadyAddress]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetNotReadyAddress]]],
...
class DataKubernetesEndpointsV1SubsetNotReadyAddressOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetNotReadyAddress, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetNotReadyAddress, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetNotReadyAddress, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetNotReadyAddress, cdktf.IResolvable]],
...
class DataKubernetesEndpointsV1SubsetOutputReference(
    ...
    def put_address(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union[DataKubernetesEndpointsV1SubsetAddress, typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_not_ready_address(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union[DataKubernetesEndpointsV1SubsetNotReadyAddress, typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_port(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["DataKubernetesEndpointsV1SubsetPort", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def address_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetAddress]]], jsii.get(self, "addressInput"))
    ...
    def not_ready_address_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetNotReadyAddress]]], jsii.get(self, "notReadyAddressInput"))
    ...
    def port_input(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["DataKubernetesEndpointsV1SubsetPort"]]], jsii.get(self, "portInput"))

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataKubernetesEndpointsV1Subset, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataKubernetesEndpointsV1Subset, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataKubernetesEndpointsV1Subset, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataKubernetesEndpointsV1Subset, cdktf.IResolvable]],
...
class DataKubernetesEndpointsV1SubsetPort:
    def __init__(
        ...
        *,
        ...
        '''
        :param port: The port that will be exposed by this endpoint. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#port DataKubernetesEndpointsV1#port}
        :param name: The name of this port within the endpoint. Must be a DNS_LABEL. Optional if only one Port is defined on this endpoint. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#name DataKubernetesEndpointsV1#name}
        :param protocol: The IP protocol for this port. Supports ``TCP`` and ``UDP``. Default is ``TCP``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/endpoints_v1#protocol DataKubernetesEndpointsV1#protocol}
        '''
        if __debug__:
            def stub(
                *,
...
class DataKubernetesEndpointsV1SubsetPortList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetPort]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetPort]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[DataKubernetesEndpointsV1SubsetPort]]],
...
class DataKubernetesEndpointsV1SubsetPortOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetPort, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetPort, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetPort, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataKubernetesEndpointsV1SubsetPort, cdktf.IResolvable]],
