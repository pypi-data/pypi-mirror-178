...
class PersistentVolumeClaimMetadataOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[PersistentVolumeClaimMetadata]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class PersistentVolumeClaimSpecOutputReference(
    ...
    def internal_value(self, value: typing.Optional[PersistentVolumeClaimSpec]) -> None:
        if __debug__:
            def stub(value: typing.Optional[PersistentVolumeClaimSpec]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class PersistentVolumeClaimSpecSelectorOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[PersistentVolumeClaimSpecSelector]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
