...
class QuboModel(object):
    ...
    def __init__(self):
        ...
        # some stats
        self._num_nnz_full_matrix = None
    ...
    def get_nnz_full_matrix(self):
        if self._num_nnz_full_matrix is None:
            return NotImplemented

        return self._num_nnz_full_matrix
    ...
    def _readQuboFile(cls, f):
        ...
        qubo._num_nnz_full_matrix = linear_terms + 2*(num_nnz - linear_terms)
