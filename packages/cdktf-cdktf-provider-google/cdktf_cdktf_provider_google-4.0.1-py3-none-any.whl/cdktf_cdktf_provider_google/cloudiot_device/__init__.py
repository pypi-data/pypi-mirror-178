...
class CloudiotDeviceConfigAOutputReference(
    ...
    def internal_value(self, value: typing.Optional[CloudiotDeviceConfigA]) -> None:
        if __debug__:
            def stub(value: typing.Optional[CloudiotDeviceConfigA]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CloudiotDeviceGatewayConfigOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[CloudiotDeviceGatewayConfig]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class CloudiotDeviceLastErrorStatusOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[CloudiotDeviceLastErrorStatus]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class CloudiotDeviceStateOutputReference(
    ...
    def internal_value(self, value: typing.Optional[CloudiotDeviceState]) -> None:
        if __debug__:
            def stub(value: typing.Optional[CloudiotDeviceState]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
