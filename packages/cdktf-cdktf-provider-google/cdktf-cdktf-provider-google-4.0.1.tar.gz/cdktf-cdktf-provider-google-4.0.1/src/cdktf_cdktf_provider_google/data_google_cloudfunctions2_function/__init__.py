...
class DataGoogleCloudfunctions2FunctionBuildConfigSourceRepoSourceOutputReference(
    ...
    def invert_regex(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "invertRegex"))
...
class DataGoogleCloudfunctions2FunctionConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class DataGoogleCloudfunctions2FunctionServiceConfigOutputReference(
    ...
    def all_traffic_on_latest_revision(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "allTrafficOnLatestRevision"))
