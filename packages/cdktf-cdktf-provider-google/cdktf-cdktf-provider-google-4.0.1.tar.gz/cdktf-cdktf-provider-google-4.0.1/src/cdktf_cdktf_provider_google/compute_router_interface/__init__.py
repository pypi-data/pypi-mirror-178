...
class ComputeRouterInterface(
    ...
    def __init__(
        ...
        *,
        ...
        :param redundant_interface: The name of the interface that is redundant to this interface. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google/r/compute_router_interface#redundant_interface ComputeRouterInterface#redundant_interface}
