...
class ModelWindow(QtWidgets.QMainWindow):
    ...
    def setup_gui(self):
        ...
        self.settings_widget.resize(400, 300)
        self.settings_widget.setWindowModality(QtCore.Qt.WindowModality.WindowModal)
...
class GenerativeTab(ModelTab):
    ...
    def post_init(self, pe):
        super().post_init(pe)
        with fns.overrideAttr(pe, "defaultParent", "Sample Options"):
