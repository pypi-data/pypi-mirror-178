...
def get_working_environment_and_notebook_if_appropriate() -> Tuple[
    ...
    if working_environment is WorkingEnvironment.SCRIPT:
        ...
        notebook = jupyter_notebook.Notebook(working_environment)
