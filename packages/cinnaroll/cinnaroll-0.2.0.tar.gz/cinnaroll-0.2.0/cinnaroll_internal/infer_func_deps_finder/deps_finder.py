...
class NotebookDepsFinder(DependenciesFinder):
    def __init__(self, infer_func: Callable[[Any, Any], Any], current_notebook: Notebook) -> None:
        super().__init__()
...
def build_deps_finder(
        ...
        current_notebook: Optional[Notebook]) -> DependenciesFinder:
    if current_notebook:
        return NotebookDepsFinder(infer_func, current_notebook)
    else:
