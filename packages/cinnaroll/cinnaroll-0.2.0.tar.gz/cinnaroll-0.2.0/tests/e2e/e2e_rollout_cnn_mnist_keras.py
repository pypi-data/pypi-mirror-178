...
from cinnaroll import rollout, RolloutConfig
...
class MyRolloutConfig(RolloutConfig):
    ...
    ) -> str:  # input -> processing -> inference -> output
...
if __name__ == "__main__":
    ...
    myRolloutConfig = MyRolloutConfig(
        project_id="196a6681-72ab-48d1-a04a-584a3267cbea",  # project's unique identifier
