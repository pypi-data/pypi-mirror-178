...
# cifti_space = my_brain_viewer.visualize_cifti_space(volumetric_structures='subcortex')
...
dscalar_layer = my_brain_viewer.add_cifti_dscalar_layer(dscalar_file=dscalar_file, colormap=plt.cm.Spectral,)

wait = input("Press Enter to continue.")

# stat = 'curvature'
# dscalar_file = cbu.get_data_file(f'templates/HCP/dscalars/S1200.{stat}_MSMAll.32k_fs_LR.dscalar.nii')
# dscalar_layer = my_brain_viewer.add_cifti_dscalar_layer(dscalar_file=dscalar_file, colormap=plt.cm.Greys_r, opacity=0.01)
