...
class ScenarioExecutor():
    ...
    def __init__(self, global_config, machines_factory, name, title, description, machine_provisionner, default_target, verifieurs_list=[], expected_result=True, **scenario_args):
        """
    ...
    def run(self, is_skipped):
        ...
        self.log.debut('Lancement scenario', scenario=self.name)
        ...
        self.log.fin('Lancement scenario', scenario=self.name)
    ...
    def play_scenario(self, machine_provisionner, scenario_name, **scenarios_args):
        ...
        """
        self.log.debut('Lancement deploiement', scenario=self.name)
        ...
        if not self.global_config.get('testcase::skip_deploy') == True:
            ...
            self.log.fin('Lancement deploiement', scenario=self.name)
