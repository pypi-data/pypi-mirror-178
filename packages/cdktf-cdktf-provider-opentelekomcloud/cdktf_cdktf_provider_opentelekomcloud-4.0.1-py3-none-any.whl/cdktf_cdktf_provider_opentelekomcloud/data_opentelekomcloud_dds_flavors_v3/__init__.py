...
class DataOpentelekomcloudDdsFlavorsV3Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class DataOpentelekomcloudDdsFlavorsV3FlavorsOutputReference(
    ...
    def az_status(self) -> cdktf.StringMap:
        return typing.cast(cdktf.StringMap, jsii.get(self, "azStatus"))
