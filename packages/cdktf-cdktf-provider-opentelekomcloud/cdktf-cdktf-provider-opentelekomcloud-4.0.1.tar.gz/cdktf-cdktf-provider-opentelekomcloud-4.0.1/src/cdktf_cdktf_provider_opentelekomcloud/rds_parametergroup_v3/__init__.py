...
class RdsParametergroupV3(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        datastore: typing.Union["RdsParametergroupV3Datastore", typing.Dict[str, typing.Any]],
        name: builtins.str,
...
class RdsParametergroupV3Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class RdsParametergroupV3ConfigurationParametersOutputReference(
    ...
    def readonly(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "readonly"))

    @builtins.property
    @jsii.member(jsii_name="restartRequired")
    def restart_required(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "restartRequired"))
...
class RdsParametergroupV3DatastoreOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[RdsParametergroupV3Datastore]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
