...
class DataOpentelekomcloudCssFlavorV1(
    ...
    def __init__(
        ...
        id_: builtins.str,
        *,
        disk_range: typing.Optional[typing.Union["DataOpentelekomcloudCssFlavorV1DiskRange", typing.Dict[str, typing.Any]]] = None,
...
class DataOpentelekomcloudCssFlavorV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
