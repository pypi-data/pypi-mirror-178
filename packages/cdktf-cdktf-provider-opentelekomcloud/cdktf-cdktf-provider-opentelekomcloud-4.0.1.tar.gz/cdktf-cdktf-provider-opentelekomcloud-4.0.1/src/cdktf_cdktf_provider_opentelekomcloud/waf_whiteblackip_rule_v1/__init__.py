...
class WafWhiteblackipRuleV1(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["WafWhiteblackipRuleV1Timeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["WafWhiteblackipRuleV1Timeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["WafWhiteblackipRuleV1Timeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class WafWhiteblackipRuleV1Config(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class WafWhiteblackipRuleV1TimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[WafWhiteblackipRuleV1Timeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[WafWhiteblackipRuleV1Timeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[WafWhiteblackipRuleV1Timeouts, cdktf.IResolvable]],
