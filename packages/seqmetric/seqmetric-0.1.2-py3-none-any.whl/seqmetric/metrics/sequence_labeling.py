...
from .v1 import precision_recall_fscore_support as precision_recall_fscore_support_v1
...
def precision_recall_fscore_support(y_true: List[List[str]],
    ...
    Examples:
        >>> from seqmetric.metrics.sequence_labeling import precision_recall_fscore_support
...
def get_entities(seq, suffix=False):
    ...
    Example:
        >>> from seqmetric.metrics.sequence_labeling import get_entities
...
def f1_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from seqmetric.metrics import f1_score
...
def accuracy_score(y_true, y_pred):
    ...
    Example:
        >>> from seqmetric.metrics import accuracy_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def precision_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from seqmetric.metrics import precision_score
        >>> y_true = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'O', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def recall_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Example:
        >>> from seqmetric.metrics import recall_score
        >>> y_true = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'O', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'B-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def performance_measure(y_true, y_pred):
    ...
    Example:
        >>> from seqmetric.metrics import performance_measure
...
def classification_report(y_true, y_pred,
    ...
    Examples:
        >>> from seqmetric.metrics import classification_report
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
