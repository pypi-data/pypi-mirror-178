...
def precision_recall_fscore_support(y_true: List[List[str]],
    ...
    Examples:
        >>> from seqmetric.metrics.v1 import precision_recall_fscore_support
        >>> from seqmetric.scheme import IOB2
...
def classification_report(y_true: List[List[str]],
    ...
    Examples:
        >>> from seqmetric.metrics.v1 import classification_report
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
