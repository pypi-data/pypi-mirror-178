...
class GoogleDataFusionInstance(
    ...
    def __init__(
        ...
        *,
        ...
        :param enable_rbac: Option to enable granular role-based access control. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/google-beta/r/google_data_fusion_instance#enable_rbac GoogleDataFusionInstance#enable_rbac}
