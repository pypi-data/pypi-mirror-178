...
class GoogleComputeSubnetwork(
    ...
    def __init__(
        ...
        *,
        ...
        log_config: typing.Optional[typing.Union["GoogleComputeSubnetworkLogConfig", typing.Dict[str, typing.Any]]] = None,
        ...
        secondary_ip_range: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["GoogleComputeSubnetworkSecondaryIpRange", typing.Dict[str, typing.Any]]]]] = None,
        stack_type: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional[typing.Union["GoogleComputeSubnetworkTimeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def put_secondary_ip_range(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["GoogleComputeSubnetworkSecondaryIpRange", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def secondary_ip_range_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["GoogleComputeSubnetworkSecondaryIpRange"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["GoogleComputeSubnetworkSecondaryIpRange"]]], jsii.get(self, "secondaryIpRangeInput"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["GoogleComputeSubnetworkTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["GoogleComputeSubnetworkTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class GoogleComputeSubnetworkConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def secondary_ip_range(
        ...
        *Note**: This field uses `attr-as-block mode <https://www.terraform.io/docs/configuration/attr-as-blocks.html>`_ to avoid
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["GoogleComputeSubnetworkSecondaryIpRange"]]], result)
...
class GoogleComputeSubnetworkLogConfigOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[GoogleComputeSubnetworkLogConfig]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleComputeSubnetworkSecondaryIpRangeList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[GoogleComputeSubnetworkSecondaryIpRange]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[GoogleComputeSubnetworkSecondaryIpRange]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[GoogleComputeSubnetworkSecondaryIpRange]]],
...
class GoogleComputeSubnetworkSecondaryIpRangeOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[GoogleComputeSubnetworkSecondaryIpRange, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[GoogleComputeSubnetworkSecondaryIpRange, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[GoogleComputeSubnetworkSecondaryIpRange, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[GoogleComputeSubnetworkSecondaryIpRange, cdktf.IResolvable]],
...
class GoogleComputeSubnetworkTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[GoogleComputeSubnetworkTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[GoogleComputeSubnetworkTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[GoogleComputeSubnetworkTimeouts, cdktf.IResolvable]],
