...
class GoogleAccessContextManagerServicePerimeterResource(
    ...
    def __init__(
        ...
        *,
        ...
        timeouts: typing.Optional[typing.Union["GoogleAccessContextManagerServicePerimeterResourceTimeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["GoogleAccessContextManagerServicePerimeterResourceTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["GoogleAccessContextManagerServicePerimeterResourceTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class GoogleAccessContextManagerServicePerimeterResourceTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[GoogleAccessContextManagerServicePerimeterResourceTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[GoogleAccessContextManagerServicePerimeterResourceTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[GoogleAccessContextManagerServicePerimeterResourceTimeouts, cdktf.IResolvable]],
