...
class GoogleGkeHubFeature(
    ...
    def __init__(
        ...
        *,
        ...
        spec: typing.Optional[typing.Union["GoogleGkeHubFeatureSpec", typing.Dict[str, typing.Any]]] = None,
        timeouts: typing.Optional[typing.Union["GoogleGkeHubFeatureTimeouts", typing.Dict[str, typing.Any]]] = None,
    ...
    def put_spec(
        self,
        *,
        multiclusteringress: typing.Optional[typing.Union["GoogleGkeHubFeatureSpecMulticlusteringress", typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["GoogleGkeHubFeatureTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["GoogleGkeHubFeatureTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class GoogleGkeHubFeatureConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
...
class GoogleGkeHubFeatureResourceStateOutputReference(
    ...
    def has_resources(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "hasResources"))
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[GoogleGkeHubFeatureResourceState]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class GoogleGkeHubFeatureSpecMulticlusteringress:
    def __init__(self, *, config_membership: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, config_membership: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GoogleGkeHubFeatureSpecOutputReference(
    ...
    def internal_value(self, value: typing.Optional[GoogleGkeHubFeatureSpec]) -> None:
        if __debug__:
            def stub(value: typing.Optional[GoogleGkeHubFeatureSpec]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class GoogleGkeHubFeatureStateOutputReference(
    ...
    def internal_value(self, value: typing.Optional[GoogleGkeHubFeatureState]) -> None:
        if __debug__:
            def stub(value: typing.Optional[GoogleGkeHubFeatureState]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class GoogleGkeHubFeatureStateStateOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[GoogleGkeHubFeatureStateState]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class GoogleGkeHubFeatureTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[GoogleGkeHubFeatureTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[GoogleGkeHubFeatureTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[GoogleGkeHubFeatureTimeouts, cdktf.IResolvable]],
