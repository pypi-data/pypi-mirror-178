...
class GoogleBigqueryTableIamBinding(
    ...
    def __init__(
        ...
        *,
        ...
        condition: typing.Optional[typing.Union["GoogleBigqueryTableIamBindingCondition", typing.Dict[str, typing.Any]]] = None,
...
class GoogleBigqueryTableIamBindingConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
