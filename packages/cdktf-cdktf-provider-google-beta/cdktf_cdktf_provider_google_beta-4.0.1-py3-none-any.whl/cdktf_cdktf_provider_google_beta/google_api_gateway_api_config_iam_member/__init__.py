...
class GoogleApiGatewayApiConfigIamMember(
    ...
    def __init__(
        ...
        *,
        ...
        member: builtins.str,
        role: builtins.str,
        condition: typing.Optional[typing.Union["GoogleApiGatewayApiConfigIamMemberCondition", typing.Dict[str, typing.Any]]] = None,
...
class GoogleApiGatewayApiConfigIamMemberConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
