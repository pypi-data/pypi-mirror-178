...
class GoogleCloudfunctionsFunctionIamBinding(
    ...
    def __init__(
        ...
        *,
        ...
        role: builtins.str,
        condition: typing.Optional[typing.Union["GoogleCloudfunctionsFunctionIamBindingCondition", typing.Dict[str, typing.Any]]] = None,
...
class GoogleCloudfunctionsFunctionIamBindingConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
