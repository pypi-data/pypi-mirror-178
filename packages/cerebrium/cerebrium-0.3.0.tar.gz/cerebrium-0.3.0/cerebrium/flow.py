...
PrebuiltModelTypes = {"mt0-xl", "galactica", "whisper-medium", "flan-xl", "stable-diffusion-2"}
...
def _check_special_model(model_flow: CerebriumFlow):
    ...
    if model_flow[0][0] == ModelType.ONNX:
        ...
        if model_flow[0][1] not in PrebuiltModelTypes:
            raise NotImplementedError(
                f"Prebuilt model {model_flow[0][1]} not found. Available models are {PrebuiltModelTypes}"
            )
