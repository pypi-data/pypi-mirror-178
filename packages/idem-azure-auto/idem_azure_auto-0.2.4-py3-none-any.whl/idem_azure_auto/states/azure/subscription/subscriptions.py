...
async def present(
    ...
    **Autogenerated function**
    ...
    response_get = await hub.exec.request.json.get(
        ctx,
        url=f"{hub.exec.azure.URL}{resource_id}?api-version=2020-09-01",
        success_codes=[200],
    )
    ...
    if not response_get["result"]:
        ...
        response_get_detailed_subscription = await hub.exec.request.json.get(
            ctx,
            url=f"{hub.exec.azure.URL}/subscriptions/{subscription_id}?api-version=2020-01-01",
            success_codes=[200],
        )
        ...
        response_rename = await hub.exec.request.json.post(
            ctx,
            url=f"{hub.exec.azure.URL}/subscriptions/{subscription_id}/providers/Microsoft.Subscription/rename?api-version=2020-09-01",
            success_codes=[200, 201],
            json=rename_payload,
        )
    ...
    **Autogenerated function**
    ...
    if response_get["result"]:
        ...
        response_cancel = await hub.exec.request.json.post(
            ctx,
            url=f"{hub.exec.azure.URL}/subscriptions/{subscription_id}/providers/Microsoft.Subscription/cancel?api-version=2020-09-01",
...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    **Autogenerated function**
    ...
    async for page_result in hub.tool.azure.request.paginate(
        ctx,
        url=f"{hub.exec.azure.URL}/subscriptions?api-version=2020-01-01",
        success_codes=[200],
    ):
