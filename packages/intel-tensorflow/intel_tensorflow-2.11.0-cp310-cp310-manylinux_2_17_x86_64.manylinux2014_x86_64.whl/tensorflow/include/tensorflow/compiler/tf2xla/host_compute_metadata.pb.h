...
class HostTransferMetadata final :
 ...
 public:
  ...
  explicit constexpr HostTransferMetadata(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class HostComputeMetadata final :
 ...
 public:
  ...
  explicit constexpr HostComputeMetadata(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
