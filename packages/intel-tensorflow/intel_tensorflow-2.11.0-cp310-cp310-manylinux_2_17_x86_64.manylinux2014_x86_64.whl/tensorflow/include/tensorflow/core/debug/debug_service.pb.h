...
class EventReply_DebugOpStateChange final :
 ...
 public:
  ...
  explicit constexpr EventReply_DebugOpStateChange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class EventReply final :
 ...
 public:
  ...
  ~EventReply() override;
  explicit constexpr EventReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr CallTraceback_OriginIdToStringEntry_DoNotUse(
...
class CallTraceback final :
 ...
 public:
  ...
  explicit constexpr CallTraceback(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void EventReply_DebugOpStateChange::set_debug_op(ArgT0&& arg0, ArgT... args) {
 ...
 debug_op_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& EventReply_DebugOpStateChange::_internal_debug_op() const {
  return debug_op_.Get();
}
inline void EventReply_DebugOpStateChange::_internal_set_debug_op(const std::string& value) {
  
  debug_op_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* EventReply_DebugOpStateChange::_internal_mutable_debug_op() {
  
  return debug_op_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* EventReply_DebugOpStateChange::release_debug_op() {
  ...
  return debug_op_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void EventReply_DebugOpStateChange::set_allocated_debug_op(std::string* debug_op) {
  ...
  debug_op_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), debug_op,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (debug_op_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    debug_op_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void CallTraceback::set_call_key(ArgT0&& arg0, ArgT... args) {
 ...
 call_key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CallTraceback::_internal_call_key() const {
  return call_key_.Get();
}
inline void CallTraceback::_internal_set_call_key(const std::string& value) {
  
  call_key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CallTraceback::_internal_mutable_call_key() {
  
  return call_key_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CallTraceback::release_call_key() {
  // @@protoc_insertion_point(field_release:tensorflow.CallTraceback.call_key)
  return call_key_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CallTraceback::set_allocated_call_key(std::string* call_key) {
  ...
  call_key_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), call_key,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (call_key_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    call_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
