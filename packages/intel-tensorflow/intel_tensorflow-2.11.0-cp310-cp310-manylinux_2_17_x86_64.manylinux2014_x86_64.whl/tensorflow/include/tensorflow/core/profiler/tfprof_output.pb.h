...
class TFProfTensorProto final :
 ...
 public:
  ...
  explicit constexpr TFProfTensorProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr GraphNodeProto_InputShapesEntry_DoNotUse(
...
class GraphNodeProto final :
 ...
 public:
  ...
  explicit constexpr GraphNodeProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class MultiGraphNodeProto final :
 ...
 public:
  ...
  explicit constexpr MultiGraphNodeProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr AdviceProto_CheckersEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AdviceProto_Checker final :
 ...
 public:
  ...
  explicit constexpr AdviceProto_Checker(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AdviceProto final :
 ...
 public:
  ...
  explicit constexpr AdviceProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void GraphNodeProto::clear_tensor_value() {
  if (GetArenaForAllocation() == nullptr && tensor_value_ != nullptr) {
...
inline void GraphNodeProto::set_allocated_tensor_value(::tensorflow::tfprof::TFProfTensorProto* tensor_value) {
  ...
  if (tensor_value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::tfprof::TFProfTensorProto>::GetOwningArena(tensor_value);
...
inline void GraphNodeProto::clear_accelerator_exec_micros() {
  accelerator_exec_micros_ = int64_t{0};
}
...
inline void GraphNodeProto::clear_total_definition_count() {
  total_definition_count_ = int64_t{0};
}
...
inline void GraphNodeProto::clear_total_accelerator_exec_micros() {
  total_accelerator_exec_micros_ = int64_t{0};
}
...
inline void GraphNodeProto::clear_total_cpu_exec_micros() {
  total_cpu_exec_micros_ = int64_t{0};
}
...
inline void GraphNodeProto::clear_total_requested_bytes() {
  total_requested_bytes_ = int64_t{0};
}
...
inline void GraphNodeProto::clear_total_residual_bytes() {
  total_residual_bytes_ = int64_t{0};
}
