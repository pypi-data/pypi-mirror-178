...
class TPUEmbeddingConfiguration_SpmdSharding final :
 ...
 public:
  ...
  explicit constexpr TPUEmbeddingConfiguration_SpmdSharding(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TPUEmbeddingError final :
 ...
 public:
  ...
  explicit constexpr TPUEmbeddingError(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void TPUEmbeddingConfiguration::clear_spmd_sharding() {
  if (GetArenaForAllocation() == nullptr && spmd_sharding_ != nullptr) {
...
inline void TPUEmbeddingConfiguration::unsafe_arena_set_allocated_spmd_sharding(
    ::tensorflow::tpu::TPUEmbeddingConfiguration_SpmdSharding* spmd_sharding) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(spmd_sharding_);
  }
...
inline void TPUEmbeddingConfiguration::set_allocated_spmd_sharding(::tensorflow::tpu::TPUEmbeddingConfiguration_SpmdSharding* spmd_sharding) {
  ...
  if (spmd_sharding) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::tpu::TPUEmbeddingConfiguration_SpmdSharding>::GetOwningArena(spmd_sharding);
    if (message_arena != submessage_arena) {
