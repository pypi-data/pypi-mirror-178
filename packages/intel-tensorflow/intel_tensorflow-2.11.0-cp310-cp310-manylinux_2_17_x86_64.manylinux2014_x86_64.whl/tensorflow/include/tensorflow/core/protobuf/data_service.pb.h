...
class ProcessingModeDef final :
 ...
 public:
  ...
  explicit constexpr ProcessingModeDef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DataServiceMetadata final :
 ...
 public:
  ...
  explicit constexpr DataServiceMetadata(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class CrossTrainerCacheOptions final :
 ...
 public:
  ...
  explicit constexpr CrossTrainerCacheOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DataServiceConfig final :
 ...
 public:
  ...
  explicit constexpr DataServiceConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void DataServiceMetadata::clear_element_spec() {
  if (_internal_has_element_spec()) {
    optional_element_spec_.element_spec_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
...
inline void DataServiceMetadata::set_element_spec(ArgT0&& arg0, ArgT... args) {
  ...
  optional_element_spec_.element_spec_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& DataServiceMetadata::_internal_element_spec() const {
  if (_internal_has_element_spec()) {
    return optional_element_spec_.element_spec_.Get();
  }
...
inline void DataServiceMetadata::_internal_set_element_spec(const std::string& value) {
  ...
  optional_element_spec_.element_spec_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DataServiceMetadata::_internal_mutable_element_spec() {
  ...
  return optional_element_spec_.element_spec_.Mutable(
...
inline std::string* DataServiceMetadata::release_element_spec() {
  ...
  if (_internal_has_element_spec()) {
    clear_has_optional_element_spec();
    return optional_element_spec_.element_spec_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
...
void CrossTrainerCacheOptions::set_trainer_id(ArgT0&& arg0, ArgT... args) {
 ...
 trainer_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CrossTrainerCacheOptions::_internal_trainer_id() const {
  return trainer_id_.Get();
}
inline void CrossTrainerCacheOptions::_internal_set_trainer_id(const std::string& value) {
  
  trainer_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CrossTrainerCacheOptions::_internal_mutable_trainer_id() {
  
  return trainer_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CrossTrainerCacheOptions::release_trainer_id() {
  ...
  return trainer_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CrossTrainerCacheOptions::set_allocated_trainer_id(std::string* trainer_id) {
  ...
  trainer_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), trainer_id,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trainer_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    trainer_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
