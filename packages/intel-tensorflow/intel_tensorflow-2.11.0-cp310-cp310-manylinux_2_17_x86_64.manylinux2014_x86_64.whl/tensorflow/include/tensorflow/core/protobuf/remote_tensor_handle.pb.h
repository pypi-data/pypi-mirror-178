...
class ResourceDtypeAndShape final :
 ...
 public:
  ...
  explicit constexpr ResourceDtypeAndShape(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RemoteTensorHandle final :
 ...
 public:
  ...
  explicit constexpr RemoteTensorHandle(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void RemoteTensorHandle::set_op_device(ArgT0&& arg0, ArgT... args) {
 ...
 op_device_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RemoteTensorHandle::_internal_set_op_device(const std::string& value) {
  ...
  op_device_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RemoteTensorHandle::_internal_mutable_op_device() {
  
  return op_device_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RemoteTensorHandle::release_op_device() {
  ...
  return op_device_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RemoteTensorHandle::set_allocated_op_device(std::string* op_device) {
  ...
  op_device_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), op_device,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (op_device_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    op_device_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
