...
_TFPROFTENSORPROTO = DESCRIPTOR.message_types_by_name['TFProfTensorProto']
_GRAPHNODEPROTO = DESCRIPTOR.message_types_by_name['GraphNodeProto']
_GRAPHNODEPROTO_INPUTSHAPESENTRY = _GRAPHNODEPROTO.nested_types_by_name['InputShapesEntry']
_MULTIGRAPHNODEPROTO = DESCRIPTOR.message_types_by_name['MultiGraphNodeProto']
_ADVICEPROTO = DESCRIPTOR.message_types_by_name['AdviceProto']
_ADVICEPROTO_CHECKERSENTRY = _ADVICEPROTO.nested_types_by_name['CheckersEntry']
_ADVICEPROTO_CHECKER = _ADVICEPROTO.nested_types_by_name['Checker']
