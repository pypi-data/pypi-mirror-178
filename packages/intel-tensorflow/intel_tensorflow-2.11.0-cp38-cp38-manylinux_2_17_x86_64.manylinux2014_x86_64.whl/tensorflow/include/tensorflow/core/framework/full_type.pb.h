...
class FullTypeDef final :
 ...
 public:
  ...
  explicit constexpr FullTypeDef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void FullTypeDef::clear_s() {
  if (_internal_has_s()) {
    attr_.s_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
    clear_has_attr();
  }
}
...
inline void FullTypeDef::set_s(ArgT0&& arg0, ArgT... args) {
  ...
  attr_.s_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void FullTypeDef::_internal_set_s(const std::string& value) {
  ...
  attr_.s_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* FullTypeDef::release_s() {
  ...
  if (_internal_has_s()) {
    clear_has_attr();
    return attr_.s_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
