...
public:
  ...
  explicit constexpr JobDef_TasksEntry_DoNotUse(
...
class JobDef final :
 ...
 public:
  ...
  ~JobDef() override;
  explicit constexpr JobDef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ClusterDef final :
 ...
 public:
  ...
  ~ClusterDef() override;
  explicit constexpr ClusterDef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
