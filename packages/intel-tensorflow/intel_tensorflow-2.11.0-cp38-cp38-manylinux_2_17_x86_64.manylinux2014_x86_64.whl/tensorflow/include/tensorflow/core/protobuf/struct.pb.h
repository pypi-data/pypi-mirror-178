...
inline ::tensorflow::NoneValue* StructuredValue::_internal_mutable_none_value() {
  if (!_internal_has_none_value()) {
    clear_kind();
    set_has_none_value();
    kind_.none_value_ = CreateMaybeMessage< ::tensorflow::NoneValue >(GetArenaForAllocation());
  }
...
inline ::tensorflow::TensorShapeProto* StructuredValue::_internal_mutable_tensor_shape_value() {
  if (!_internal_has_tensor_shape_value()) {
    clear_kind();
    set_has_tensor_shape_value();
    kind_.tensor_shape_value_ = CreateMaybeMessage< ::tensorflow::TensorShapeProto >(GetArenaForAllocation());
  }
...
inline ::tensorflow::TensorSpecProto* StructuredValue::_internal_mutable_tensor_spec_value() {
  if (!_internal_has_tensor_spec_value()) {
    clear_kind();
    set_has_tensor_spec_value();
    kind_.tensor_spec_value_ = CreateMaybeMessage< ::tensorflow::TensorSpecProto >(GetArenaForAllocation());
  }
...
inline ::tensorflow::TypeSpecProto* StructuredValue::_internal_mutable_type_spec_value() {
  if (!_internal_has_type_spec_value()) {
    clear_kind();
    set_has_type_spec_value();
    kind_.type_spec_value_ = CreateMaybeMessage< ::tensorflow::TypeSpecProto >(GetArenaForAllocation());
  }
...
inline ::tensorflow::BoundedTensorSpecProto* StructuredValue::_internal_mutable_bounded_tensor_spec_value() {
  if (!_internal_has_bounded_tensor_spec_value()) {
    clear_kind();
    set_has_bounded_tensor_spec_value();
    kind_.bounded_tensor_spec_value_ = CreateMaybeMessage< ::tensorflow::BoundedTensorSpecProto >(GetArenaForAllocation());
  }
...
inline ::tensorflow::ListValue* StructuredValue::_internal_mutable_list_value() {
  if (!_internal_has_list_value()) {
    clear_kind();
    set_has_list_value();
    kind_.list_value_ = CreateMaybeMessage< ::tensorflow::ListValue >(GetArenaForAllocation());
  }
...
inline ::tensorflow::TupleValue* StructuredValue::_internal_mutable_tuple_value() {
  if (!_internal_has_tuple_value()) {
    clear_kind();
    set_has_tuple_value();
    kind_.tuple_value_ = CreateMaybeMessage< ::tensorflow::TupleValue >(GetArenaForAllocation());
  }
...
inline ::tensorflow::DictValue* StructuredValue::_internal_mutable_dict_value() {
  if (!_internal_has_dict_value()) {
    clear_kind();
    set_has_dict_value();
    kind_.dict_value_ = CreateMaybeMessage< ::tensorflow::DictValue >(GetArenaForAllocation());
  }
...
inline ::tensorflow::NamedTupleValue* StructuredValue::_internal_mutable_named_tuple_value() {
  if (!_internal_has_named_tuple_value()) {
    clear_kind();
    set_has_named_tuple_value();
    kind_.named_tuple_value_ = CreateMaybeMessage< ::tensorflow::NamedTupleValue >(GetArenaForAllocation());
  }
...
inline void PairValue::set_allocated_value(::tensorflow::StructuredValue* value) {
  ...
  if (value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::StructuredValue>::GetOwningArena(value);
...
inline void TypeSpecProto::clear_type_state() {
  if (GetArenaForAllocation() == nullptr && type_state_ != nullptr) {
    delete type_state_;
  }
  type_state_ = nullptr;
}
...
inline void TypeSpecProto::set_allocated_type_state(::tensorflow::StructuredValue* type_state) {
  ...
  if (type_state) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::StructuredValue>::GetOwningArena(type_state);
    if (message_arena != submessage_arena) {
...
void TypeSpecProto::set_type_spec_class_name(ArgT0&& arg0, ArgT... args) {
 ...
 type_spec_class_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TypeSpecProto::_internal_set_type_spec_class_name(const std::string& value) {
  ...
  type_spec_class_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TypeSpecProto::_internal_mutable_type_spec_class_name() {
  
  return type_spec_class_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TypeSpecProto::release_type_spec_class_name() {
  ...
  return type_spec_class_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void TypeSpecProto::set_allocated_type_spec_class_name(std::string* type_spec_class_name) {
  ...
  type_spec_class_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), type_spec_class_name,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (type_spec_class_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    type_spec_class_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
