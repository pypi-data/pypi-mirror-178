...
_SHARDINGSPEC = DESCRIPTOR.message_types_by_name['ShardingSpec']
_MESHDIMENSIONPROTO = DESCRIPTOR.message_types_by_name['MeshDimensionProto']
_LAYOUTPROTO = DESCRIPTOR.message_types_by_name['LayoutProto']
_MESHPROTO = DESCRIPTOR.message_types_by_name['MeshProto']
