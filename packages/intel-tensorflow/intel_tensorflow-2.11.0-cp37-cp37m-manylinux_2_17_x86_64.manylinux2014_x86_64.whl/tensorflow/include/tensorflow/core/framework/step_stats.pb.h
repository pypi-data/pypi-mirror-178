...
class AllocationRecord final :
 ...
 public:
  ...
  explicit constexpr AllocationRecord(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class MemoryStats final :
 ...
 public:
  ...
  explicit constexpr MemoryStats(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr DeviceStepStats_ThreadNamesEntry_DoNotUse(
...
void NodeExecStats::set_timeline_label(ArgT0&& arg0, ArgT... args) {
 ...
 timeline_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void NodeExecStats::_internal_set_timeline_label(const std::string& value) {
  ...
  timeline_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* NodeExecStats::_internal_mutable_timeline_label() {
  
  return timeline_label_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* NodeExecStats::release_timeline_label() {
  ...
  return timeline_label_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void NodeExecStats::set_allocated_timeline_label(std::string* timeline_label) {
  ...
  timeline_label_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), timeline_label,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (timeline_label_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    timeline_label_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void NodeExecStats::clear_memory_stats() {
  if (GetArenaForAllocation() == nullptr && memory_stats_ != nullptr) {
...
inline void NodeExecStats::set_allocated_memory_stats(::tensorflow::MemoryStats* memory_stats) {
  ...
  if (memory_stats) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::tensorflow::MemoryStats>::GetOwningArena(memory_stats);
    if (message_arena != submessage_arena) {
