...
class OptionsProto final :
 ...
 public:
  ...
  explicit constexpr OptionsProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
public:
  ...
  explicit constexpr AdvisorOptionsProto_CheckersEntry_DoNotUse(
...
public:
  ...
  explicit constexpr AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AdvisorOptionsProto_CheckerOption final :
 ...
 public:
  ...
  explicit constexpr AdvisorOptionsProto_CheckerOption(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AdvisorOptionsProto final :
 ...
 public:
  ...
  explicit constexpr AdvisorOptionsProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void OptionsProto::clear_min_accelerator_micros() {
  min_accelerator_micros_ = int64_t{0};
}
...
void OptionsProto::set_dump_to_file(ArgT0&& arg0, ArgT... args) {
 ...
 dump_to_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& OptionsProto::_internal_dump_to_file() const {
  return dump_to_file_.Get();
}
inline void OptionsProto::_internal_set_dump_to_file(const std::string& value) {
  
  dump_to_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* OptionsProto::_internal_mutable_dump_to_file() {
  
  return dump_to_file_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* OptionsProto::release_dump_to_file() {
  ...
  return dump_to_file_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void OptionsProto::set_allocated_dump_to_file(std::string* dump_to_file) {
  ...
  dump_to_file_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), dump_to_file,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (dump_to_file_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    dump_to_file_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
