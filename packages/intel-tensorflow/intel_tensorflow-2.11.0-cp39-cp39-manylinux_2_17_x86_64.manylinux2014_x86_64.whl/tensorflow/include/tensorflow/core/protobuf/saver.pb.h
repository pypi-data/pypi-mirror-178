...
class SaverDef final :
 ...
 public:
  ...
  ~SaverDef() override;
  explicit constexpr SaverDef(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void SaverDef::clear_filename_tensor_name() {
  filename_tensor_name_.ClearToEmpty();
}
...
void SaverDef::set_filename_tensor_name(ArgT0&& arg0, ArgT... args) {
 ...
 filename_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SaverDef::_internal_set_filename_tensor_name(const std::string& value) {
  ...
  filename_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SaverDef::_internal_mutable_filename_tensor_name() {
  
  return filename_tensor_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SaverDef::release_filename_tensor_name() {
  ...
  return filename_tensor_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void SaverDef::set_allocated_filename_tensor_name(std::string* filename_tensor_name) {
  ...
  if (filename_tensor_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    filename_tensor_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
inline void SaverDef::clear_save_tensor_name() {
  save_tensor_name_.ClearToEmpty();
}
...
void SaverDef::set_save_tensor_name(ArgT0&& arg0, ArgT... args) {
 ...
 save_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SaverDef::_internal_set_save_tensor_name(const std::string& value) {
  ...
  save_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SaverDef::_internal_mutable_save_tensor_name() {
  
  return save_tensor_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SaverDef::release_save_tensor_name() {
  ...
  return save_tensor_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void SaverDef::set_allocated_save_tensor_name(std::string* save_tensor_name) {
  ...
  save_tensor_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), save_tensor_name,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (save_tensor_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    save_tensor_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void SaverDef::set_restore_op_name(ArgT0&& arg0, ArgT... args) {
 ...
 restore_op_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SaverDef::_internal_set_restore_op_name(const std::string& value) {
  ...
  restore_op_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SaverDef::_internal_mutable_restore_op_name() {
  
  return restore_op_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SaverDef::release_restore_op_name() {
  ...
  return restore_op_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void SaverDef::set_allocated_restore_op_name(std::string* restore_op_name) {
  ...
  restore_op_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), restore_op_name,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (restore_op_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    restore_op_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
