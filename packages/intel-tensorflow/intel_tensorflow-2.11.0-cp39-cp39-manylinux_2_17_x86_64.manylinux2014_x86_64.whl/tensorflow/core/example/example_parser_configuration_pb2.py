...
_VARLENFEATUREPROTO = DESCRIPTOR.message_types_by_name['VarLenFeatureProto']
_FIXEDLENFEATUREPROTO = DESCRIPTOR.message_types_by_name['FixedLenFeatureProto']
_FEATURECONFIGURATION = DESCRIPTOR.message_types_by_name['FeatureConfiguration']
_EXAMPLEPARSERCONFIGURATION = DESCRIPTOR.message_types_by_name['ExampleParserConfiguration']
_EXAMPLEPARSERCONFIGURATION_FEATUREMAPENTRY = _EXAMPLEPARSERCONFIGURATION.nested_types_by_name['FeatureMapEntry']
