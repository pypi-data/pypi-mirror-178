...
class CloudWanTGW(
    ...
    def adds2s_vpn(
        ...
        *,
        ...
        :param dx_association_id: (experimental) DX Association Id, need to use if there using private IP.
    ...
    def tg_d_xattachment_id(self) -> builtins.str:
        '''
        :stability: experimental
        '''
        return typing.cast(builtins.str, jsii.get(self, "tgDXattachmentId"))

    @tg_d_xattachment_id.setter
    def tg_d_xattachment_id(self, value: builtins.str) -> None:
        if __debug__:
...
class VpnProps:
    ...
    def dx_association_id(self) -> typing.Optional[builtins.str]:
        '''(experimental) DX Association Id, need to use if there using private IP.
