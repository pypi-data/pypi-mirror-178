...
class CloudWanTGW(
    ...
    @cloudwan_tg_attachment_id.setter
    def cloudwan_tg_attachment_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CloudWanTGW, "cloudwan_tg_attachment_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "cloudwanTgAttachmentId", value)
