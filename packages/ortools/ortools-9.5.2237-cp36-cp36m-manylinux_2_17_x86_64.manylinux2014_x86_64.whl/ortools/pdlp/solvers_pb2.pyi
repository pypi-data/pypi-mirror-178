...
class TerminationCriteria(google.protobuf.message.Message):
    ...
    class SimpleOptimalityCriteria(google.protobuf.message.Message):
        ...
        norm(primal_residual, p) <=
            ...
            eps_optimal_primal_residual_relative * norm(b, p)
        ...
        also satisfies SCS's optimality conditions (see link above) with
    ...
    class DetailedOptimalityCriteria(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            eps_optimal_primal_residual_absolute: typing.Optional[builtins.float] = ...,
            eps_optimal_primal_residual_relative: typing.Optional[builtins.float] = ...,
            eps_optimal_dual_residual_absolute: typing.Optional[builtins.float] = ...,
            eps_optimal_dual_residual_relative: typing.Optional[builtins.float] = ...,
            eps_optimal_objective_gap_absolute: typing.Optional[builtins.float] = ...,
            eps_optimal_objective_gap_relative: typing.Optional[builtins.float] = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        simple_optimality_criteria: typing.Optional[global___TerminationCriteria.SimpleOptimalityCriteria] = ...,
        detailed_optimality_criteria: typing.Optional[global___TerminationCriteria.DetailedOptimalityCriteria] = ...,
        eps_optimal_absolute: typing.Optional[builtins.float] = ...,
        eps_optimal_relative: typing.Optional[builtins.float] = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optimality_criteria",b"optimality_criteria"]) -> typing.Optional[typing_extensions.Literal["simple_optimality_criteria","detailed_optimality_criteria"]]: ...
