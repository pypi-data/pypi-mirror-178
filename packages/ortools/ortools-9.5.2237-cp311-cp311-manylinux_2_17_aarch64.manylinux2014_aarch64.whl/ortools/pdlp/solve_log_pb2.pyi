...
class IterationStats(google.protobuf.message.Message):
    ...
    *after* the iteration. Therefore stats from iteration 0 are the stats at
    ...
    """
    @property
    def method_specific_stats(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.float]: ...
    def __init__(
        self,
        *,
        ...
        method_specific_stats: collections.abc.Mapping[builtins.str, builtins.float] | None = ...,
    ) -> None: ...
