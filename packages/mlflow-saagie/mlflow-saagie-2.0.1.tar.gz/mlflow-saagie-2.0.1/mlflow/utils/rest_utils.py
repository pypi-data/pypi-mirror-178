...
def http_request(
    ...
    **kwargs,
    ...
    try:
        kwargs['cookies'] = {"SAAGIETOKEN" + os.environ['REALM'].upper(): str(SaagieApi(
            url_saagie=os.environ['SAAGIE_URL'],
            id_platform=os.environ['PLATFORM_ID'],
        ...
        raise MlflowException(
            'Saagie cookie not set: check if the following environment variables are set : '
            'REALM, SAAGIE_URL, PLATFORM_ID, SAAGIE_LOGIN, SAAGIE_PASSWORD')
