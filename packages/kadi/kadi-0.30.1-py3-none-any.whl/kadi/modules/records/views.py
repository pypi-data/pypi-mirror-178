...
def edit_record_link(record_id, link_id):
    ...
    if request.method == "POST":
        if form.validate():
            ...
            danger(_("Error editing record link."))
...
def remove_record_link(record_id, link_id):
    ...
    try:
        ...
        success(_("Record link removed successfully."))
