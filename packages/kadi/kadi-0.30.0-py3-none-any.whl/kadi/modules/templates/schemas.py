...
class _RecordTemplateSchema(RecordSchema):
    ...
    def _post_load(self, data, **kwargs):
        ...
        # template data is always consistent in regards to the loaded keys.
        default_values = {
            "title": "",
            "identifier": "",
            "type": None,
