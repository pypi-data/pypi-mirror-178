...
class Entity(object):
    ...
    attribute_map = {
        ...
        'timestampedwhen': 'timestampedwhen',
        'title': 'title',
        'type': 'type',
    ...
    def __init__(self, body=None, body_html=None, canread=None, canwrite=None, category=None, category_id=None, color=None, comments=None, content_type=None, created_at=None, _date=None, elabid=None, events_id=None, events_item_id=None, firtname=None, fullname=None, has_attachement=None, has_comment=None, id=None, is_bound=None, lastchangeby=None, lastname=None, links=None, locked=None, lockedby=None, lockedwhen=None, metadata=None, modified_at=None, next_step=None, orcid=None, page=None, rating=None, recent_comment=None, sharelink=None, state=None, steps=None, tags=None, tags_id=None, timestamped=None, timestampedby=None, timestampedwhen=None, title=None, type=None, up_item_id=None, uploads=None, userid=None):  # noqa: E501
        ...
        if timestampedwhen is not None:
            self.timestampedwhen = timestampedwhen
    ...
    @property
    def timestampedwhen(self):
        """Gets the timestampedwhen of this Entity.  # noqa: E501


        :return: The timestampedwhen of this Entity.  # noqa: E501
        :rtype: str
        """
        return self._timestampedwhen

    @timestampedwhen.setter
    def timestampedwhen(self, timestampedwhen):
        """Sets the timestampedwhen of this Entity.


        :param timestampedwhen: The timestampedwhen of this Entity.  # noqa: E501
        :type: str
        """

        self._timestampedwhen = timestampedwhen
