...
__all__ = ['sh_imported', 'df_ensemble', 'SimpleMultiComponent', 'Transform1', 'Transform2', 'SimplePipeline',
           ...
           'test_make_pipeline', 'test_pipeline_factory', 'test_pandas_pipeline', 'test_sequential_with_tracking',
           'test_seq_with_track_memory', 'test_seq_with_track_memory2', 'test_parallel',
           'test_pipeline_find_last_result', 'test_pipeline_find_last_fitted_model_seq',
