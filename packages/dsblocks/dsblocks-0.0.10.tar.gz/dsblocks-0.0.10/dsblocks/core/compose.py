    ...
    *components: list of components, optional.
    ...
    def __init__ (self,
        ...
        super().__init__ (name=name, class_name=class_name, group=group, tag=tag, 
                          ...
                          path_models=path_models, root=root, track_results=track_results, **kwargs)
...
# %% ../../nbs/core/compose.ipynb 109
#@delegates ()
class TrackingComponent (MultiComponent):
...
class MultiSplitComponent (MultiComponent, metaclass=abc.ABCMeta):
    ...
    def _fit (self, *X, fit_to=None, **kwargs):
        ...
        component.fit(X_fit, split=self.fit_to, **additional_data)
