...
setup(**{
    ...
    'install_requires': (
        'aiodocker~=0.21.0',
        'aiohttp~=3.8.1',
        """backend.ai-agent==22.09.5
""",
        """backend.ai-cli==22.09.5
""",
        """backend.ai-common==22.09.5
""",
        """backend.ai-kernel-binary==22.09.5
""",
        """backend.ai-kernel-helper==22.09.5
""",
        """backend.ai-kernel==22.09.5
""",
        """backend.ai-plugin==22.09.5
""",
    ),
    'license': 'LGPLv3',
