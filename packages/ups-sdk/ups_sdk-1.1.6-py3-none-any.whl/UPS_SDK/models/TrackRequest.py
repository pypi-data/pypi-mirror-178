...
class TrackRequest(BaseModel):
    ...
    request_action: str = RequestAction.TRACK
    request_option: str = RequestOption.ACTIVITY
    ...
    def xml(self) -> ET.Element:
        ...
        ET.SubElement(request_el, "RequestAction").text = self.request_action
        ET.SubElement(request_el, "RequestOption").text = self.request_option
