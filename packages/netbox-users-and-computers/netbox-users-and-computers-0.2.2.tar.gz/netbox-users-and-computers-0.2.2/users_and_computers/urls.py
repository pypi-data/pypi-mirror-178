...
urlpatterns = (
    ...
    path('ad_users/<int:pk>/', views.RiskView.as_view(), name='risk'),
    path('ad_users/<int:pk>/edit/', views.RiskEditView.as_view(),
         name='risk_edit'),
    path('ad_users/<int:pk>/delete/', views.RiskDeleteView.as_view(),
         name='risk_delete'),
    path('ad_users/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name='risk_changelog', kwargs={
         'model': models.Risk
         }),
    #  risk relation
