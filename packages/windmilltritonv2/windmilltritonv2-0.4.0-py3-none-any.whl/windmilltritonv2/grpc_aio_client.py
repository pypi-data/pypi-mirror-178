...
class TritonAioGRPCClient(TritonClient):
    ...
    async def get_inputs_and_outputs_detail(self, model_name, model_version):
        ...
        try:
            ...
            raise TritonClientException('Failed to gen inputs and outputs detail: {}'.format(e)) from None

    async def model_meta(self, model_name, model_version="1"):
        """
        get model meta
        :param model_name:
        :param model_version:
    ...
    async def model_config(self, model_name, model_version="1"):
        """
       get model config
       :param model_name:
       :param model_version:
    ...
    async def model_ready(self, model_name, model_version="1"):
        """
        check model ready
        :param model_name:
        :param model_version:
    ...
    async def model_statistics(self, model_name, model_version="1", headers=None):
        """
