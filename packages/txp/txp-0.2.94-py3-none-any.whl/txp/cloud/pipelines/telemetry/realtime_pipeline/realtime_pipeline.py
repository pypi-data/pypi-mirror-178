...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/marcosandoval/Work/Tranxpert/txp/src/txp/common/credentials/pub_sub_to_bigquery_credentials.json"#"../../../../common/credentials/pub_sub_to_bigquery_credentials.json"
...
########################################################################################################################
        ...
        rms_signal_collection = (
            signal_package_collection
            | "VibrationProcessing" >> beam.ParDo(ts.VibrationProcessing())
        )
        (
            rms_signal_collection
