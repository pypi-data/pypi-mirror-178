...
class FieldsContainerCAPI(fields_container_abstract_api.FieldsContainerAbstractAPI):
	...
	def fields_container_delete(fieldContainer):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.FieldsContainer_Delete(fieldContainer._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def fields_container_at(fieldContainer, i, ic):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.FieldsContainer_at(fieldContainer._internal_obj, utils.to_int32(i), utils.to_int32(ic), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def fields_container_set_field(fieldContainer, field, fieldId, ic):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.FieldsContainer_setField(fieldContainer._internal_obj, field._internal_obj, utils.to_int32(fieldId), utils.to_int32(ic), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def fields_container_get_scoping(fieldContainer, ic, size):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.FieldsContainer_GetScoping(fieldContainer._internal_obj, utils.to_int32(ic), ctypes.byref(utils.to_int32(size)), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def fields_container_num_fields(fieldContainer):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.FieldsContainer_numFields(fieldContainer._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
