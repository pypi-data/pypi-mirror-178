...
class ExternalOperatorCAPI(external_operator_abstract_api.ExternalOperatorAbstractAPI):
	...
	def external_operator_record(operator_main, func, operator_identifier, spec):
		...
		res = capi.dll.ExternalOperator_record(utils.to_void_ptr(operator_main), func, utils.to_char_ptr(operator_identifier), spec._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
	...
	def external_operator_record_with_abstract_core(operator_main, func, operator_identifier, spec, core):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_recordWithAbstractCore(utils.to_void_ptr(operator_main), func, utils.to_char_ptr(operator_identifier), spec._internal_obj, core, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_record_with_abstract_core_and_wrapper(operator_main, func, operator_identifier, spec, core, wrapper):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_recordWithAbstractCoreAndWrapper(utils.to_void_ptr(operator_main), func, utils.to_char_ptr(operator_identifier), spec._internal_obj, core, wrapper, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_collection(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutCollection(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_field(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutField(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_data_sources(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutDataSources(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_scoping(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutScoping(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_meshed_region(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutMeshedRegion(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_time_freq(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutTimeFreq(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_streams(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutStreams(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_property_field(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutPropertyField(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_remote_workflow(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutRemoteWorkflow(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_operator(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutOperator(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_support(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutSupport(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_as_any(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutAsAny(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_data_tree(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutDataTree(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_workflow(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutWorkflow(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_result_info(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutResultInfo(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_string_field(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutStringField(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_custom_type_field(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutCustomTypeField(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_external_data(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutExternalData(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_put_out_collection_as_vector(operator_data, pin_index, data):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_putOutCollectionAsVector(operator_data, utils.to_int32(pin_index), data._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_delegate_run(operator_data, other_op, forwardInputs):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_delegateRun(operator_data, other_op._internal_obj, forwardInputs, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def external_operator_connect_all_inputs_to_operator(operator_data, other_op):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_connectAllInputsToOperator(operator_data, other_op._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
