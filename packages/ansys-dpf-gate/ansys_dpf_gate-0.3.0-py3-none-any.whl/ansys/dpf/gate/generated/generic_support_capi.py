...
class GenericSupportCAPI(generic_support_abstract_api.GenericSupportAbstractAPI):
	...
	def generic_support_set_field_support_of_property(support, name, field):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.GenericSupport_setFieldSupportOfProperty(support._internal_obj, utils.to_char_ptr(name), field._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def generic_support_set_property_field_support_of_property(support, name, field):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.GenericSupport_setPropertyFieldSupportOfProperty(support._internal_obj, utils.to_char_ptr(name), field._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def generic_support_set_string_field_support_of_property(support, name, field):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.GenericSupport_setStringFieldSupportOfProperty(support._internal_obj, utils.to_char_ptr(name), field._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def generic_support_new_on_client(client, name):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.GenericSupport_new_on_client(client._internal_obj, utils.to_char_ptr(name), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
