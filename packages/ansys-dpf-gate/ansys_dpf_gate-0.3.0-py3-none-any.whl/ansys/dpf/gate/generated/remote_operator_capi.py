...
class RemoteOperatorCAPI(remote_operator_abstract_api.RemoteOperatorAbstractAPI):
	...
	def remote_operator_new(streams, remoteId):
		...
		res = capi.dll.RemoteOperator_new(streams._internal_obj, utils.to_int32(remoteId), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
	...
	def remote_operator_get_streams(remote_wf):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteOperator_get_streams(remote_wf._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def remote_operator_get_operator_id(remote_wf):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteOperator_get_operator_id(remote_wf._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def remote_operator_hold_streams(wf, streams):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteOperator_hold_streams(wf._internal_obj, utils.to_int32(streams), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
