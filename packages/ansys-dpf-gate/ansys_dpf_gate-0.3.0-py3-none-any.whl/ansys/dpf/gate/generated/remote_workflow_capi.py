...
class RemoteWorkflowCAPI(remote_workflow_abstract_api.RemoteWorkflowAbstractAPI):
	...
	def remote_workflow_new(streams, remoteId):
		...
		res = capi.dll.RemoteWorkflow_new(streams._internal_obj, utils.to_int32(remoteId), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
	...
	def remote_workflow_get_workflow_id(remote_wf):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteWorkflow_get_workflow_id(remote_wf._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def remote_workflow_get_streams(remote_wf):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteWorkflow_get_streams(remote_wf._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def remote_work_flow_delete(remote_wf):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.RemoteWorkFlow_delete(remote_wf._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
