...
from owl_finder.singlequery.svc import (
    GenerateViewSpans, GenerateViewSynonyms, GenerateViewTrie,
    LoadOntologyModel, QueryOntologyModel)
...
class AskOwlAPI(BaseObject):
    ...
    def spans(self) -> dict or None:
        ...
        return GenerateViewSpans().process(d_results)
