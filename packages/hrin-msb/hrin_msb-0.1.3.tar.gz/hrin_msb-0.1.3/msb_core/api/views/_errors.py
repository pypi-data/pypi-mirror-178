...
class ErrorViews():
	...
	def error_403_handler(request, exception):
		return render(request=request, template_name='errors/error_permission_denied.html',
		              context={})
	...
	def error_500_handler(request):
		return render(request=request, template_name='errors/error_internal_server.html',
		              context={})