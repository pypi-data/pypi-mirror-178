...
*
* This module is an area to add init defs that will be used for
* entry points for the pip package. Call other module defs from
* here as needed, once added then custom cmd entry points can be
* created in the pyproject.toml for package building
"""
import glob
import argparse
import os
