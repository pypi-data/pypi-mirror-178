...
def build_category_chart_data(chart_spec: ChartSpec, *, dbnomics_api_cache_dir: Path) -> CategoryChartData:
...
def update_chart(
    ...
    *,
    ...
    chart_data = build_category_chart_data(chart_spec, dbnomics_api_cache_dir=dbnomics_api_cache_dir)
