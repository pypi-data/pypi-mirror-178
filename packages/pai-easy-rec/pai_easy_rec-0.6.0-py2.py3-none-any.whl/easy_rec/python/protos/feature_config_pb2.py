...
_TEXTCNNCOMBINER = _descriptor.Descriptor(
  name='TextCnnCombiner',
  full_name='protos.TextCnnCombiner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='filter_sizes', full_name='protos.TextCnnCombiner.filter_sizes', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_filters', full_name='protos.TextCnnCombiner.num_filters', index=1,
...
_SEQUENCECOMBINER.fields_by_name['text_cnn'].message_type = _TEXTCNNCOMBINER
...
DESCRIPTOR.message_types_by_name['TextCnnCombiner'] = _TEXTCNNCOMBINER
...
TextCnnCombiner = _reflection.GeneratedProtocolMessageType('TextCnnCombiner', (_message.Message,), dict(
