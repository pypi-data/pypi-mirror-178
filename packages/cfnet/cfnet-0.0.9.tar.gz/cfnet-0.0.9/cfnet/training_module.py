...
# %% auto 0
__all__ = ['BaseTrainingModule', 'PredictiveTrainingModuleConfigs', 'PredictiveTrainingModule', 'partition_trainable_params',
...
# %% ../nbs/03_training_module.ipynb 4
...
@deprecated(removed_in='0.1.0', deprecated_in='0.0.7',
            details='Use `cfnet.module.PredictiveTrainingModule` instead.')
...
@deprecated(removed_in='0.1.0', deprecated_in='0.0.7',
            details='Use `cfnet.module.partition_trainable_params` instead.')
...
@deprecated(removed_in='0.1.0', deprecated_in='0.0.7',
            details='Use `cfnet.module.project_immutable_features` instead.')
...
@deprecated(removed_in='0.1.0', deprecated_in='0.0.7',
            details='Use `cfnet.module.CounterNetTrainingModule` instead.')
