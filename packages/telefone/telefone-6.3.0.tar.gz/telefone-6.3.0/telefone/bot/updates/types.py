...
from telegram_text.bases import Text
from telegram_text.elements import Element

from telefone.bot.updates.base import BaseBotUpdate
from telefone.types.methods import APIMethods
from telefone.types.objects import (
    CallbackQuery,
    ChatJoinRequest,
    ChatMemberUpdated,
    ChosenInlineResult,
