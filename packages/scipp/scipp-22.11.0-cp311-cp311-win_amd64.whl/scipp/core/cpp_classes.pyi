...
class DataArray():
    ...
    @typing.overload
    def __setitem__(self, arg0: typing.Tuple[str, Variable], arg1: DataArray) -> None: ...
    @typing.overload
    def __setitem__(self, arg0: typing.Tuple[str, Variable], arg1: Variable) -> None: ...
    @typing.overload
    ...
    def _ipython_key_completions_(self) -> list: ...
    def _rename_dims(self, arg0: typing.Dict[str, str]) -> DataArray: ...
    ...
    def underlying_size(self) -> int: 
        ...
        ``__sizeof__`` to get the size of the current slice only.
        """
    @property
    ...
    __hash__ = None
    pass
    def all(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def any(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def bin(self, arg_dict: typing.Dict[str, typing.Union[int, Variable]] = None, /, **kwargs: typing.Union[int, Variable]) -> typing.Union[DataArray, Dataset]: ...
    ...
    def group(self, /, *args: typing.Union[str, Variable]) -> typing.Union[DataArray, Dataset]: ...
    ...
    def hist(self, arg_dict: typing.Union[typing.Dict[str, typing.Union[int, Variable]], None] = None, /, **kwargs: typing.Union[int, Variable]) -> typing.Union[DataArray, Dataset]: ...
    def max(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def mean(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def min(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def nanhist(self, arg_dict: typing.Union[typing.Dict[str, typing.Union[int, Variable]], None] = None, /, **kwargs: typing.Union[int, Variable]) -> typing.Union[DataArray, Dataset]: ...
    def nanmax(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def nanmean(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def nanmin(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def nansum(self, dim: 'typing.Optional[str]' = None) -> 'VariableLikeType': ...
    def plot(*args, **kwargs): ...
    def rebin(self, arg_dict: typing.Dict[str, typing.Union[int, Variable]] = None, deprecated=None, /, **kwargs: typing.Union[int, Variable]) -> typing.Union[DataArray, Dataset]: ...
    def rename(self, dims_dict: typing.Dict[str, str] = None, /, **names: str) -> DataArray: ...
    def rename_dims(self, dims_dict: typing.Union[typing.Dict[str, str], None] = None, /, **names: str) -> ~VariableLikeType: ...
    ...
    def transform_coords(self, targets: typing.Union[str, typing.Iterable[str], None] = None, /, graph: typing.Union[typing.Dict[typing.Union[str, typing.Tuple[str, ...]], typing.Union[str, typing.Callable]], None] = None, *, rename_dims: bool = True, keep_aliases: bool = True, keep_intermediate: bool = True, keep_inputs: bool = True, quiet: bool = False, **kwargs: typing.Callable) -> typing.Union[DataArray, Dataset]: ...
...
class Dataset():
    ...
    def __setitem__(self, arg0: str, arg1: Variable) -> None: ...
    @typing.overload
    def __setitem__(self, arg0: typing.Tuple[str, Variable], arg1: Dataset) -> None: ...
    @typing.overload
    def __setitem__(self, arg0: typing.Tuple[str, int], arg1: object) -> None: ...
    @typing.overload
    def __setitem__(self, arg0: typing.Tuple[str, slice], arg1: object) -> None: ...
    ...
    def _ipython_key_completions_(self) -> list: ...
    def _pop(self, k: str) -> object: ...
    def _rename_dims(self, arg0: typing.Dict[str, str]) -> Dataset: ...
    def clear(self) -> None: 
        """
...
class GroupByDataArray():
    ...
    def nanmax(self, dim: str) -> DataArray: 
        ...
        :param dim: Dimension to reduce when computing the nanmax.
        :type dim: Dim
        :return: The computed nanmax over each group, combined along the dimension specified when calling :py:func:`scipp.groupby`.
        :rtype: DataArray
        """
    def nanmin(self, dim: str) -> DataArray: 
        ...
        :param dim: Dimension to reduce when computing the nanmin.
        :type dim: Dim
        :return: The computed nanmin over each group, combined along the dimension specified when calling :py:func:`scipp.groupby`.
        :rtype: DataArray
        """
    def nansum(self, dim: str) -> DataArray: 
        ...
        :param dim: Dimension to reduce when computing the nansum.
        :type dim: Dim
        :return: The computed nansum over each group, combined along the dimension specified when calling :py:func:`scipp.groupby`.
        :rtype: DataArray
        """
...
class Unit():
    ...
    def from_dict(self) -> Unit: 
        ...
        This function is meant to be used in combination with :meth:`scipp.Unit.to_dict`.
        """
    def to_dict(self) -> dict: 
        """
        Serialize a unit to a dict.

        This function is meant to be used with :meth:`scipp.Unit.from_dict` to serialize units.

        Warning
        -------
        The structure of the returned dict is an implementation detail and may change without warning at any time! It should not be used to access the internal representation of ``Unit``.
        """
    @property
    def name(self) -> str:
        """
...
class Variable():
    ...
    def _ipython_key_completions_(self) -> list: ...
    def _rename_dims(self, arg0: typing.Dict[str, str]) -> Variable: ...
    ...
    def broadcast(self, dims: typing.Union[typing.List[str], typing.Tuple[str, ...], None] = None, shape: typing.Union[typing.Sequence[int], None] = None, sizes: typing.Union[typing.Dict[str, int], None] = None) -> ~VariableLikeType: ...
    def ceil(self, *, out: 'typing.Optional[VariableLike]' = None) -> 'VariableLike': ...
    def cumsum(self, dim: typing.Union[str, None] = None, mode: Literal['exclusive', 'inclusive'] = 'inclusive') -> ~VariableLikeType: ...
    def flatten(self, dims: typing.Union[typing.List[str], typing.Tuple[str, ...], None] = None, to: typing.Union[str, None] = None) -> ~VariableLikeType: ...
    def floor(self, *, out: 'typing.Optional[VariableLike]' = None) -> 'VariableLike': ...
    def fold(self, dim: str, sizes: typing.Union[typing.Dict[str, int], None] = None, dims: typing.Union[typing.List[str], typing.Tuple[str, ...], None] = None, shape: typing.Union[typing.Sequence[int], None] = None) -> ~VariableLikeType: ...
    def hist(self, arg_dict: typing.Union[typing.Dict[str, typing.Union[int, Variable]], None] = None, /, **kwargs: typing.Union[int, Variable]) -> typing.Union[DataArray, Dataset]: ...
