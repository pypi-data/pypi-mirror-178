...
class CTkTitlebar:
    ...
    def Header(self, master, title='CTItleBar', title_font='none 12', title_fg='#200E32', icon_path=None, bg_color='grey',tools_fg='#200E32'):
        ...
        if self.CTkwindow is not None:
            ...
            self.CTkh.bind("<Button-1>", self.__CTkstartMove)
            self.CTkh.bind("<ButtonRelease-1>", self.__CTkstopMove)
            self.CTkh.bind("<B1-Motion>", self.__CTkmoving)
            self.CTkh.bind('<Double-Button-1>', self.CTkReposition)
