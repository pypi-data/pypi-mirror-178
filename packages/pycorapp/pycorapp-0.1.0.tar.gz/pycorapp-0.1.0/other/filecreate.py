f = open("pycorimg.hti", "w")
f.write("""
#_ Generated by PyCor

#define "PyCorRecoveryImg": true
#define "BlockCluster": 256
#define "Language": Python
#define "BackupImg": "pycor.py"
#define "RestorePoint": 0

$ISHIFT Create Dir("recovery"), FileType=.hti
$ISHIFT Create Dir("img"), FileType=.iso 
$ISHIFT Format File("img.iso"), FileSystem=cdfs
$ISHIFT Format File("recovery.hti"), FileSystem=ntfs
$ISHIFT Create Img("detector.pyc")

$IMPORT Library("fs")

$ISHIFT Write File("img.iso"), CopyFile From "?"
...
Root = HKA; Subkey= "Software/Classes/{#MyAppAssocKey}/shell/open/command"; ValueType= string; ValueName=
