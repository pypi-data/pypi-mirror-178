...
class SettingRecord:
    ...
    description = 'extra_desc'  # Additional, more detailed, description of the parameter
    ...
    enum_options = 'enumvals'  # Allowed values of an enum parameter (null for non-enum values)
...
class KeyColumnUsageRecord:
    ...
    constraint_schema = 'constraint_schema'  # Name of the schema that contains the constraint
