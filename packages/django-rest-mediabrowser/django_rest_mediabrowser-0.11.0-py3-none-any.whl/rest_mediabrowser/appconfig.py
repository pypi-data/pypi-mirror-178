...
MEDIA_BROWSER_AUTH_FUNCTION = getattr(settings, 'MB_AUTH_FUNCTION', 'rest_mediabrowser.utils.default_auth')
...
MB_NODE_PAGINATION = getattr(settings, "MEDIA_BROWSER_NODE_PAGINATION", 'rest_mediabrowser.paginations.DefaultPagination')
