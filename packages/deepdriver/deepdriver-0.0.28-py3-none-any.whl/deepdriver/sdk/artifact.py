...
class ArtifactEntry:
    ...
    def download(self, local_root_path: str, artifact_id: int, file_index: int, total_file_count:int ):
        ...
        interface.download_file(self.path, artifact_id, local_path, file_index, total_file_count, self.size)
...
class Artifacts:
    ...
    def download(self) -> str:
        ...
        for idx, entry in enumerate(self.entry_list):
            entry.download(local_root_path, self.id, idx, total_file_count=len(self.entry_list))
