...
class PaginatedDataCollectionFileAttachment(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DataCollectionFileAttachment']:
                        return DataCollectionFileAttachment
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DataCollectionFileAttachment'], typing.List['DataCollectionFileAttachment']],
                ...
                def __getitem__(self, i: int) -> 'DataCollectionFileAttachment':
    ...
    ) -> 'PaginatedDataCollectionFileAttachment':
        return super().__new__(
            cls,
            *args,
            total=total,
