        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SampleImage']:
                        return SampleImage
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SampleImage'], typing.List['SampleImage']],
                ...
                def __getitem__(self, i: int) -> 'SampleImage':
