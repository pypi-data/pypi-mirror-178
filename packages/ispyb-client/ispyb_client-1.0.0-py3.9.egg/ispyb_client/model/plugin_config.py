...
class PluginConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "config", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "config", ], str]):
