        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SubSample']:
                        return SubSample
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SubSample'], typing.List['SubSample']],
                ...
                def __getitem__(self, i: int) -> 'SubSample':
