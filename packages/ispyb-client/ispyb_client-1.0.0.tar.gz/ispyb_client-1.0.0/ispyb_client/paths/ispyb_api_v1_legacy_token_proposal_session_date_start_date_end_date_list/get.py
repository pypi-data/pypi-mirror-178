...
request_path_end_date = api_client.PathParameter(
    name="end_date",
    style=api_client.ParameterStyle.SIMPLE,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sessions_by_dates_legacy_token_oapg(
        self,
...
class GetSessionsByDatesLegacyToken(BaseApi):
    ...
    def get_sessions_by_dates_legacy_token(
        ...
        return self._get_sessions_by_dates_legacy_token_oapg(
