...
# body param
SchemaForRequestBodyApplicationJson = Login
...
SchemaFor201ResponseBodyApplicationJson = TokenResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _login_ispyb_api_v1_auth_login_post_oapg(
        self,
...
class LoginIspybApiV1AuthLoginPost(BaseApi):
    ...
    def login_ispyb_api_v1_auth_login_post(
        ...
        return self._login_ispyb_api_v1_auth_login_post_oapg(
            body=body,
