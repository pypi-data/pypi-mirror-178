...
class Login(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["plugin", "login", "password", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plugin", "login", "password", "token", ], str]):
