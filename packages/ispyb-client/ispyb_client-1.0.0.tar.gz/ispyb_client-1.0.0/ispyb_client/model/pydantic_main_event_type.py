...
class PydanticMainEventType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eventTypeId", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eventTypeId", "name", ], str]):
