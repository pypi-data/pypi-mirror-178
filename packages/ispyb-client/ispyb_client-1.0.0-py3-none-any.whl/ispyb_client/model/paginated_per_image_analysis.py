...
class PaginatedPerImageAnalysis(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PerImageAnalysis']:
                        return PerImageAnalysis
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PerImageAnalysis'], typing.List['PerImageAnalysis']],
                ...
                def __getitem__(self, i: int) -> 'PerImageAnalysis':
