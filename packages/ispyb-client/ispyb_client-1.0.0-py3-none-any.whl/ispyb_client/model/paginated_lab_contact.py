        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['LabContact']:
                        return LabContact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['LabContact'], typing.List['LabContact']],
                ...
                def __getitem__(self, i: int) -> 'LabContact':
