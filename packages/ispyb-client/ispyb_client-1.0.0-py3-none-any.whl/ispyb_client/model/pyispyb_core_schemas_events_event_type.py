...
class PyispybCoreSchemasEventsEventType(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["eventTypeName", "eventType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["eventTypeName", "eventType", ], str]):
    ...
    ) -> 'PyispybCoreSchemasEventsEventType':
