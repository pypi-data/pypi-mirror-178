...
class UPLabContact(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cardName", "person", "defaultCourrierCompany", "courierAccount", "billingReference", "dewarAvgCustomsValue", "dewarAvgTransportValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cardName", "person", "defaultCourrierCompany", "courierAccount", "billingReference", "dewarAvgCustomsValue", "dewarAvgTransportValue", ], str]):
