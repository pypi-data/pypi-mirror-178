...
class DataCollectionFileAttachmentMetaData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "fileName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "fileName", ], str]):
    ...
    ) -> 'DataCollectionFileAttachmentMetaData':
