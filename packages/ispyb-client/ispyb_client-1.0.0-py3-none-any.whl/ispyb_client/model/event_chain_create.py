...
class EventChainCreate(
        ...
        class properties:
            ...
            class events(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EventCreate']:
                        return EventCreate
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['EventCreate'], typing.List['EventCreate']],
                ...
                def __getitem__(self, i: int) -> 'EventCreate':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["events", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["events", "name", ], str]):
