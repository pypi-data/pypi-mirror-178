...
# body param
SchemaForRequestBodyApplicationJson = Options


request_body_options = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Options
...
class BaseApi(api_client.Api):
    ...
    def _update_options_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_options.serialize(body, content_type)
