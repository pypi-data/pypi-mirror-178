...
class GenericController:
    def __init__(self, app="", path_for_generic_app="", path_log_app=""):
        self.app_name = app
        self.log = logController.LogController("", app, path_log_app)
        self.data_app_config = utilController.readFileJson(path_for_generic_app)
        self.flag_data = utilController.getFlagData()
        self.msg_error = ""
        ...
        if("report" in self.data_app_config["controller_app"]):
        ...
        if("member" in self.data_app_config["controller_app"]):
        ...
        if("summary" in self.data_app_config["controller_app"]):
