...
['flax>=0.6.2,<0.7.0',
 ...
 'numpy>=1.23.4,<2.0.0',
 'optax>=0.1.3,<0.2.0',
 'sphinxawesome-theme>=3.3.7,<4.0.0',
 'tensorflow-cpu>=2.11.0,<3.0.0',
 'tensorflow-datasets>=4.7.0,<5.0.0',
 'tqdm>=4.64.1,<5.0.0']
