...
from tesoro_client.errors import MalformedResponseError
from tesoro_client import resources
from tesoro_client import list_response
...
def test_customer_bank_accounts_create():
    ...
    assert_equal(response.customer_reference, body.get('customer_reference'))
    assert_equal(response.hidden_iban, body.get('hidden_iban'))
    assert_equal(response.sepa_type, body.get('sepa_type'))
    assert_equal(response.created_at, body.get('created_at'))
    assert_equal(response.mandate_status, body.get('mandate_status'))
...
def test_customer_bank_accounts_list():
    ...
    assert_equal([r.customer_reference for r in response.records],
                 [b.get('customer_reference') for b in body])
    assert_equal([r.hidden_iban for r in response.records],
                 [b.get('hidden_iban') for b in body])
    assert_equal([r.sepa_type for r in response.records],
                 [b.get('sepa_type') for b in body])
    assert_equal([r.created_at for r in response.records],
                 [b.get('created_at') for b in body])
    assert_equal([r.mandate_status for r in response.records],
                 [b.get('mandate_status') for b in body])
