...
__title__ = "marta-python"
__author__ = 'Nate Harris'
__author_email__ = 'n8gr8gbln@gmail.com'
__github_username__ = "nwithan8"
__github_repo__ = "marta-python"
__copyright__ = "Copyright © 2022 - Nate Harris"
__license__ = 'GNU General Public License v3 (GPLv3)'
__description__ = "An API client for interacting with MARTA's live train and bus data."
__keywords__ = ["API", "client", "MARTA", "transit", "bus", "train", "Atlanta", "Georgia", "GTFS"]
