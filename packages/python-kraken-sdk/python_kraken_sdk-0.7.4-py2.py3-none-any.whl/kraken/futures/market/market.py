...
class MarketClient(KrakenBaseFuturesAPI):
    ...
    def get_tradeable_products(self, tick_type: str) -> dict:
        ...
        return self._request(method='GET', uri=f'/api/charts/v1/{tick_type}', auth=False)
    ...
    def get_fee_schedules(self) -> dict:
        ...
        '''
        return self._request(method='GET', uri='/derivatives/api/v3/feeschedules', auth=False)
    ...
    def get_tickers(self) -> dict:
        ...
        '''
        return self._request(method='GET', uri='/derivatives/api/v3/tickers', auth=False)
    ...
    def get_historical_funding_rates(self, symbol: str) -> dict:
        ...
        return self._request(method='GET', uri='/derivatives/api/v4/historicalfundingrates', query_params={ 'symbol': symbol }, auth=False)
    ...
    def get_leverage_preference(self) -> dict:
        ...
        return self._request(method='GET', uri='/derivatives/api/v3/leveragepreferences', auth=True)
    ...
    def get_pnl_preference(self) -> dict:
        ...
        return self._request(method='GET', uri='/derivatives/api/v3/pnlpreferences', auth=True)
