...
git branch -M main
git remote add origin https://github.com/pypole/pypole.git
...
```bash
poetry run pypole --help
```

### Makefile usage

[`Makefile`](https://github.com/pypole/pypole/blob/master/Makefile) contains a lot of functions for faster development.
...
More information [about docker](https://github.com/pypole/pypole/tree/master/docker).
...
You can see the list of available releases on the [GitHub Releases](https://github.com/pypole/pypole/releases) page.
...
You can update it in [`release-drafter.yml`](https://github.com/pypole/pypole/blob/master/.github/release-drafter.yml).
