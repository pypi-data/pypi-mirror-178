...
def parseStationInfoFromDSHIPActionLogFile(file:str,stationColName:str,stationStartTimeColName:str,stationEndTimeColName,timeFormat='%Y/%m/%d %H:%M:%S'):
...
def removeEmptyLines(fileName:str,indicatorColumnNr:int,separator="\t",linesToRemove=[]):
	"""removes empty lines from file (caution, overwrites original file)"""
	newLines = []
