...
## Installation
Path4GMNS has been published on [PyPI](https://pypi.org/project/path4gmns/0.8.8a2/), and can be installed using
```
$ pip install path4gmns
```
If you need a specific version of Path4GMNS, say, 0.8.8a2,
```
$ pip install path4gmns==0.8.8a2
```

v0.8.8a2 is a **special version without DTALite** to facilitate installation for some Mac users. Its Python modules are exactly the same as v0.8.7. v0.8.7 finalizes the changes introduced in v0.8.7 as a stable release. Please **update to or install the latest version** and **discard all old versions**, which could lead to wrong assignment results under certain conditions.
