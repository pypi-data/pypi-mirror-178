...
class AccessTableNames:
    ...
    def clean_table_name(self, table: AccessTable) -> str:
        """
        ...
        def tname(t: AccessTable):
            ...
            """
            return t.table.replace("_", "").strip()
...
class AccessColumnToDjango(IOWriter):
    ...
    def __init__(self, builder: TextIOBase, field_renamer: NamerProto = FieldRenamer()):
...
class AccessColumnToPydantic(IOWriter):
    ...
    def __init__(self, builder: TextIOBase, field_namer: Type[NamerProto] = FieldRenamer, *args, **kwargs):
...
class AccessTableToDjango(IOWriter):
    ...
    def __call__(self, table: AccessTable) -> None:
        ...
        self._write(indent("\nclass Meta:\n", pre))
        self._write(indent(f'db_table = "{table.table}"\n\n', pre * 2))
