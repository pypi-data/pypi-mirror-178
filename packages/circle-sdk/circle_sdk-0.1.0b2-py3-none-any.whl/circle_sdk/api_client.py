...
from circle_sdk import rest
from circle_sdk.configuration import Configuration
from circle_sdk.exceptions import ApiTypeError, ApiValueError
from circle_sdk.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'CirclePython/0.1.0-beta.2'
