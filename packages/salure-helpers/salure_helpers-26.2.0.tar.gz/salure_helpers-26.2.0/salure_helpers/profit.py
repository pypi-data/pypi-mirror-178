...
class UpdateConnector:
    ...
    def update_subscription(self, data: dict, method: str, custom_fields: dict = None) -> requests.Response:
        ...
        allowed_fields = ['start_date_subscription', 'end_date_subscription', 'item_type_id', 'item_code', 'amount', 'subscription_line_id', 'start_date_subscription_line', 'end_date_subscription_line']
        ...
        if method == 'DELETE':
            ...
            if 'subscription_line_id' in data.keys():
                url = f'https://{self.environment}.{self.base_url}.afas.online/ProfitRestServices/connectors/FbSubscription/FbSubscriptionLines/'
            else:
                url = f'https://{self.environment}.{self.base_url}.afas.online/ProfitRestServices/connectors/FbSubscription/'
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        allowed_fields_person = ['initials', 'email_work', 'email_home', 'country_of_birth', 'place_of_birth', 'prefix',
                                 ...
                                 'mail_work', 'mail_private', 'mobile_work', 'mobile_private', 'marital_status', 'phone_work', 'phone_private', 'nationality']
